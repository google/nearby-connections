...
// Note: this is a workaround for a false-positive warning produced by the
// Visual C++ 15.9 compiler.
#pragma warning(disable : 5046)

// Note: this is a workaround for a false-positive warning produced by the
// Visual C++ 16.3 compiler.
#pragma warning(disable : 4268)

#if defined(__cpp_lib_coroutine) || defined(__cpp_coroutines) || \
...
constexpr uint32_t uint8_to_uint32(uint8_t a, uint8_t b, uint8_t c,
                                   uint8_t d) noexcept {
  ...
  struct guid {
   private:
    ...
    static constexpr guid parse(TStringView const value) noexcept {
      ...
      return {impl::uint8_to_uint32(impl::hex_to_uint8(value[0], value[1]),
              ...
              impl::uint8_to_uint16(impl::hex_to_uint8(value[9], value[10]),
                                    impl::hex_to_uint8(value[11], value[12])),
              impl::uint8_to_uint16(impl::hex_to_uint8(value[14], value[15]),
   ...
   public:
    ...
    constexpr guid(uint32_t const Data1, uint16_t const Data2,
        ...
        : Data1(Data1), Data2(Data2), Data3(Data3), Data4{Data4[0], Data4[1],
                                                          Data4[2], Data4[3],
                                                          Data4[4], Data4[5],
                                                          Data4[6], Data4[7]} {}
    ...
    constexpr guid(GUID const& value) noexcept
        : Data1(value.Data1),
          Data2(value.Data2),
          Data3(value.Data3),
          Data4{value.Data4[0], value.Data4[1], value.Data4[2],
...
inline constexpr hresult error_fail{
    static_cast<hresult>(0x80004005)};  // E_FAIL
inline constexpr hresult error_access_denied{
    static_cast<hresult>(0x80070005)};  // E_ACCESSDENIED
inline constexpr hresult error_wrong_thread{
    static_cast<hresult>(0x8001010E)};  // RPC_E_WRONG_THREAD
inline constexpr hresult error_not_implemented{
    static_cast<hresult>(0x80004001)};  // E_NOTIMPL
inline constexpr hresult error_invalid_argument{
    static_cast<hresult>(0x80070057)};  // E_INVALIDARG
inline constexpr hresult error_out_of_bounds{
    static_cast<hresult>(0x8000000B)};  // E_BOUNDS
inline constexpr hresult error_no_interface{
    static_cast<hresult>(0x80004002)};  // E_NOINTERFACE
inline constexpr hresult error_class_not_available{
    static_cast<hresult>(0x80040111)};  // CLASS_E_CLASSNOTAVAILABLE
inline constexpr hresult error_class_not_registered{
    static_cast<hresult>(0x80040154)};  // REGDB_E_CLASSNOTREG
inline constexpr hresult error_changed_state{
    static_cast<hresult>(0x8000000C)};  // E_CHANGED_STATE
inline constexpr hresult error_illegal_method_call{
    static_cast<hresult>(0x8000000E)};  // E_ILLEGAL_METHOD_CALL
inline constexpr hresult error_illegal_state_change{
    static_cast<hresult>(0x8000000D)};  // E_ILLEGAL_STATE_CHANGE
inline constexpr hresult error_illegal_delegate_assignment{
    static_cast<hresult>(0x80000018)};  // E_ILLEGAL_DELEGATE_ASSIGNMENT
inline constexpr hresult error_canceled{
    static_cast<hresult>(0x800704C7)};  // HRESULT_FROM_WIN32(ERROR_CANCELLED)
inline constexpr hresult error_bad_alloc{
    static_cast<hresult>(0x8007000E)};  // E_OUTOFMEMORY
inline constexpr hresult error_not_initialized{
    static_cast<hresult>(0x800401F0)};  // CO_E_NOTINITIALIZED
inline constexpr hresult error_file_not_found{static_cast<hresult>(
    0x80070002)};  // HRESULT_FROM_WIN32(ERROR_FILE_NOT_FOUND)
}  // namespace winrt::impl

__declspec(selectany)
    int32_t(__stdcall* winrt_to_hresult_handler)(void* address) noexcept {};
__declspec(selectany) winrt::hstring(__stdcall* winrt_to_message_handler)(
    void* address){};
__declspec(selectany) void(__stdcall* winrt_throw_hresult_handler)(
    uint32_t lineNumber, char const* fileName, char const* functionName,
    void* returnAddress, winrt::hresult const result) noexcept {};
__declspec(selectany) void(__stdcall* winrt_suspend_handler)(
    void const* token) noexcept {};
__declspec(selectany) void(__stdcall* winrt_resume_handler)(
    void const* token) noexcept {};
__declspec(selectany)
    int32_t(__stdcall* winrt_activation_handler)(void* classId,
...
void* __stdcall WINRT_IMPL_GetProcAddress(void* library,
                                          char const* name) noexcept;

int32_t __stdcall WINRT_IMPL_SetErrorInfo(uint32_t reserved,
                                          void* info) noexcept;
int32_t __stdcall WINRT_IMPL_GetErrorInfo(uint32_t reserved,
                                          void** info) noexcept;
int32_t __stdcall WINRT_IMPL_CoInitializeEx(void*, uint32_t type) noexcept;
void __stdcall WINRT_IMPL_CoUninitialize() noexcept;

int32_t __stdcall WINRT_IMPL_CoCreateFreeThreadedMarshaler(
    void* outer, void** marshaler) noexcept;
int32_t __stdcall WINRT_IMPL_CoCreateInstance(winrt::guid const& clsid,
                                              void* outer, uint32_t context,
                                              winrt::guid const& iid,
                                              void** object) noexcept;
int32_t __stdcall WINRT_IMPL_CoGetCallContext(winrt::guid const& iid,
                                              void** object) noexcept;
int32_t __stdcall WINRT_IMPL_CoGetObjectContext(winrt::guid const& iid,
                                                void** object) noexcept;
int32_t __stdcall WINRT_IMPL_CoGetApartmentType(int32_t* type,
                                                int32_t* qualifier) noexcept;
...
winrt::impl::bstr __stdcall WINRT_IMPL_SysAllocString(
    wchar_t const* value) noexcept;
...
int32_t __stdcall WINRT_IMPL_IIDFromString(wchar_t const* string,
                                           winrt::guid* iid) noexcept;
int32_t __stdcall WINRT_IMPL_MultiByteToWideChar(
    uint32_t codepage, uint32_t flags, char const* in_string, int32_t in_size,
    wchar_t* out_string, int32_t out_size) noexcept;
int32_t __stdcall WINRT_IMPL_WideCharToMultiByte(
    uint32_t codepage, uint32_t flags, wchar_t const* int_string,
    int32_t in_size, char* out_string, int32_t out_size,
    char const* default_char, int32_t* default_used) noexcept;
void* __stdcall WINRT_IMPL_HeapAlloc(void* heap, uint32_t flags,
                                     size_t bytes) noexcept;
int32_t __stdcall WINRT_IMPL_HeapFree(void* heap, uint32_t flags,
                                      void* value) noexcept;
void* __stdcall WINRT_IMPL_GetProcessHeap() noexcept;
uint32_t __stdcall WINRT_IMPL_FormatMessageW(uint32_t flags, void const* source,
                                             uint32_t code, uint32_t language,
...
uintptr_t __stdcall WINRT_IMPL_VirtualQuery(void* address, void* buffer,
                                            uintptr_t length) noexcept;
void* __stdcall WINRT_IMPL_EncodePointer(void* ptr) noexcept;

int32_t __stdcall WINRT_IMPL_OpenProcessToken(void* process, uint32_t access,
                                              void** token) noexcept;
void* __stdcall WINRT_IMPL_GetCurrentProcess() noexcept;
int32_t __stdcall WINRT_IMPL_DuplicateToken(void* existing, uint32_t level,
                                            void** duplicate) noexcept;
int32_t __stdcall WINRT_IMPL_OpenThreadToken(void* thread, uint32_t access,
                                             int32_t self,
                                             void** token) noexcept;
void* __stdcall WINRT_IMPL_GetCurrentThread() noexcept;
int32_t __stdcall WINRT_IMPL_SetThreadToken(void** thread,
                                            void* token) noexcept;

void __stdcall WINRT_IMPL_AcquireSRWLockExclusive(
    winrt::impl::srwlock* lock) noexcept;
void __stdcall WINRT_IMPL_AcquireSRWLockShared(
    winrt::impl::srwlock* lock) noexcept;
uint8_t __stdcall WINRT_IMPL_TryAcquireSRWLockExclusive(
    winrt::impl::srwlock* lock) noexcept;
uint8_t __stdcall WINRT_IMPL_TryAcquireSRWLockShared(
    winrt::impl::srwlock* lock) noexcept;
void __stdcall WINRT_IMPL_ReleaseSRWLockExclusive(
    winrt::impl::srwlock* lock) noexcept;
void __stdcall WINRT_IMPL_ReleaseSRWLockShared(
    winrt::impl::srwlock* lock) noexcept;
int32_t __stdcall WINRT_IMPL_SleepConditionVariableSRW(
    winrt::impl::condition_variable* cv, winrt::impl::srwlock* lock,
    uint32_t milliseconds, uint32_t flags) noexcept;
void __stdcall WINRT_IMPL_WakeConditionVariable(
    winrt::impl::condition_variable* cv) noexcept;
void __stdcall WINRT_IMPL_WakeAllConditionVariable(
    winrt::impl::condition_variable* cv) noexcept;
void* __stdcall WINRT_IMPL_InterlockedPushEntrySList(void* head,
                                                     void* entry) noexcept;
void* __stdcall WINRT_IMPL_InterlockedFlushSList(void* head) noexcept;

void* __stdcall WINRT_IMPL_CreateEventW(void*, int32_t, int32_t,
                                        void*) noexcept;
int32_t __stdcall WINRT_IMPL_SetEvent(void*) noexcept;
int32_t __stdcall WINRT_IMPL_CloseHandle(void* hObject) noexcept;
uint32_t __stdcall WINRT_IMPL_WaitForSingleObject(
    void* handle, uint32_t milliseconds) noexcept;

int32_t __stdcall WINRT_IMPL_TrySubmitThreadpoolCallback(
    void(__stdcall* callback)(void*, void* context), void* context,
    void*) noexcept;
winrt::impl::ptp_timer __stdcall WINRT_IMPL_CreateThreadpoolTimer(
    void(__stdcall* callback)(void*, void* context, void*), void* context,
    void*) noexcept;
void __stdcall WINRT_IMPL_SetThreadpoolTimer(winrt::impl::ptp_timer timer,
                                             void* time, uint32_t period,
                                             uint32_t window) noexcept;
void __stdcall WINRT_IMPL_CloseThreadpoolTimer(
    winrt::impl::ptp_timer timer) noexcept;
winrt::impl::ptp_wait __stdcall WINRT_IMPL_CreateThreadpoolWait(
    void(__stdcall* callback)(void*, void* context, void*, uint32_t result),
    void* context, void*) noexcept;
void __stdcall WINRT_IMPL_SetThreadpoolWait(winrt::impl::ptp_wait wait,
                                            void* handle,
                                            void* timeout) noexcept;
void __stdcall WINRT_IMPL_CloseThreadpoolWait(
    winrt::impl::ptp_wait wait) noexcept;
winrt::impl::ptp_io __stdcall WINRT_IMPL_CreateThreadpoolIo(
    void* object,
    void(__stdcall* callback)(void*, void* context, void* overlapped,
                              uint32_t result, std::size_t bytes,
                              void*) noexcept,
    void* context, void*) noexcept;
...
winrt::impl::ptp_pool __stdcall WINRT_IMPL_CreateThreadpool(
    void* reserved) noexcept;
void __stdcall WINRT_IMPL_SetThreadpoolThreadMaximum(winrt::impl::ptp_pool pool,
                                                     uint32_t value) noexcept;
int32_t __stdcall WINRT_IMPL_SetThreadpoolThreadMinimum(
    winrt::impl::ptp_pool pool, uint32_t value) noexcept;
void __stdcall WINRT_IMPL_CloseThreadpool(winrt::impl::ptp_pool pool) noexcept;

int32_t __stdcall WINRT_CanUnloadNow() noexcept;
int32_t __stdcall WINRT_GetActivationFactory(void* classId,
                                             void** factory) noexcept;
}
...
#define WINRT_IMPL_LINK(function, count) \
  __pragma(                              \
      comment(linker, "/alternatename:#WINRT_IMPL_" #function "=#" #function))
#elif _M_IX86
#define WINRT_IMPL_LINK(function, count)                                      \
...
template <typename T>
struct is_implements<T, std::void_t<typename T::implements_type>>
    : std::true_type {};
...
template <typename T>
struct arg<
    T, std::enable_if_t<std::is_base_of_v<Windows::Foundation::IUnknown, T>>> {
  using in = void*;
};
...
template <typename D>
struct produce<D, Windows::Foundation::IInspectable>
    : produce_base<D, Windows::Foundation::IInspectable> {};
...
template <>
struct typelist_concat<> {
  using type = winrt::impl::typelist<>;
};

template <typename... List>
struct typelist_concat<winrt::impl::typelist<List...>> {
  using type = winrt::impl::typelist<List...>;
};

template <typename... List1, typename... List2, typename... Rest>
struct typelist_concat<winrt::impl::typelist<List1...>,
                       winrt::impl::typelist<List2...>, Rest...>
...
constexpr std::array<T, Size> to_array(
    T const* value, std::index_sequence<Index...> const) noexcept {
  return {value[Index]...};
}
...
template <typename T, size_t LeftSize, size_t RightSize, size_t... LeftIndex,
          size_t... RightIndex>
...
constexpr auto concat(std::array<T, LeftSize> const& left,
                      std::array<T, RightSize> const& right) noexcept {
  return concat(left, right, std::make_index_sequence<LeftSize>(),
                std::make_index_sequence<RightSize>());
}

template <typename T, size_t LeftSize, size_t RightSize>
constexpr auto concat(std::array<T, LeftSize> const& left,
                      T const (&right)[RightSize]) noexcept {
  return concat(left, to_array(right));
}

template <typename T, size_t LeftSize, size_t RightSize>
constexpr auto concat(T const (&left)[LeftSize],
                      std::array<T, RightSize> const& right) noexcept {
...
constexpr std::array<T, LS + RS - 1> zconcat_base(
    std::array<T, LS> const& left, std::array<T, RS> const& right,
    std::index_sequence<LI...> const,
    std::index_sequence<RI...> const) noexcept {
  return {left[LI]..., right[RI]..., T{}};
}

template <typename T, size_t LS, size_t RS>
constexpr auto zconcat(std::array<T, LS> const& left,
                       std::array<T, RS> const& right) noexcept {
  return zconcat_base(left, right, std::make_index_sequence<LS - 1>(),
                      std::make_index_sequence<RS - 1>());
}

template <typename T, size_t S, size_t... I>
constexpr std::array<T, S> to_zarray_base(
    T const (&value)[S], std::index_sequence<I...> const) noexcept {
  return {value[I]...};
}
...
constexpr auto to_array(guid const& value) noexcept {
  return combine(
      to_array(value.Data1), to_array(value.Data2), to_array(value.Data3),
      std::array<uint8_t, 8>{value.Data4[0], value.Data4[1], value.Data4[2],
                             value.Data4[3], value.Data4[4], value.Data4[5],
                             value.Data4[6], value.Data4[7]});
}
...
constexpr T to_hex_digit(uint8_t value) noexcept {
  value &= 0xF;
  return value < 10 ? static_cast<T>('0') + value
                    : static_cast<T>('a') + (value - 10);
}
...
constexpr auto uint16_to_hex(uint16_t value) noexcept {
  return combine(uint8_to_hex<T>(static_cast<uint8_t>(value >> 8)),
                 uint8_to_hex<T>(value & 0xFF));
}

template <typename T>
constexpr auto uint32_to_hex(uint32_t const value) noexcept {
  return combine(uint16_to_hex<T>(value >> 16),
                 uint16_to_hex<T>(value & 0xFFFF));
}

template <typename T>
constexpr auto to_array(guid const& value) noexcept {
  return combine(std::array<T, 1>{'{'}, uint32_to_hex<T>(value.Data1),
                 std::array<T, 1>{'-'}, uint16_to_hex<T>(value.Data2),
                 std::array<T, 1>{'-'}, uint16_to_hex<T>(value.Data3),
                 std::array<T, 1>{'-'},
                 uint16_to_hex<T>(value.Data4[0] << 8 | value.Data4[1]),
                 std::array<T, 1>{'-'},
...
constexpr uint32_t to_guid(uint8_t a, uint8_t b, uint8_t c,
                           uint8_t d) noexcept {
...
constexpr std::array<uint8_t, Size> char_to_byte_array(
    std::array<T, Size> const& value,
...
constexpr std::array<uint32_t, 5> process_msg_block(
    uint8_t const* input, size_t start_pos,
    std::array<uint32_t, 5> const& intermediate_hash) noexcept {
  ...
  return {intermediate_hash[0] + A, intermediate_hash[1] + B,
          intermediate_hash[2] + C, intermediate_hash[3] + D,
          intermediate_hash[4] + E};
}

template <size_t Size>
constexpr std::array<uint32_t, 5> process_msg_block(
    std::array<uint8_t, Size> const& input, size_t start_pos,
    std::array<uint32_t, 5> const& intermediate_hash) noexcept {
...
constexpr std::array<uint8_t, 8> size_to_bytes(size_t size) noexcept {
  return {static_cast<uint8_t>((size & 0xff00000000000000) >> 56),
...
constexpr std::array<uint8_t, RemainingSize + 1> make_remaining(
    [[maybe_unused]] std::array<uint8_t, Size> const& input,
    [[maybe_unused]] size_t start_pos, std::index_sequence<Index...>) noexcept {
  return {input[Index + start_pos]..., 0x80};
}

template <size_t Size>
constexpr auto make_remaining(std::array<uint8_t, Size> const& input,
                              size_t start_pos) noexcept {
  constexpr auto remaining_size = Size % 64;
  return make_remaining<Size, remaining_size>(
      input, start_pos, std::make_index_sequence<remaining_size>());
}

template <size_t InputSize, size_t RemainderSize>
constexpr auto make_buffer(
    std::array<uint8_t, RemainderSize> const& remaining_buffer) noexcept {
...
template <size_t Size>
constexpr std::array<uint32_t, 5> finalize_remaining_buffer(
    std::array<uint8_t, Size> const& input,
    std::array<uint32_t, 5> const& intermediate_hash) noexcept {
  if constexpr (Size == 64) {
    return process_msg_block(input, 0, intermediate_hash);
  } else if constexpr (Size == 64 * 2) {
    return process_msg_block(input, 64,
                             process_msg_block(input, 0, intermediate_hash));
  }
}

template <size_t... Index>
constexpr std::array<uint8_t, 20> get_result(
    std::array<uint32_t, 5> const& intermediate_hash,
    std::index_sequence<Index...>) noexcept {
  return {static_cast<uint8_t>(intermediate_hash[Index >> 2] >>
                               (8 * (3 - (Index & 0x03))))...};
}
...
constexpr auto calculate_sha1(std::array<uint8_t, Size> const& input) noexcept {
  std::array<uint32_t, 5> intermediate_hash{0x67452301, 0xEFCDAB89, 0x98BADCFE,
  ...
  intermediate_hash = finalize_remaining_buffer(
      make_buffer<Size>(make_remaining(input, i)), intermediate_hash);
  return get_result(intermediate_hash);
}

template <size_t Size>
constexpr guid generate_guid(std::array<char, Size> const& value) noexcept {
  guid namespace_guid = {0xd57af411,
                         0x737b,
                         0xc042,
                         {0xab, 0xae, 0x87, 0x8b, 0x1e, 0x16, 0xad, 0xee}};

  auto buffer =
      combine(to_array(namespace_guid),
              char_to_byte_array(value, std::make_index_sequence<Size>()));
...
struct arg_collection {
  constexpr static auto data{combine(to_array(signature<TArg>::data), ";",
                                     arg_collection<TRest...>::data)};
};
...
template <>
inline constexpr auto& basic_signature_v<bool> = "b1";
template <>
inline constexpr auto& basic_signature_v<int8_t> = "i1";
template <>
inline constexpr auto& basic_signature_v<int16_t> = "i2";
template <>
inline constexpr auto& basic_signature_v<int32_t> = "i4";
template <>
inline constexpr auto& basic_signature_v<int64_t> = "i8";
template <>
inline constexpr auto& basic_signature_v<uint8_t> = "u1";
template <>
inline constexpr auto& basic_signature_v<uint16_t> = "u2";
template <>
inline constexpr auto& basic_signature_v<uint32_t> = "u4";
template <>
inline constexpr auto& basic_signature_v<uint64_t> = "u8";
template <>
inline constexpr auto& basic_signature_v<float> = "f4";
template <>
inline constexpr auto& basic_signature_v<double> = "f8";
template <>
inline constexpr auto& basic_signature_v<char16_t> = "c2";
template <>
inline constexpr auto& basic_signature_v<guid> = "g16";
template <>
inline constexpr auto& basic_signature_v<hstring> = "string";
template <>
inline constexpr auto& basic_signature_v<Windows::Foundation::IInspectable> =
    "cinterface(IInspectable)";

template <>
inline constexpr auto& name_v<bool> = L"Boolean";
template <>
inline constexpr auto& name_v<int8_t> = L"Int8";
template <>
inline constexpr auto& name_v<int16_t> = L"Int16";
template <>
inline constexpr auto& name_v<int32_t> = L"Int32";
template <>
inline constexpr auto& name_v<int64_t> = L"Int64";
template <>
inline constexpr auto& name_v<uint8_t> = L"UInt8";
template <>
inline constexpr auto& name_v<uint16_t> = L"UInt16";
template <>
inline constexpr auto& name_v<uint32_t> = L"UInt32";
template <>
inline constexpr auto& name_v<uint64_t> = L"UInt64";
template <>
inline constexpr auto& name_v<float> = L"Single";
template <>
inline constexpr auto& name_v<double> = L"Double";
template <>
inline constexpr auto& name_v<char16_t> = L"Char16";
template <>
inline constexpr auto& name_v<guid> = L"Guid";
template <>
inline constexpr auto& name_v<hstring> = L"String";
template <>
inline constexpr auto& name_v<hresult> = L"Windows.Foundation.HResult";
template <>
inline constexpr auto& name_v<event_token> =
    L"Windows.Foundation.EventRegistrationToken";
template <>
inline constexpr auto& name_v<Windows::Foundation::IInspectable> = L"Object";
template <>
inline constexpr auto& name_v<Windows::Foundation::TimeSpan> =
    L"Windows.Foundation.TimeSpan";
template <>
inline constexpr auto& name_v<Windows::Foundation::DateTime> =
    L"Windows.Foundation.DateTime";
template <>
inline constexpr auto& name_v<IAgileObject> = L"IAgileObject";
...
template <>
struct category<Windows::Foundation::IInspectable> {
  using type = basic_category;
};
template <>
struct category<Windows::Foundation::TimeSpan> {
  using type = struct_category<int64_t>;
};
template <>
struct category<Windows::Foundation::DateTime> {
  using type = struct_category<int64_t>;
};
...
struct category_signature<enum_category, T> {
  ...
  constexpr static auto data{
      combine("enum(", to_utf8<T>(), ";", signature<enum_type>::data, ")")};
};

template <typename... Fields, typename T>
struct category_signature<struct_category<Fields...>, T> {
  constexpr static auto data{combine("struct(", to_utf8<T>(), ";",
                                     arg_collection<Fields...>::data, ")")};
};

template <typename T>
struct category_signature<class_category, T> {
  constexpr static auto data{
      combine("rc(", to_utf8<T>(), ";",
              signature<winrt::default_interface<T>>::data, ")")};
};

template <typename... Args, typename T>
struct category_signature<generic_category<Args...>, T> {
  constexpr static auto data{combine("pinterface(",
                                     to_array<char>(generic_guid_v<T>), ";",
                                     arg_collection<Args...>::data, ")")};
};
...
struct category_signature<delegate_category, T> {
  constexpr static auto data{
      combine("delegate(", to_array<char>(guid_of<T>()), ")")};
};

template <size_t Size>
constexpr std::wstring_view to_wstring_view(
    std::array<wchar_t, Size> const& value) noexcept {
  return {value.data(), Size - 1};
}

template <size_t Size>
constexpr std::wstring_view to_wstring_view(
    wchar_t const (&value)[Size]) noexcept {
  return {value, Size - 1};
}
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt {
  ...
  struct handle_type {
    ...
    explicit operator bool() const noexcept { return T::invalid() != m_value; }
  ...
  struct file_handle_traits {
    ...
    static type invalid() noexcept { return reinterpret_cast<type>(-1); }
  };
...
WINRT_EXPORT namespace winrt {
  ...
  struct slim_mutex {
    ...
    void lock() noexcept { WINRT_IMPL_AcquireSRWLockExclusive(&m_lock); }

    void lock_shared() noexcept { WINRT_IMPL_AcquireSRWLockShared(&m_lock); }
    ...
    void unlock() noexcept { WINRT_IMPL_ReleaseSRWLockExclusive(&m_lock); }

    void unlock_shared() noexcept { WINRT_IMPL_ReleaseSRWLockShared(&m_lock); }

   private:
    friend slim_condition_variable;

    auto get() noexcept { return &m_lock; }

    impl::srwlock m_lock{};
  };

  struct slim_lock_guard {
    explicit slim_lock_guard(slim_mutex& m) noexcept : m_mutex(m) {
      m_mutex.lock();
    }

    slim_lock_guard(slim_lock_guard const&) = delete;

    ~slim_lock_guard() noexcept { m_mutex.unlock(); }
  ...
  struct slim_shared_lock_guard {
    explicit slim_shared_lock_guard(slim_mutex& m) noexcept : m_mutex(m) {
      m_mutex.lock_shared();
    }

    slim_shared_lock_guard(slim_shared_lock_guard const&) = delete;

    ~slim_shared_lock_guard() noexcept { m_mutex.unlock_shared(); }
  ...
  struct slim_condition_variable {
    ...
    slim_condition_variable const& operator=(slim_condition_variable const&) =
        delete;
    ...
    void wait(slim_mutex& x, T predicate) {
      while (!predicate()) {
        WINRT_VERIFY(WINRT_IMPL_SleepConditionVariableSRW(
            &m_cv, x.get(), 0xFFFFFFFF /*INFINITE*/, 0));
      }
    }

    template <typename T>
    bool wait_for(slim_mutex& x,
                  std::chrono::high_resolution_clock::duration const timeout,
                  T predicate) {
      ...
      while (!predicate()) {
        ...
        if (!WINRT_IMPL_SleepConditionVariableSRW(
                &m_cv, x.get(), static_cast<uint32_t>(milliseconds), 0)) {
          return predicate();
        }
      }
    ...
    void notify_one() noexcept { WINRT_IMPL_WakeConditionVariable(&m_cv); }

    void notify_all() noexcept { WINRT_IMPL_WakeAllConditionVariable(&m_cv); }
...
namespace winrt::impl {
template <>
struct abi<Windows::Foundation::IUnknown> {
  struct __declspec(novtable) type {
    virtual int32_t __stdcall QueryInterface(guid const& id,
...
template <>
struct abi<Windows::Foundation::IInspectable> {
  struct __declspec(novtable) type : unknown_abi {
    ...
    virtual int32_t __stdcall GetTrustLevel(
        Windows::Foundation::TrustLevel* level) noexcept = 0;
  };
};
...
template <>
struct abi<Windows::Foundation::IActivationFactory> {
...
struct __declspec(novtable) IMarshal : unknown_abi {
  virtual int32_t __stdcall GetUnmarshalClass(guid const& riid, void* pv,
                                              uint32_t dwDestContext,
                                              void* pvDestContext,
                                              uint32_t mshlflags,
                                              guid* pCid) noexcept = 0;
  virtual int32_t __stdcall GetMarshalSizeMax(guid const& riid, void* pv,
                                              uint32_t dwDestContext,
                                              void* pvDestContext,
                                              uint32_t mshlflags,
                                              uint32_t* pSize) noexcept = 0;
  virtual int32_t __stdcall MarshalInterface(void* pStm, guid const& riid,
                                             void* pv, uint32_t dwDestContext,
                                             void* pvDestContext,
                                             uint32_t mshlflags) noexcept = 0;
  virtual int32_t __stdcall UnmarshalInterface(void* pStm, guid const& riid,
                                               void** ppv) noexcept = 0;
...
struct __declspec(novtable) IGlobalInterfaceTable : unknown_abi {
  virtual int32_t __stdcall RegisterInterfaceInGlobal(
      void* object, guid const& iid, uint32_t* cookie) noexcept = 0;
  virtual int32_t __stdcall RevokeInterfaceFromGlobal(
      uint32_t cookie) noexcept = 0;
  virtual int32_t __stdcall GetInterfaceFromGlobal(uint32_t cookie,
                                                   guid const& iid,
                                                   void** object) noexcept = 0;
};
...
struct __declspec(novtable) IWeakReference : unknown_abi {
  virtual int32_t __stdcall Resolve(guid const& iid,
                                    void** objectReference) noexcept = 0;
};

struct __declspec(novtable) IWeakReferenceSource : unknown_abi {
  virtual int32_t __stdcall GetWeakReference(
      IWeakReference** weakReference) noexcept = 0;
};

struct __declspec(novtable) IRestrictedErrorInfo : unknown_abi {
  virtual int32_t __stdcall GetErrorDetails(bstr* description, int32_t* error,
...
struct __declspec(novtable) ILanguageExceptionErrorInfo2 : unknown_abi {
  ...
  virtual int32_t __stdcall GetPreviousLanguageExceptionErrorInfo(
      ILanguageExceptionErrorInfo2** previous) noexcept = 0;
  virtual int32_t __stdcall CapturePropagationContext(
      void* exception) noexcept = 0;
  virtual int32_t __stdcall GetPropagationContextHead(
      ILanguageExceptionErrorInfo2** head) noexcept = 0;
};
...
struct __declspec(novtable) IContextCallback : unknown_abi {
  virtual int32_t __stdcall ContextCallback(
      int32_t(__stdcall* callback)(com_callback_args*), com_callback_args* args,
      guid const& iid, int method, void* reserved) noexcept = 0;
};

struct __declspec(novtable) IServerSecurity : unknown_abi {
  virtual int32_t __stdcall QueryBlanket(uint32_t*, uint32_t*, wchar_t**,
...
template <>
struct abi<Windows::Foundation::TimeSpan> {
  using type = int64_t;
};

template <>
struct abi<Windows::Foundation::DateTime> {
  using type = int64_t;
};

template <>
inline constexpr guid guid_v<Windows::Foundation::IUnknown>{
    0x00000000,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<Windows::Foundation::IInspectable>{
    0xAF86E2E0,
    0xB12D,
    0x4C6A,
    {0x9C, 0x5A, 0xD7, 0xAA, 0x65, 0x10, 0x1E, 0x90}};
template <>
inline constexpr guid guid_v<Windows::Foundation::IActivationFactory>{
    0x00000035,
    0x0000,
    0x0000,
    {0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IAgileObject>{
    0x94EA2B94,
    0xE9CC,
    0x49E0,
    {0xC0, 0xFF, 0xEE, 0x64, 0xCA, 0x8F, 0x5B, 0x90}};
template <>
inline constexpr guid guid_v<IAgileReference>{
    0xC03F6A43,
    0x65A4,
    0x9818,
    {0x98, 0x7E, 0xE0, 0xB8, 0x10, 0xD2, 0xA6, 0xF2}};
template <>
inline constexpr guid guid_v<IMarshal>{
    0x00000003,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IGlobalInterfaceTable>{
    0x00000146,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IStaticLifetime>{
    0x17b0e613,
    0x942a,
    0x422d,
    {0x90, 0x4c, 0xf9, 0x0d, 0xc7, 0x1a, 0x7d, 0xae}};
template <>
inline constexpr guid guid_v<IStaticLifetimeCollection>{
    0x1b0d3570,
    0x0877,
    0x5ec2,
    {0x8a, 0x2c, 0x3b, 0x95, 0x39, 0x50, 0x6a, 0xca}};
template <>
inline constexpr guid guid_v<IWeakReference>{
    0x00000037,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IWeakReferenceSource>{
    0x00000038,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IRestrictedErrorInfo>{
    0x82BA7092,
    0x4C88,
    0x427D,
    {0xA7, 0xBC, 0x16, 0xDD, 0x93, 0xFE, 0xB6, 0x7E}};
template <>
inline constexpr guid guid_v<IErrorInfo>{
    0x1CF2B120,
    0x547D,
    0x101B,
    {0x8E, 0x65, 0x08, 0x00, 0x2B, 0x2B, 0xD1, 0x19}};
template <>
inline constexpr guid guid_v<ILanguageExceptionErrorInfo2>{
    0x5746E5C4,
    0x5B97,
    0x424C,
    {0xB6, 0x20, 0x28, 0x22, 0x91, 0x57, 0x34, 0xDD}};
template <>
inline constexpr guid guid_v<ICallbackWithNoReentrancyToApplicationSTA>{
    0x0A299774,
    0x3E4E,
    0xFC42,
    {0x1D, 0x9D, 0x72, 0xCE, 0xE1, 0x05, 0xCA, 0x57}};
template <>
inline constexpr guid guid_v<IContextCallback>{
    0x000001da,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IServerSecurity>{
    0x0000013E,
    0x0000,
    0x0000,
    {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
template <>
inline constexpr guid guid_v<IBufferByteAccess>{
    0x905a0fef,
    0xbc53,
    0x11df,
...
template <typename T>
using com_ref =
    std::conditional_t<std::is_base_of_v<Windows::Foundation::IUnknown, T>, T,
                       com_ptr<T>>;

template <typename T, std::enable_if_t<is_implements_v<T>, int> = 0>
com_ref<T> wrap_as_result(void* result) {
  return {&static_cast<produce<T, typename default_interface<T>::type>*>(result)
               ->shim(),
...
struct is_com_interface
    : std::disjunction<std::is_base_of<Windows::Foundation::IUnknown, T>,
                       std::is_base_of<unknown_abi, T>, is_implements<T>,
...
template <typename To, typename From,
          std::enable_if_t<!is_com_interface_v<To>, int> = 0>
auto as(From* ptr);
...
WINRT_EXPORT namespace winrt::Windows::Foundation {
  struct IUnknown {
    ...
    IUnknown(void* ptr, take_ownership_from_abi_t) noexcept
        : m_ptr(static_cast<impl::unknown_abi*>(ptr)) {}

    IUnknown(IUnknown const& other) noexcept : m_ptr(other.m_ptr) { add_ref(); }

    IUnknown(IUnknown&& other) noexcept
        : m_ptr(std::exchange(other.m_ptr, {})) {}

    ~IUnknown() noexcept { release_ref(); }
    ...
    bool try_as(To& to) const noexcept {
      if constexpr (impl::is_com_interface_v<To> ||
                    !std::is_same_v<To, impl::wrapped_type_t<To>>) {
...
WINRT_EXPORT namespace winrt{
    template <
        typename T,
        std::enable_if_t<!std::is_base_of_v<Windows::Foundation::IUnknown, T>,
                         int> = 0>
    ...
    template <typename T,
              std::enable_if_t<!std::is_base_of_v<Windows::Foundation::IUnknown,
                                                  std::decay_t<T>> &&
    ...
    inline void attach_abi(Windows::Foundation::IUnknown& object,
                           void* value) noexcept {
      object = nullptr;
    ...
    constexpr void* detach_abi(std::nullptr_t) noexcept { return nullptr; }

    inline void copy_from_abi(Windows::Foundation::IUnknown& object,
                              void* value) noexcept {
      object = nullptr;
    ...
    inline void copy_to_abi(Windows::Foundation::IUnknown const& object,
                            void*& value) noexcept {
    ...
    inline ::IUnknown* get_unknown(
        Windows::Foundation::IUnknown const& object) noexcept {
...
WINRT_EXPORT namespace winrt::Windows::Foundation {
  inline bool operator==(IUnknown const& left, IUnknown const& right) noexcept {
    ...
    return get_abi(left.try_as<IUnknown>()) ==
           get_abi(right.try_as<IUnknown>());
  }
  ...
  struct IInspectable : IUnknown {
    ...
    IInspectable(void* ptr, take_ownership_from_abi_t) noexcept
        : IUnknown(ptr, take_ownership_from_abi) {}
...
template <typename T, typename O, typename M, typename... Args,
          std::enable_if_t<std::is_class_v<O> || std::is_union_v<O>, int> = 0>
int32_t capture_to(void** result, O* object, M method, Args&&... args) {
  return (object->*method)(args..., guid_of<T>(), result);
}

template <typename T, typename O, typename M, typename... Args>
int32_t capture_to(void** result, com_ptr<O> const& object, M method,
                   Args&&... args);
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt {
  ...
  struct com_ptr {
    ...
    com_ptr(com_ptr const& other) noexcept : m_ptr(other.m_ptr) { add_ref(); }
    ...
    type* detach() noexcept { return std::exchange(m_ptr, {}); }
    ...
    void copy_from(type* other) noexcept { copy_ref(other); }
    ...
    void capture(Args&&... args) {
      check_hresult(
          impl::capture_to<T>(put_void(), std::forward<Args>(args)...));
    }
...
struct atomic_ref_count {
  ...
  uint32_t operator=(uint32_t count) noexcept { return m_count = count; }
  ...
  operator uint32_t() const noexcept { return m_count; }
...
inline shared_hstring_header* precreate_hstring_on_heap(uint32_t length) {
  ...
  uint64_t bytes_required =
      static_cast<uint64_t>(sizeof(shared_hstring_header)) +
  ...
  auto header = static_cast<shared_hstring_header*>(
      WINRT_IMPL_HeapAlloc(WINRT_IMPL_GetProcessHeap(), 0,
                           static_cast<std::size_t>(bytes_required)));
...
inline hstring_header* create_hstring_on_heap(wchar_t const* value,
                                              uint32_t length) {
  if (!length) {
    return nullptr;
  }
  ...
  memcpy_s(header->buffer, sizeof(wchar_t) * length, value,
           sizeof(wchar_t) * length);
  return header;
}

inline void create_hstring_on_stack(hstring_header& header,
                                    wchar_t const* value,
...
struct hstring_traits {
  ...
  static void close(type value) noexcept { release_hstring(value); }
...
WINRT_EXPORT namespace winrt {
  struct hstring {
    ...
    hstring(void* ptr, take_ownership_from_abi_t) noexcept
        : m_handle(static_cast<impl::hstring_header*>(ptr)) {}
    ...
    hstring(wchar_t const* value) : hstring(std::wstring_view(value)) {}
    ...
    void clear() noexcept { m_handle.close(); }
  ...
  inline void copy_from_abi(hstring & object, void* value) {
    attach_abi(object, impl::duplicate_hstring(
                           static_cast<impl::hstring_header*>(value)));
  }

  inline void copy_to_abi(hstring const& object, void*& value) {
    WINRT_ASSERT(value == nullptr);
    value = impl::duplicate_hstring(
        static_cast<impl::hstring_header*>(get_abi(object)));
  }

  inline void* detach_abi(std::wstring_view const& value) {
    return impl::create_hstring_on_heap(value.data(),
                                        static_cast<uint32_t>(value.size()));
  }

  inline void* detach_abi(wchar_t const* const value) {
    return impl::create_hstring_on_heap(value,
                                        static_cast<uint32_t>(wcslen(value)));
  }
}
...
struct hstring_builder {
  ...
  wchar_t* data() noexcept { return const_cast<wchar_t*>(m_handle.get()->ptr); }

  hstring to_hstring() { return {m_handle.detach(), take_ownership_from_abi}; }
...
inline hstring hstring_convert(T value) {
  ...
  return hstring{
      std::wstring_view{buffer, static_cast<std::size_t>(end - buffer)}};
}
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt {
  ...
  inline hstring to_hstring(hstring const& value) noexcept { return value; }
  ...
  template <typename T,
            std::enable_if_t<std::is_convertible_v<T, std::string_view>, int> =
                0>
  hstring to_hstring(T const& value) {
    std::string_view const view(value);
    int const size = WINRT_IMPL_MultiByteToWideChar(
        65001 /*CP_UTF8*/, 0, view.data(), static_cast<int32_t>(view.size()),
        nullptr, 0);
    ...
    WINRT_VERIFY_(
        size, WINRT_IMPL_MultiByteToWideChar(65001 /*CP_UTF8*/, 0, view.data(),
  ...
  inline std::string to_string(std::wstring_view value) {
    int const size = WINRT_IMPL_WideCharToMultiByte(
        65001 /*CP_UTF8*/, 0, value.data(), static_cast<int32_t>(value.size()),
    ...
    WINRT_VERIFY_(size, WINRT_IMPL_WideCharToMultiByte(
                            65001 /*CP_UTF8*/, 0, value.data(),
...
#pragma warning(suppress : 26495)
   ...
   private:
    void create_string_reference(wchar_t const* const data,
...
template <typename T>
using param_type =
    std::conditional_t<std::is_same_v<T, hstring>, param::hstring, T>;
}
...
WINRT_EXPORT namespace winrt {
  ...
  inline bool operator==(hstring const& left,
                         std::wstring const& right) noexcept {
    return std::wstring_view(left) == right;
  }

  inline bool operator==(std::wstring const& left,
                         hstring const& right) noexcept {
...
namespace winrt::impl {
inline hstring concat_hstring(std::wstring_view const& left,
                              std::wstring_view const& right) {
  auto size = static_cast<uint32_t>(left.size() + right.size());
  if (size == 0) {
    return {};
  }
  hstring_builder text(size);
  memcpy_s(text.data(), left.size() * sizeof(wchar_t), left.data(),
           left.size() * sizeof(wchar_t));
  memcpy_s(text.data() + left.size(), right.size() * sizeof(wchar_t),
           right.data(), right.size() * sizeof(wchar_t));
...
WINRT_EXPORT namespace winrt {
  ...
  inline hstring operator+(hstring const& left,
                           std::wstring_view const& right) {
    return impl::concat_hstring(left, right);
  }

  inline hstring operator+(std::wstring_view const& left,
                           hstring const& right) {
    return impl::concat_hstring(left, right);
  }
}
...
WINRT_EXPORT namespace winrt {
  ...
  struct array_view {
    ...
    array_view(array_view<OtherType> const& other,
               std::enable_if_t<std::is_convertible_v<OtherType (*)[], T (*)[]>,
                                int> = 0) noexcept
   ...
   private:
    ...
    auto data(std::vector<C> const& value) noexcept {
      static_assert(!std::is_same_v<C, bool>,
                    "Cannot use std::vector<bool> as an array_view. Consider "
                    "std::array or std::unique_ptr<bool[]>.");
      return value.data();
    }
  ...
  struct com_array : array_view<T> {
    ...
    com_array(void* ptr, uint32_t const count,
              take_ownership_from_abi_t) noexcept
        : array_view<T>(static_cast<value_type*>(ptr),
                        static_cast<value_type*>(ptr) + count) {}
    ...
    template <typename U, size_t N>
    explicit com_array(U const (&value)[N]) : com_array(value, value + N) {}
   ...
   private:
    void alloc(size_type const size) {
      ...
      if (0 != size) {
        this->m_data = static_cast<value_type*>(
            WINRT_IMPL_CoTaskMemAlloc(size * sizeof(value_type)));
  ...
  template <typename C>
  com_array(uint32_t, C const&) -> com_array<std::decay_t<C>>;
  template <typename InIt, typename = std::void_t<typename std::iterator_traits<
                               InIt>::difference_type>>
  com_array(InIt, InIt) -> com_array<
      std::decay_t<typename std::iterator_traits<InIt>::value_type>>;
  template <typename C>
  com_array(std::vector<C> const&) -> com_array<std::decay_t<C>>;
  template <size_t N, typename C>
  com_array(std::array<C, N> const&) -> com_array<std::decay_t<C>>;
  template <size_t N, typename C>
  com_array(C const(&)[N]) -> com_array<std::decay_t<C>>;
  template <typename C>
  com_array(std::initializer_list<C>) -> com_array<std::decay_t<C>>;

  namespace impl {
  template <typename T, typename U>
  inline constexpr bool array_comparable =
      std::is_same_v<std::remove_cv_t<T>, std::remove_cv_t<U>>;
  }

  template <typename T, typename U,
            std::enable_if_t<impl::array_comparable<T, U>, int> = 0>
  bool operator==(array_view<T> const& left,
                  array_view<U> const& right) noexcept {
  ...
  auto get_abi(array_view<T> object) noexcept {
    ...
    if constexpr (std::is_base_of_v<Windows::Foundation::IUnknown, T>) {
      ...
      return reinterpret_cast<impl::arg_out<std::remove_const_t<T>>>(
  ...
  auto detach_abi(com_array<T> & object) noexcept {
    std::pair<uint32_t, impl::arg_out<T>> result(
        object.size(), *reinterpret_cast<impl::arg_out<T>*>(&object));
...
struct array_size_proxy {
  ...
  ~array_size_proxy() noexcept {
    ...
    *reinterpret_cast<uint32_t*>(reinterpret_cast<uintptr_t*>(&m_value) + 1) =
        m_size;
  }

  operator uint32_t*() noexcept { return &m_size; }
...
struct com_array_proxy {
  ...
  operator com_array<T>&() noexcept { return m_temp; }

  com_array_proxy(com_array_proxy const&) noexcept {
    // A Visual C++ compiler bug (550631) requires the copy constructor even
...
WINRT_EXPORT namespace winrt {
  ...
  inline hstring get_class_name(
      Windows::Foundation::IInspectable const& object) {
    void* value{};
    check_hresult(
        (*(impl::inspectable_abi**)&object)->GetRuntimeClassName(&value));
    return {value, take_ownership_from_abi};
  }

  inline com_array<guid> get_interfaces(
      Windows::Foundation::IInspectable const& object) {
    com_array<guid> value;
    check_hresult((*(impl::inspectable_abi**)&object)
                      ->GetIids(impl::put_size_abi(value), put_abi(value)));
    return value;
  }

  inline Windows::Foundation::TrustLevel get_trust_level(
      Windows::Foundation::IInspectable const& object) {
...
WINRT_EXPORT namespace winrt {
  ...
  struct weak_ref {
    ...
    weak_ref(impl::com_ref<T> const& object) {
      if (object) {
        if constexpr (impl::is_implements_v<T>) {
          ...
          // An access violation (crash) on the following line means that the
          // object does not support weak references. Avoid using
          // weak_ref/auto_revoke with such objects.
          check_hresult(object.template try_as<impl::IWeakReferenceSource>()
                            ->GetWeakReference(m_ref.put()));
        }
      }
    }
    ...
    auto put() noexcept { return m_ref.put(); }

    explicit operator bool() const noexcept { return static_cast<bool>(m_ref); }
  ...
  template <typename T>
  inline bool operator==(weak_ref<T> const& left,
                         weak_ref<T> const& right) noexcept {
    return get_abi(left) == get_abi(right);
  }
...
WINRT_EXPORT namespace winrt {
  ...
  // Defining WINRT_NO_MODULE_LOCK is appropriate for apps (executables) that
  // don't implement something like DllCanUnloadNow and can thus avoid the
  // synchronization overhead imposed by the default module lock.

  constexpr auto get_module_lock() noexcept {
    struct lock {
      constexpr uint32_t operator++() noexcept { return 1; }

      constexpr uint32_t operator--() noexcept { return 0; }
    };
  ...
  // When WINRT_CUSTOM_MODULE_LOCK is defined, you must provide an
  // implementation of winrt::get_module_lock() that returns an object that
  // implements operator++ and operator--.
...
struct module_lock_updater<true> {
  module_lock_updater() noexcept { ++get_module_lock(); }
...
struct agile_ref_fallback final : IAgileReference, update_module_lock {
  agile_ref_fallback(com_ptr<IGlobalInterfaceTable>&& git,
                     uint32_t cookie) noexcept
      : m_git(std::move(git)), m_cookie(cookie) {}

  ~agile_ref_fallback() noexcept { m_git->RevokeInterfaceFromGlobal(m_cookie); }

  int32_t __stdcall QueryInterface(guid const& id,
                                   void** object) noexcept final {
    if (is_guid_of<IAgileReference>(id) ||
        is_guid_of<Windows::Foundation::IUnknown>(id) ||
  ...
  uint32_t __stdcall AddRef() noexcept final { return ++m_references; }
...
void load_runtime_function(wchar_t const* library, char const* name, F& result,
                           L fallback) noexcept {
  if (result) {
    return;
  }
  ...
  result = reinterpret_cast<F>(
      WINRT_IMPL_GetProcAddress(WINRT_IMPL_LoadLibraryW(library), name));
...
inline int32_t __stdcall fallback_RoGetAgileReference(
    uint32_t, winrt::guid const& iid, void* object, void** reference) noexcept {
  *reference = nullptr;
  static constexpr guid git_clsid{
      0x00000323,
      0x0000,
      0x0000,
      {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
  ...
  hresult hr = WINRT_IMPL_CoCreateInstance(
      git_clsid, nullptr, 1 /*CLSCTX_INPROC_SERVER*/,
      guid_of<IGlobalInterfaceTable>(), git.put_void());
...
inline hresult get_agile_reference(winrt::guid const& iid, void* object,
                                   void** reference) noexcept {
  static int32_t(__stdcall * handler)(uint32_t options, winrt::guid const& iid,
                                      void* object, void** reference) noexcept;
  load_runtime_function(L"combase.dll", "RoGetAgileReference", handler,
                        fallback_RoGetAgileReference);
...
WINRT_EXPORT namespace winrt {
  ...
  struct agile_ref {
    ...
    agile_ref(impl::com_ref<T> const& object) {
      if (object) {
        check_hresult(impl::get_agile_reference(
            guid_of<T>(), winrt::get_abi(object), m_ref.put_void()));
      }
    }
...
#elif defined(__GNUC__)
#define WINRT_IMPL_RETURNADDRESS() \
...
struct bstr_traits {
  ...
  static void close(type value) noexcept { WINRT_IMPL_SysFreeString(value); }
...
inline hstring trim_hresult_message(wchar_t const* const message,
...
inline hstring message_from_hresult(hresult code) noexcept {
  ...
  uint32_t const size = WINRT_IMPL_FormatMessageW(
      0x00001300,  // FORMAT_MESSAGE_ALLOCATE_BUFFER |
...
constexpr int32_t hresult_from_win32(uint32_t const x) noexcept {
  return (int32_t)(x) <= 0
             ? (int32_t)(x)
             : (int32_t)(((x)&0x0000FFFF) | (7 << 16) | 0x80000000);
}
...
struct error_info_fallback final : IErrorInfo,
                                   IRestrictedErrorInfo,
                                   update_module_lock {
  error_info_fallback(int32_t code, void* message) noexcept
      : m_code(code),
        m_message(message ? *reinterpret_cast<winrt::hstring*>(&message)
                          : message_from_hresult(code)) {}

  int32_t __stdcall QueryInterface(guid const& id,
                                   void** object) noexcept final {
    if (is_guid_of<IRestrictedErrorInfo>(id) ||
        is_guid_of<Windows::Foundation::IUnknown>(id) ||
        is_guid_of<IAgileObject>(id)) {
  ...
  int32_t __stdcall GetErrorDetails(bstr* fallback, int32_t* error,
                                    bstr* message,
                                    bstr* capability) noexcept final {
    *fallback = nullptr;
    *error = m_code;
    *capability = nullptr;
...
[[noreturn]] inline void __stdcall fallback_RoFailFastWithErrorContext(
    int32_t) noexcept {
  abort();
}
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt {
  struct hresult_error {
    ...
    hresult_error(hresult_error const& other) noexcept
        : m_code(other.m_code), m_info(other.m_info) {}
    ...
    hresult_error(hresult const code, param::hstring const& message) noexcept
        : m_code(verify_error(code)) {
      originate(code, get_abi(message));
    }

    hresult_error(hresult const code, take_ownership_from_abi_t) noexcept
        : m_code(verify_error(code)) {
      ...
      if ((m_info = info.try_as<impl::IRestrictedErrorInfo>())) {
        ...
        if (legacy) {
          message = impl::trim_hresult_message(
    ...
    hstring message() const noexcept {
      if (m_info) {
        ...
        if (0 == m_info->GetErrorDetails(fallback.put(), &code, message.put(),
                                         unused.put())) {
          if (code == m_code) {
            if (message) {
              return impl::trim_hresult_message(
                  message.get(), WINRT_IMPL_SysStringLen(message.get()));
            } else {
              return impl::trim_hresult_message(
                  fallback.get(), WINRT_IMPL_SysStringLen(fallback.get()));
            }
          }
        }
      }
   ...
   private:
    static int32_t __stdcall fallback_RoOriginateLanguageException(
        int32_t error, void* message, void*) noexcept {
      com_ptr<impl::IErrorInfo> info(
          new (std::nothrow) impl::error_info_fallback(error, message),
          take_ownership_from_abi);
    ...
    void originate(hresult const code, void* message) noexcept {
      static int32_t(__stdcall * handler)(int32_t error, void* message,
                                          void* exception) noexcept;
      impl::load_runtime_function(L"combase.dll",
                                  "RoOriginateLanguageException", handler,
                                  fallback_RoOriginateLanguageException);
...
#pragma clang diagnostic pop
  ...
  struct hresult_access_denied : hresult_error {
    hresult_access_denied() noexcept
        : hresult_error(impl::error_access_denied) {}
    hresult_access_denied(param::hstring const& message) noexcept
        : hresult_error(impl::error_access_denied, message) {}
    hresult_access_denied(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_access_denied, take_ownership_from_abi) {}
  };

  struct hresult_wrong_thread : hresult_error {
    hresult_wrong_thread() noexcept : hresult_error(impl::error_wrong_thread) {}
    hresult_wrong_thread(param::hstring const& message) noexcept
        : hresult_error(impl::error_wrong_thread, message) {}
    hresult_wrong_thread(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_wrong_thread, take_ownership_from_abi) {}
  };

  struct hresult_not_implemented : hresult_error {
    hresult_not_implemented() noexcept
        : hresult_error(impl::error_not_implemented) {}
    hresult_not_implemented(param::hstring const& message) noexcept
        : hresult_error(impl::error_not_implemented, message) {}
    hresult_not_implemented(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_not_implemented, take_ownership_from_abi) {}
  };

  struct hresult_invalid_argument : hresult_error {
    hresult_invalid_argument() noexcept
        : hresult_error(impl::error_invalid_argument) {}
    hresult_invalid_argument(param::hstring const& message) noexcept
        : hresult_error(impl::error_invalid_argument, message) {}
    hresult_invalid_argument(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_invalid_argument, take_ownership_from_abi) {
    }
  };

  struct hresult_out_of_bounds : hresult_error {
    hresult_out_of_bounds() noexcept
        : hresult_error(impl::error_out_of_bounds) {}
    hresult_out_of_bounds(param::hstring const& message) noexcept
        : hresult_error(impl::error_out_of_bounds, message) {}
    hresult_out_of_bounds(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_out_of_bounds, take_ownership_from_abi) {}
  };

  struct hresult_no_interface : hresult_error {
    hresult_no_interface() noexcept : hresult_error(impl::error_no_interface) {}
    hresult_no_interface(param::hstring const& message) noexcept
        : hresult_error(impl::error_no_interface, message) {}
    hresult_no_interface(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_no_interface, take_ownership_from_abi) {}
  };

  struct hresult_class_not_available : hresult_error {
    hresult_class_not_available() noexcept
        : hresult_error(impl::error_class_not_available) {}
    hresult_class_not_available(param::hstring const& message) noexcept
        : hresult_error(impl::error_class_not_available, message) {}
    hresult_class_not_available(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_class_not_available,
                        take_ownership_from_abi) {}
  };

  struct hresult_class_not_registered : hresult_error {
    hresult_class_not_registered() noexcept
        : hresult_error(impl::error_class_not_registered) {}
    hresult_class_not_registered(param::hstring const& message) noexcept
        : hresult_error(impl::error_class_not_registered, message) {}
    hresult_class_not_registered(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_class_not_registered,
                        take_ownership_from_abi) {}
  };
  ...
  struct hresult_changed_state : hresult_error {
    hresult_changed_state() noexcept
        : hresult_error(impl::error_changed_state) {}
    hresult_changed_state(param::hstring const& message) noexcept
        : hresult_error(impl::error_changed_state, message) {}
    hresult_changed_state(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_changed_state, take_ownership_from_abi) {}
  };

  struct hresult_illegal_method_call : hresult_error {
    hresult_illegal_method_call() noexcept
        : hresult_error(impl::error_illegal_method_call) {}
    hresult_illegal_method_call(param::hstring const& message) noexcept
        : hresult_error(impl::error_illegal_method_call, message) {}
    hresult_illegal_method_call(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_illegal_method_call,
                        take_ownership_from_abi) {}
  };
  ...
  struct hresult_illegal_state_change : hresult_error {
    hresult_illegal_state_change() noexcept
        : hresult_error(impl::error_illegal_state_change) {}
    hresult_illegal_state_change(param::hstring const& message) noexcept
        : hresult_error(impl::error_illegal_state_change, message) {}
    hresult_illegal_state_change(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_illegal_state_change,
                        take_ownership_from_abi) {}
  };
  ...
  struct hresult_illegal_delegate_assignment : hresult_error {
    hresult_illegal_delegate_assignment() noexcept
        : hresult_error(impl::error_illegal_delegate_assignment) {}
    hresult_illegal_delegate_assignment(param::hstring const& message) noexcept
        : hresult_error(impl::error_illegal_delegate_assignment, message) {}
    hresult_illegal_delegate_assignment(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_illegal_delegate_assignment,
                        take_ownership_from_abi) {}
  };
  ...
  struct hresult_canceled : hresult_error {
    ...
    hresult_canceled(param::hstring const& message) noexcept
        : hresult_error(impl::error_canceled, message) {}
    hresult_canceled(take_ownership_from_abi_t) noexcept
        : hresult_error(impl::error_canceled, take_ownership_from_abi) {}
  };

  [[noreturn]] inline WINRT_IMPL_NOINLINE void throw_hresult(
      hresult const result) {
    if (winrt_throw_hresult_handler) {
      winrt_throw_hresult_handler(0, nullptr, nullptr,
                                  WINRT_IMPL_RETURNADDRESS(), result);
    }
  ...
  [[noreturn]] inline void terminate() noexcept {
    ...
    impl::load_runtime_function(L"combase.dll", "RoFailFastWithErrorContext",
                                handler,
                                impl::fallback_RoFailFastWithErrorContext);
    handler(to_hresult());
    abort();
  }
}
...
inline hresult check_hresult_allow_bounds(hresult const result) {
  if (result != impl::error_out_of_bounds && result != impl::error_fail &&
      result != impl::error_file_not_found) {
...
inline int32_t make_marshaler(unknown_abi* outer, void** result) noexcept {
  struct marshaler final : IMarshal {
    marshaler(unknown_abi* object) noexcept { m_object.copy_from(object); }
    ...
    int32_t __stdcall GetUnmarshalClass(guid const& riid, void* pv,
                                        uint32_t dwDestContext,
                                        void* pvDestContext, uint32_t mshlflags,
                                        guid* pCid) noexcept final {
      if (m_marshaler) {
        return m_marshaler->GetUnmarshalClass(riid, pv, dwDestContext,
    ...
    int32_t __stdcall GetMarshalSizeMax(guid const& riid, void* pv,
                                        uint32_t dwDestContext,
                                        void* pvDestContext, uint32_t mshlflags,
                                        uint32_t* pSize) noexcept final {
      if (m_marshaler) {
        return m_marshaler->GetMarshalSizeMax(riid, pv, dwDestContext,
    ...
    int32_t __stdcall MarshalInterface(void* pStm, guid const& riid, void* pv,
                                       uint32_t dwDestContext,
                                       void* pvDestContext,
                                       uint32_t mshlflags) noexcept final {
      if (m_marshaler) {
        return m_marshaler->MarshalInterface(pStm, riid, pv, dwDestContext,
    ...
    int32_t __stdcall UnmarshalInterface(void* pStm, guid const& riid,
                                         void** ppv) noexcept final {
      if (m_marshaler) {
   ...
   private:
    static com_ptr<IMarshal> get_marshaler() noexcept {
      ...
      WINRT_VERIFY_(0, WINRT_IMPL_CoCreateFreeThreadedMarshaler(
                           nullptr, unknown.put_void()));
...
#if defined(_MSC_VER)
#pragma warning(push)
#pragma warning(disable : 4458)  // declaration hides class member (okay because
                                 // we do not use named members of base class)
#endif
...
T make_delegate(H&& handler) {
  return {static_cast<void*>(static_cast<abi_t<T>*>(
              new delegate<T, H>(std::forward<H>(handler)))),
          take_ownership_from_abi};
}
...
struct variadic_delegate final : variadic_delegate_abi<R, Args...>,
                                 H,
                                 update_module_lock {
...
struct __declspec(empty_bases) delegate_base : Windows::Foundation::IUnknown {
  ...
  delegate_base(void* ptr, take_ownership_from_abi_t) noexcept
      : IUnknown(ptr, take_ownership_from_abi) {}

  template <typename L>
  delegate_base(L handler) : delegate_base(make(std::forward<L>(handler))) {}
  ...
  delegate_base(com_ptr<O>&& object, M method)
      : delegate_base([o = std::move(object), method](auto&&... args) {
          return ((*o).*(method))(args...);
        }) {}

  template <typename O, typename M>
  delegate_base(winrt::weak_ref<O>&& object, M method)
      : delegate_base([o = std::move(object), method](auto&&... args) {
          if (auto s = o.get()) {
            ((*s).*(method))(args...);
          }
 ...
 private:
  ...
  static delegate_base<R, Args...> make(H&& handler) {
    return {static_cast<void*>(
                new variadic_delegate<H, R, Args...>(std::forward<H>(handler))),
            take_ownership_from_abi};
  }
};
...
WINRT_EXPORT namespace winrt {
  ...
  struct __declspec(empty_bases)
      delegate<R(Args...)> : impl::delegate_base<R, Args...> {
...
WINRT_EXPORT namespace winrt {
  ...
  inline bool operator==(event_token const& left,
                         event_token const& right) noexcept {
  ...
  struct event_revoker {
    using method_type =
        int32_t (__stdcall impl::abi_t<I>::*)(winrt::event_token);
    ...
    event_revoker(U&& object, method_type method, event_token token)
        : m_object(std::forward<U>(object)), m_method(method), m_token(token) {}

    ~event_revoker() noexcept { revoke(); }
    ...
    explicit operator bool() const noexcept { return m_object ? true : false; }
  ...
  struct factory_event_revoker {
    ...
    template <typename U>
    factory_event_revoker(U&& object, method_type method,
                          event_token token) noexcept
        : m_object(std::forward<U>(object)), m_method(method), m_token(token) {}

    ~factory_event_revoker() noexcept { revoke(); }
...
struct event_revoker {
  ...
  void revoke() noexcept { revoke_impl(std::exchange(m_object, {}).get()); }

  explicit operator bool() const noexcept { return bool{m_object}; }
...
struct factory_event_revoker {
  ...
  void revoke() noexcept { revoke_impl(std::exchange(m_object, {})); }
...
struct event_array {
  ...
  unsigned long AddRef() noexcept { return ++m_references; }
  ...
  ~event_array() noexcept { std::destroy(begin(), end()); }
...
inline int32_t __stdcall fallback_RoTransformError(int32_t, int32_t,
                                                   void*) noexcept {
  return 1;
}
...
bool invoke(Delegate const& delegate, Arg const&... args) noexcept {
  try {
    ...
    impl::load_runtime_function(L"combase.dll", "RoTransformError", handler,
                                fallback_RoTransformError);
...
WINRT_EXPORT namespace winrt {
  ...
  struct event {
    ...
    explicit operator bool() const noexcept { return m_targets != nullptr; }
    ...
    event_token add(delegate_type const& delegate) {
...

      {
        ...
        delegate_array new_targets = impl::make_event_array<delegate_type>(
            (!m_targets) ? 1 : m_targets->size() + 1);

        if (m_targets) {
          std::copy_n(m_targets->begin(), m_targets->size(),
                      new_targets->begin());
        }
   ...
   private:
    event_token get_token(delegate_type const& delegate) const noexcept {
      return event_token{reinterpret_cast<int64_t>(
          WINRT_IMPL_EncodePointer(get_abi(delegate)))};
    }
...
struct library_traits {
  ...
  static void close(type value) noexcept { WINRT_IMPL_FreeLibrary(value); }
...
inline int32_t __stdcall fallback_RoGetActivationFactory(
    void*, guid const&, void** factory) noexcept {
  *factory = nullptr;
  return error_class_not_available;
}

template <bool isSameInterfaceAsIActivationFactory>
WINRT_IMPL_NOINLINE hresult get_runtime_activation_factory_impl(
    param::hstring const& name, winrt::guid const& guid,
    void** result) noexcept {
  if (winrt_activation_handler) {
    return winrt_activation_handler(*(void**)(&name), guid, result);
  }

  static int32_t(__stdcall * handler)(void* classId, winrt::guid const& iid,
                                      void** factory) noexcept;
  impl::load_runtime_function(L"combase.dll", "RoGetActivationFactory", handler,
                              fallback_RoGetActivationFactory);
  hresult hr = handler(*(void**)(&name), guid, result);

  if (hr == impl::error_not_initialized) {
    auto usage = reinterpret_cast<int32_t(__stdcall*)(void** cookie) noexcept>(
        WINRT_IMPL_GetProcAddress(WINRT_IMPL_LoadLibraryW(L"combase.dll"),
                                  "CoIncrementMTAUsage"));
  ...
  while (std::wstring::npos != (count = path.rfind('.'))) {
    ...
    auto library_call =
        reinterpret_cast<int32_t(__stdcall*)(void* classId, void** factory)>(
            WINRT_IMPL_GetProcAddress(library.get(),
...
hresult get_runtime_activation_factory(param::hstring const& name,
                                       void** result) noexcept {
  return get_runtime_activation_factory_impl<
      std::is_same_v<Interface, Windows::Foundation::IActivationFactory>>(
      name, guid_of<Interface>(), result);
}
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt {
  ...
  impl::com_ref<Interface> get_activation_factory(param::hstring const& name) {
    void* result{};
    check_hresult(
        impl::get_runtime_activation_factory<Interface>(name, &result));
    return {result, take_ownership_from_abi};
  }
}
...
inline int32_t interlocked_read_32(int32_t const volatile* target) noexcept {
  ...
  int32_t const result =
      __iso_volatile_load32(reinterpret_cast<int32_t const volatile*>(target));
...
#if defined _WIN64
    if (1 == _InterlockedCompareExchange128((int64_t*)this, 0, 0,
                                            (int64_t*)&current_value)) {
      pointer_value->Release();
    }
#else
    int64_t const result = _InterlockedCompareExchange64(
        (int64_t*)this, 0, *(int64_t*)&current_value);
...
struct factory_cache {
  ...
  void clear() noexcept {
    slist_entry* entry =
        static_cast<slist_entry*>(WINRT_IMPL_InterlockedFlushSList(&m_list));

    while (entry != nullptr) {
      // entry->next must be read before entry->clear() is called since the
      // InterlockedCompareExchange inside clear() will allow another thread to
  ...
  WINRT_IMPL_NOINLINE auto call(F&& callback) {
...

    {
      ...
      if (nullptr == _InterlockedCompareExchangePointer(
                         reinterpret_cast<void**>(&m_value.object),
                         *reinterpret_cast<void**>(&object), nullptr)) {
        *reinterpret_cast<void**>(&object) = nullptr;
      ...
      return callback(
          *reinterpret_cast<com_ref<Interface> const*>(&m_value.object));
    }
  }
};
...
template <typename Class,
          typename Interface = Windows::Foundation::IActivationFactory,
          typename F>
auto call_factory(F&& callback) {
...

  {
    ...
    if (factory.m_value.object) {
      return callback(*reinterpret_cast<com_ref<Interface> const*>(
          &factory.m_value.object));
    }
  }
...
template <typename CastType, typename Class,
          typename Interface = Windows::Foundation::IActivationFactory,
          typename F>
...
template <typename Interface = Windows::Foundation::IActivationFactory>
com_ref<Interface> try_get_activation_factory(
    param::hstring const& name, hresult_error* exception = nullptr) noexcept {
  void* result{};
...
template <typename D>
struct produce<D, Windows::Foundation::IActivationFactory>
    : produce_base<D, Windows::Foundation::IActivationFactory> {
...
WINRT_EXPORT namespace winrt {
  ...
  inline void init_apartment(apartment_type const type =
                                 apartment_type::multi_threaded) {
    hresult const result =
        WINRT_IMPL_CoInitializeEx(nullptr, static_cast<uint32_t>(type));
  ...
  inline void uninit_apartment() noexcept { WINRT_IMPL_CoUninitialize(); }

  template <typename Class,
            typename Interface = Windows::Foundation::IActivationFactory>
  auto get_activation_factory() {
    // Normally, the callback avoids having to return a ref-counted object and
    // the resulting AddRef/Release bump. In this case we do want a unique
    // reference, so we use the lambda to return one and thus produce an
    // AddRef'd object that is returned to the caller.
    return impl::call_factory<Class, Interface>(
        [](auto&& factory) { return factory; });
  }
  ...
  template <typename Interface = Windows::Foundation::IActivationFactory>
  auto try_get_activation_factory(param::hstring const& name,
                                  hresult_error& exception) noexcept {
  ...
  template <typename Interface>
  auto try_create_instance(guid const& clsid,
                           uint32_t context = 0x1 /*CLSCTX_INPROC_SERVER*/,
                           void* outer = nullptr) {
    return try_capture<Interface>(WINRT_IMPL_CoCreateInstance, clsid, outer,
                                  context);
  }

  template <typename Interface>
  auto create_instance(guid const& clsid,
                       uint32_t context = 0x1 /*CLSCTX_INPROC_SERVER*/,
                       void* outer = nullptr) {
    return capture<Interface>(WINRT_IMPL_CoCreateInstance, clsid, outer,
                              context);
  }
  ...
  struct IActivationFactory : IInspectable {
    ...
    IActivationFactory& operator=(IActivationFactory const&) & noexcept =
        default;
    ...
    T ActivateInstance() const {
      ...
      check_hresult((*(impl::abi_t<IActivationFactory>**)this)
                        ->ActivateInstance(put_abi(instance)));
...
T fast_activate(Windows::Foundation::IActivationFactory const& factory) {
  void* result{};
  check_hresult(
      (*(impl::abi_t<Windows::Foundation::IActivationFactory>**)&factory)
          ->ActivateInstance(&result));
  return {result, take_ownership_from_abi};
}
}  // namespace winrt::impl
#if defined(_MSC_VER)
...
#pragma detect_mismatch(                 \
    "C++/WinRT WINRT_NO_MAKE_DETECTION", \
    "make detection enabled (DEBUG and !WINRT_NO_MAKE_DETECTION)")
#else
#pragma detect_mismatch(                 \
    "C++/WinRT WINRT_NO_MAKE_DETECTION", \
    "make detection disabled (!DEBUG or WINRT_NO_MAKE_DETECTION)")
#endif
#endif
...
struct tuple_if_base<Condition, std::tuple<T...>> {
  using type =
      tuple_cat_t<typename std::conditional<Condition<T>::value, std::tuple<T>,
                                            std::tuple<>>::type...>;
};
...
template <typename T>
struct is_interface
    : std::disjunction<std::is_base_of<Windows::Foundation::IInspectable, T>,
                       std::conjunction<std::is_base_of<::IUnknown, T>,
...
template <typename T>
struct is_marker
    : std::disjunction<std::is_base_of<marker, T>, std::is_void<T>> {};
...
template <typename I>
struct is_cloaked
    : std::disjunction<std::is_same<Windows::Foundation::IInspectable, I>,
                       std::negation<std::is_base_of<
                           Windows::Foundation::IInspectable, I>>> {};
...
struct producer_ref : T {
  ...
  ~producer_ref() noexcept { detach_abi(*this); }
};
...
struct producer_convert : producer<D, typename default_interface<I>::type> {
  ...
  operator producer_vtable<I> const() const noexcept { return {(void*)this}; }
};
...
template <typename D, typename... T>
using producers =
    producers_base<D, tuple_if<is_interface, std::tuple<uncloak<T>...>>>;
...
struct nested_implements<First, Rest...>
    : std::conditional_t<is_implements_v<First>, impl::identity<First>,
                         nested_implements<Rest...>> {
  static_assert(!is_implements_v<First> ||
...
struct base_implements_impl : impl::identity<root_implements<D, I...>> {};

template <typename D, typename... I>
struct base_implements_impl<
    D, std::void_t<typename nested_implements<I...>::type>, I...>
    : nested_implements<I...> {};
...
template <typename D, typename... I>
struct has_static_lifetime<implements<D, I...>>
    : std::disjunction<std::is_same<static_lifetime, I>...> {};

template <typename D>
inline constexpr bool has_static_lifetime_v =
    has_static_lifetime<typename D::implements_type>::value;
...
template <typename T>
void zero_abi([[maybe_unused]] void* ptr,
              [[maybe_unused]] uint32_t const capacity) noexcept {
  if constexpr (!std::is_trivially_destructible_v<T>) {
...
WINRT_EXPORT namespace winrt {
  template <typename D, typename I>
  D* get_self(I const& from) noexcept {
    return &static_cast<impl::produce<D, default_interface<I>>*>(get_abi(from))
                ->shim();
  }
  ...
  impl::abi_t<I>* to_abi(impl::producer<D, I> const* from) noexcept {
    return reinterpret_cast<impl::abi_t<I>*>(
        const_cast<impl::producer<D, I>*>(from));
  }

  template <typename I, typename D>
  impl::abi_t<I>* to_abi(impl::producer_convert<D, I> const* from) noexcept {
    return reinterpret_cast<impl::abi_t<I>*>(
        (impl::producer<D, default_interface<I>>*)from);
  }
}
...
struct interface_list_append_impl;
...
struct filter_impl<Predicate, interface_list<T...>, Rest...> {
  using type =
      typename interface_list_append_impl<filter<Predicate, T...>,
                                          filter<Predicate, Rest...>>::type;
};

template <template <typename> class Predicate, typename D, typename... I,
          typename... Rest>
struct filter_impl<Predicate, winrt::implements<D, I...>, Rest...> {
  using type =
      typename interface_list_append_impl<filter<Predicate, I...>,
                                          filter<Predicate, Rest...>>::type;
};

template <typename T>
using implemented_interfaces =
    filter<is_interface, typename T::implements_type>;

template <typename T>
struct is_uncloaked_interface
    : std::conjunction<is_interface<T>,
                       std::negation<winrt::impl::is_cloaked<T>>> {};
template <typename T>
using uncloaked_interfaces =
    filter<is_uncloaked_interface, typename T::implements_type>;
...
struct implements_default_interface {
  using type = typename default_interface<
      typename implemented_interfaces<T>::first_interface>::type;
};
...
auto find_iid(const T* obj, const guid& iid) noexcept {
  return static_cast<unknown_abi*>(
      implemented_interfaces<T>::find(obj, iid_finder{iid}));
}
...
inspectable_abi* find_inspectable(const T* obj) noexcept {
  ...
  if constexpr (std::is_base_of_v<inspectable_abi, abi_t<default_interface>>) {
    ...
    return static_cast<inspectable_abi*>(
        implemented_interfaces<T>::find(obj, inspectable_finder{}));
  }
}

template <typename I, typename = std::void_t<>>
struct runtime_class_name {
  static hstring get() { throw hresult_not_implemented{}; }
};

template <typename I>
struct runtime_class_name<I, std::void_t<decltype(name_v<I>)>> {
  static hstring get() { return hstring{name_of<I>()}; }
};

template <>
struct runtime_class_name<Windows::Foundation::IInspectable> {
  static hstring get() { return {}; }
};
...
struct produce_base : abi_t<I> {
  ...
  uint32_t __stdcall AddRef() noexcept override { return shim().AddRef(); }

  uint32_t __stdcall Release() noexcept override { return shim().Release(); }

  int32_t __stdcall GetIids(uint32_t* count, guid** array) noexcept override {
    return shim().GetIids(reinterpret_cast<count_type*>(count),
                          reinterpret_cast<guid_type**>(array));
  }
  ...
  int32_t __stdcall GetTrustLevel(
      Windows::Foundation::TrustLevel* trustLevel) noexcept final {
...
struct producer<
    D, I,
    std::enable_if_t<std::is_base_of_v<::IUnknown, I> && !is_implements_v<I>>>
    : I {};
...
template <>
struct abi<INonDelegatingInspectable> {
  using type = inspectable_abi;
};

template <typename D>
struct produce<D, INonDelegatingInspectable>
    : produce_base<D, INonDelegatingInspectable> {
  int32_t __stdcall QueryInterface(const guid& id,
                                   void** object) noexcept final {
...
struct weak_source final : IWeakReferenceSource,
                           module_lock_updater<UseModuleLock> {
  weak_ref<Agile, UseModuleLock>* that() noexcept {
    return static_cast<weak_ref<Agile, UseModuleLock>*>(
        reinterpret_cast<weak_source_producer<Agile, UseModuleLock>*>(this));
  }
  ...
  int32_t __stdcall GetWeakReference(
      IWeakReference** weakReference) noexcept final {
    *weakReference = that();
    that()->AddRef();
    return 0;
  }
...
template <bool Agile, bool UseModuleLock>
struct weak_ref final : IWeakReference,
                        weak_source_producer<Agile, UseModuleLock> {
  weak_ref(unknown_abi* object, uint32_t const strong) noexcept
      : m_object(object), m_strong(strong) {
    WINRT_ASSERT(object);
  }
  ...
  int32_t __stdcall Resolve(guid const& id,
                            void** objectReference) noexcept final {
    ...
    while (true) {
      ...
      if (m_strong.compare_exchange_weak(target, target + 1,
  ...
  void set_strong(uint32_t const count) noexcept { m_strong = count; }
  ...
  uint32_t decrement_strong() noexcept {
    uint32_t const target =
        m_strong.fetch_sub(1, std::memory_order_release) - 1;
 ...
 private:
  ...
  static_assert(sizeof(weak_source_producer<Agile, UseModuleLock>) ==
                sizeof(weak_source<Agile, UseModuleLock>));
...
struct __declspec(empty_bases) root_implements_composing_outer<true> {
  ...
  explicit operator bool() const noexcept { return m_inner.operator bool(); }
...
template <typename D>
struct __declspec(empty_bases) root_implements_composable_inner<D, true>
    : producer<D, INonDelegatingInspectable> {
 protected:
...
struct __declspec(novtable) root_implements
    : root_implements_composing_outer<
          std::disjunction_v<std::is_same<composing, I>...>>,
      root_implements_composable_inner<
          D, std::disjunction_v<std::is_same<composable, I>...>>,
      module_lock_updater<
          !std::disjunction_v<std::is_same<no_module_lock, I>...>> {
  ...
  int32_t __stdcall QueryInterface(guid const& id, void** object) noexcept {
    ...
    if (result == error_no_interface && this->m_inner) {
      result = static_cast<unknown_abi*>(get_abi(this->m_inner))
  ...
  struct abi_guard {
    abi_guard(D& derived) : m_derived(derived) { m_derived.abi_enter(); }

    ~abi_guard() { m_derived.abi_exit(); }
...
#if defined(_DEBUG) && !defined(WINRT_NO_MAKE_DETECTION)
  // Please use winrt::make<T>(args...) to avoid allocating a C++/WinRT
  // implementation type on the stack.
 ...
 protected:
  ...
  virtual ~root_implements() noexcept {
    // If a weak reference is created during destruction, this ensures that it
    // is also destroyed.
    subtract_reference();
  }
  ...
  int32_t __stdcall abi_GetTrustLevel(
      Windows::Foundation::TrustLevel* trustLevel) noexcept {
    if (this->outer()) {
  ...
  uint32_t __stdcall NonDelegatingAddRef() noexcept {
    if constexpr (is_weak_ref_source::value) {
      ...
      while (true) {
        ...
        if (m_references.compare_exchange_weak(count_or_pointer, target,
                                               std::memory_order_relaxed)) {
  ...
  uint32_t __stdcall NonDelegatingRelease() noexcept {
    ...
    if (target == 0) {
      // If a weak reference was previously created, the m_references value will
      // not be stable value (won't be zero). This ensures destruction has a
      // stable value during destruction.
      m_references = 1;
  ...
  int32_t __stdcall NonDelegatingQueryInterface(const guid& id,
                                                void** object) noexcept {
  ...
  int32_t __stdcall NonDelegatingGetIids(uint32_t* count,
                                         guid** array) noexcept {
    ...
    if constexpr (root_implements_type::is_composing) {
      if (local_count > 0) {
        const com_array<guid>& inner_iids =
            get_interfaces(root_implements_type::m_inner);
        *count = local_count + inner_iids.size();
        *array = static_cast<guid*>(
            WINRT_IMPL_CoTaskMemAlloc(sizeof(guid) * (*count)));
        if (*array == nullptr) {
          return error_bad_alloc;
        }
        *array = std::copy(local_iids.second, local_iids.second + local_count,
                           *array);
        std::copy(inner_iids.cbegin(), inner_iids.cend(), *array);
      } else {
        return static_cast<inspectable_abi*>(
                   get_abi(root_implements_type::m_inner))
            ->GetIids(count, array);
      }
    } else {
      if (local_count > 0) {
  ...
  int32_t __stdcall NonDelegatingGetTrustLevel(
      Windows::Foundation::TrustLevel* trustLevel) noexcept try {
 ...
 private:
  class has_final_release {
    template <typename U,
              typename = decltype(std::declval<U>().final_release(0))>
  ...
  using is_agile =
      std::negation<std::disjunction<std::is_same<non_agile, I>...>>;
  using is_inspectable = std::disjunction<
      std::is_base_of<Windows::Foundation::IInspectable, I>...>;
  using is_weak_ref_source = std::conjunction<
      is_inspectable,
      std::negation<std::disjunction<std::is_same<no_weak_ref, I>...>>>;
  using use_module_lock =
      std::negation<std::disjunction<std::is_same<no_module_lock, I>...>>;
  using weak_ref_t = impl::weak_ref<is_agile::value, use_module_lock::value>;

  std::atomic<
      std::conditional_t<is_weak_ref_source::value, uintptr_t, uint32_t>>
      m_references{1};
  ...
  impl::IWeakReferenceSource* make_weak_ref() noexcept {
    static_assert(is_weak_ref_source::value,
    ...
    *weak_ref.put() = new (std::nothrow)
    ...
    for (;;) {
      if (m_references.compare_exchange_weak(count_or_pointer, encoding,
  ...
  static uintptr_t encode_weak_ref(weak_ref_t* value) noexcept {
    static_assert(is_weak_ref_source::value,
                  "This is only for weak ref support.");
    constexpr uintptr_t pointer_flag = static_cast<uintptr_t>(1)
...
inline com_ptr<IStaticLifetimeCollection> get_static_lifetime_map() {
  auto const lifetime_factory = get_activation_factory<impl::IStaticLifetime>(
...
auto make_factory() -> typename impl::implements_default_interface<D>::type {
  ...
  if constexpr (!has_static_lifetime_v<D>) {
    return {to_abi<result_type>(new heap_implements<D>),
            take_ownership_from_abi};
  } else {
    ...
    result_type object{to_abi<result_type>(new heap_implements<D>),
                       take_ownership_from_abi};
...
WINRT_EXPORT namespace winrt {
  ...
  auto make(Args && ... args) {
    ...
    static_assert(
        ...
        "C++/WinRT implementation types must have a public destructor");
    ...
    if constexpr (std::is_same_v<I, Windows::Foundation::IActivationFactory>) {
      ...
      impl::com_ref<I> result{
          to_abi<I>(new impl::heap_implements<D>(std::forward<Args>(args)...)),
          take_ownership_from_abi};
      return result.template as<typename D::composable>();
    } else if constexpr (impl::has_class_type<D>::value) {
      static_assert(
          std::is_same_v<I, default_interface<typename D::class_type>>);
      return typename D::class_type{
          to_abi<I>(new impl::heap_implements<D>(std::forward<Args>(args)...)),
          take_ownership_from_abi};
    } else {
      return impl::com_ref<I>{
          to_abi<I>(new impl::heap_implements<D>(std::forward<Args>(args)...)),
          take_ownership_from_abi};
    }
  }
  ...
  com_ptr<D> make_self(Args && ... args) {
    ...
    if constexpr (std::is_same_v<
      ...
      return {new impl::heap_implements<D>(std::forward<Args>(args)...),
              take_ownership_from_abi};
    }
  }
  ...
  inline void clear_factory_static_lifetime() {
    auto unregister = [map = impl::get_static_lifetime_map()](
                          param::hstring name) { map->Remove(get_abi(name)); };
  ...
  struct implements : impl::producers<D, I...>,
   ...
   public:
    ...
    impl::hresult_type __stdcall QueryInterface(impl::guid_type const& id,
                                                void** object) noexcept {
      return root_implements_type::QueryInterface(
          reinterpret_cast<guid const&>(id), object);
    }
    ...
    impl::hresult_type __stdcall GetIids(impl::count_type* count,
                                         impl::guid_type** iids) noexcept {
      return root_implements_type::GetIids(reinterpret_cast<uint32_t*>(count),
                                           reinterpret_cast<guid**>(iids));
    }

    impl::hresult_type __stdcall GetRuntimeClassName(
        impl::hstring_type* value) noexcept {
      return root_implements_type::abi_GetRuntimeClassName(
          reinterpret_cast<void**>(value));
    }

    using root_implements_type::GetTrustLevel;

    impl::hresult_type __stdcall GetTrustLevel(
        impl::trust_level_type* value) noexcept {
      return root_implements_type::abi_GetTrustLevel(
          reinterpret_cast<Windows::Foundation::TrustLevel*>(value));
    }
    ...
    std::pair<uint32_t, const guid*> get_local_iids() const noexcept override {
      ...
      return {static_cast<uint32_t>(local_iids::value.size()),
              local_iids::value.data()};
    }

   private:
    impl::unknown_abi* get_unknown() const noexcept override {
      return reinterpret_cast<impl::unknown_abi*>(
          to_abi<typename impl::implements_default_interface<D>::type>(this));
    }

    hstring GetRuntimeClassName() const override {
      return impl::runtime_class_name<
          typename impl::implements_default_interface<D>::type>::get();
    }
...
struct composable_factory {
  ...
  static I CreateInstance(const Windows::Foundation::IInspectable& outer,
    ...
    static_assert(std::is_base_of_v<Windows::Foundation::IInspectable, I>,
                  "Requested interface must derive from "
 ...
 private:
  template <typename... Args>
  static Windows::Foundation::IInspectable CreateInstanceImpl(
      const Windows::Foundation::IInspectable& outer, Args&&... args) {
    // Very specific dance here. The return value must have a ref on the outer,
    // while inner must have a ref count of 1. Be sure not to make a delegating
    // QueryInterface call because the controlling outer is not fully
    // constructed yet.
...
class __declspec(empty_bases) produce_dispatch_to_overridable_base {
 protected:
  D& shim() noexcept { return static_cast<T&>(*this).instance; }
...
class dispatch_to_overridable {
 ...
 public:
  static wrapper overridable(D& instance) noexcept { return wrapper{instance}; }
};
}  // namespace winrt::impl
...
WINRT_EXPORT namespace winrt::Windows::Foundation {
  struct Point {
    ...
    operator Numerics::float2() const noexcept { return {X, Y}; }
  ...
  struct Size {
    ...
    operator Numerics::float2() const noexcept { return {Width, Height}; }
...
namespace winrt::impl {
template <>
inline constexpr auto& name_v<Windows::Foundation::Point> =
    L"Windows.Foundation.Point";
template <>
inline constexpr auto& name_v<Windows::Foundation::Size> =
    L"Windows.Foundation.Size";
template <>
inline constexpr auto& name_v<Windows::Foundation::Rect> =
    L"Windows.Foundation.Rect";

template <>
struct category<Windows::Foundation::Point> {
  using type = struct_category<float, float>;
};

template <>
struct category<Windows::Foundation::Size> {
  using type = struct_category<float, float>;
};

template <>
struct category<Windows::Foundation::Rect> {
...
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::float2> =
    L"Windows.Foundation.Numerics.Vector2";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::float3> =
    L"Windows.Foundation.Numerics.Vector3";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::float4> =
    L"Windows.Foundation.Numerics.Vector4";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::float3x2> =
    L"Windows.Foundation.Numerics.Matrix3x2";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::float4x4> =
    L"Windows.Foundation.Numerics.Matrix4x4";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::quaternion> =
    L"Windows.Foundation.Numerics.Quaternion";
template <>
inline constexpr auto& name_v<Windows::Foundation::Numerics::plane> =
    L"Windows.Foundation.Numerics.Plane";

template <>
struct category<Windows::Foundation::Numerics::float2> {
  using type = struct_category<float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::float3> {
  using type = struct_category<float, float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::float4> {
  using type = struct_category<float, float, float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::float3x2> {
  using type = struct_category<float, float, float, float, float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::float4x4> {
  using type =
      struct_category<float, float, float, float, float, float, float, float,
                      float, float, float, float, float, float, float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::quaternion> {
  using type = struct_category<float, float, float, float>;
};

template <>
struct category<Windows::Foundation::Numerics::plane> {
  ...
  struct clock {
    ...
    static time_t to_time_t(time_point const& time) noexcept {
      return static_cast<time_t>(
          std::chrono::system_clock::to_time_t(to_sys(time)));
    }
    ...
    template <typename Duration>
    static std::chrono::time_point<
        clock, std::common_type_t<Duration, std::chrono::seconds>>
    from_sys(std::chrono::time_point<std::chrono::system_clock, Duration> const&
                 tp) {
      using result_t = std::chrono::time_point<
          clock, std::common_type_t<Duration, std::chrono::seconds>>;
   ...
   private:
    ...
    // This is 11644473600 seconds after Windows FILETIME epoch of 00:00:00, Jan
    // 1 1601.
    static constexpr std::chrono::time_point<std::chrono::system_clock,
                                             std::chrono::seconds>
        epoch{std::chrono::seconds{-11644473600}};
  };
}
...
WINRT_EXPORT namespace winrt {
  struct access_token : handle {
    static access_token process() {
      access_token token;
      check_bool(WINRT_IMPL_OpenProcessToken(WINRT_IMPL_GetCurrentProcess(),
                                             0x0002 /*TOKEN_DUPLICATE*/,
                                             token.put()));
      access_token duplicate;
      check_bool(WINRT_IMPL_DuplicateToken(
          token.get(), 2 /*SecurityImpersonation*/, duplicate.put()));
      return duplicate;
    }
    ...
    static access_token thread() {
      ...
      if (!WINRT_IMPL_OpenThreadToken(WINRT_IMPL_GetCurrentThread(),
                                      0x0004 /*TOKEN_IMPERSONATE*/, 1,
                                      token.put())) {
    ...
    static access_token client() {
      struct impersonate_guard {
        ...
        ~impersonate_guard() { check_hresult(m_server->RevertToSelf()); }
    ...
    auto operator()() const {
      struct guard {
        ...
        ~guard() { m_previous.revert(); }

        guard(guard const&) {
          // A Visual C++ compiler bug (550631) requires the copy constructor
...
struct hash_base {
  size_t operator()(Windows::Foundation::IUnknown const& value) const noexcept {
    void* const abi_value =
        get_abi(value.try_as<Windows::Foundation::IUnknown>());
...
template <>
struct hash<winrt::Windows::Foundation::IUnknown> : winrt::impl::hash_base {};
template <>
struct hash<winrt::Windows::Foundation::IInspectable> : winrt::impl::hash_base {
};
template <>
struct hash<winrt::Windows::Foundation::IActivationFactory>
...
struct fast_iterator {
  ...
  fast_iterator& operator-=(difference_type n) noexcept { return *this += -n; }
  ...
  reference operator*() const { return m_collection->GetAt(m_index); }
...
namespace winrt::impl {
inline auto submit_threadpool_callback(void(__stdcall* callback)(void*,
                                                                 void* context),
                                       void* context) {
...
inline void __stdcall resume_background_callback(void*,
...
struct resume_apartment_context {
  ...
  resume_apartment_context& operator=(resume_apartment_context const&) =
      default;
  ...
  bool valid() const noexcept { return m_context_type >= 0; }

  com_ptr<IContextCallback> m_context =
      try_capture<IContextCallback>(WINRT_IMPL_CoGetObjectContext);
...
inline void resume_apartment_sync(com_ptr<IContextCallback> const& context,
                                  coroutine_handle<> handle) {
  com_callback_args args{};
  args.data = handle.address();

  check_hresult(context->ContextCallback(
      resume_apartment_callback, &args,
      guid_of<ICallbackWithNoReentrancyToApplicationSTA>(), 5, nullptr));
}
...
inline void resume_apartment_on_threadpool(
    com_ptr<IContextCallback> const& context, coroutine_handle<> handle) {
...
inline auto resume_apartment(resume_apartment_context const& context,
                             coroutine_handle<> handle) {
...
class awaiter_finder {
  template <typename>
  static constexpr bool find_awaitable_member(...) {
    return false;
  }
  template <typename>
  static constexpr bool find_co_await_member(...) {
    return false;
  }
  template <typename>
  static constexpr bool find_co_await_free(...) {
    return false;
  }

#ifdef WINRT_IMPL_COROUTINES
  template <typename U, typename = decltype(std::declval<U>().await_ready())>
  static constexpr bool find_awaitable_member(int) {
    return true;
  }
  template <typename U,
            typename = decltype(std::declval<U>().operator co_await())>
  static constexpr bool find_co_await_member(int) {
    return true;
  }
  template <typename U,
            typename = decltype(operator co_await(std::declval<U>()))>
  static constexpr bool find_co_await_free(int) {
    return true;
  }
#endif
...
WINRT_EXPORT namespace winrt {
  struct cancellable_promise {
    ...
    void revoke_canceller() {
      while (m_canceller.exchange(nullptr, std::memory_order_acquire) ==
             cancelling_ptr) {
    ...
    void cancel() {
      auto canceller =
          m_canceller.exchange(cancelling_ptr, std::memory_order_acquire);
...
decltype(auto) get_awaiter(T&& value) noexcept {
  ...
  if constexpr (awaiter_finder<T>::has_co_await_member) {
    static_assert(
        !awaiter_finder<T>::has_co_await_free,
        "Ambiguous operator co_await (as both member and free function).");
    return static_cast<T&&>(value).operator co_await();
  } else if constexpr (awaiter_finder<T>::has_co_await_free) {
    return operator co_await(static_cast<T&&>(value));
  } else {
    static_assert(awaiter_finder<T>::has_awaitable_member,
...
struct notify_awaiter {
  ...
  notify_awaiter(T&& awaitable_arg,
                 [[maybe_unused]] cancellable_promise* promise = nullptr)
      : awaitable(get_awaiter(static_cast<T&&>(awaitable_arg))) {
    if constexpr (std::is_convertible_v<
                      std::remove_reference_t<decltype(awaitable)>&,
                      enable_await_cancellation&>) {
      if (promise) {
        static_cast<enable_await_cancellation&>(awaitable)
            .set_cancellable_promise(promise);
...
WINRT_EXPORT namespace winrt {
  ...
  [[nodiscard]] inline auto resume_after(
      Windows::Foundation::TimeSpan duration) noexcept {
    struct awaitable : enable_await_cancellation {
      ...
      void enable_cancellation(cancellable_promise* promise) {
        promise->set_canceller(
            [](void* context) {
              auto that = static_cast<awaitable*>(context);
              if (that->m_state.exchange(state::canceled,
                                         std::memory_order_acquire) ==
                  state::pending) {
      ...
      bool await_ready() const noexcept { return m_duration.count() <= 0; }

      void await_suspend(impl::coroutine_handle<> handle) {
        m_handle = handle;
        m_timer.attach(check_pointer(
            WINRT_IMPL_CreateThreadpoolTimer(callback, this, nullptr)));
      ...
      void await_resume() {
        if (m_state.exchange(state::idle, std::memory_order_relaxed) ==
            state::canceled) {
     ...
     private:
      static int32_t __stdcall fallback_SetThreadpoolTimerEx(
          winrt::impl::ptp_timer, void*, uint32_t, uint32_t) noexcept {
        return 0;  // pretend timer has already triggered and a callback is on
                   // its way
      }

      void fire_immediately() noexcept {
        static int32_t(__stdcall * handler)(winrt::impl::ptp_timer, void*,
                                            uint32_t, uint32_t) noexcept;
        impl::load_runtime_function(L"kernel32.dll", "SetThreadpoolTimerEx",
                                    handler, fallback_SetThreadpoolTimerEx);
  ...
  [[nodiscard]] inline auto resume_on_signal(
      void* handle, Windows::Foundation::TimeSpan timeout = {}) noexcept {
    struct awaitable : enable_await_cancellation {
      ...
      void await_suspend(impl::coroutine_handle<> resume) {
        m_resume = resume;
        m_wait.attach(check_pointer(
            WINRT_IMPL_CreateThreadpoolWait(callback, this, nullptr)));
     ...
     private:
      static int32_t __stdcall fallback_SetThreadpoolWaitEx(
          winrt::impl::ptp_wait, void*, void*, void*) noexcept {
        return 0;  // pretend wait has already triggered and a callback is on
                   // its way
      }

      void fire_immediately() noexcept {
        static int32_t(__stdcall * handler)(winrt::impl::ptp_wait, void*, void*,
                                            void*) noexcept;
        impl::load_runtime_function(L"kernel32.dll", "SetThreadpoolWaitEx",
                                    handler, fallback_SetThreadpoolWaitEx);

        if (handler(m_wait.get(), nullptr, nullptr, nullptr)) {
          int64_t now = 0;
          WINRT_IMPL_SetThreadpoolWait(m_wait.get(),
                                       WINRT_IMPL_GetCurrentProcess(), &now);
        }
      }

      static void __stdcall callback(void*, void* context, void*,
  ...
  struct thread_pool {
    ...
    void await_suspend(impl::coroutine_handle<> handle) {
      if (!WINRT_IMPL_TrySubmitThreadpoolCallback(callback, handle.address(),
                                                  &m_environment)) {
        throw_last_error();
      }
    }
...
struct coroutine_traits<winrt::fire_and_forget, Args...> {
  struct promise_type {
    winrt::fire_and_forget get_return_object() const noexcept { return {}; }
    ...
    void unhandled_exception() const noexcept { winrt::terminate(); }
...
namespace winrt::impl {
struct natvis {
  static auto __stdcall abi_val(void* object, wchar_t const* iid_str,
                                int method) {
    union variant {
      bool b;
      wchar_t c;
    ...
    if (WINRT_IMPL_IIDFromString(iid_str, &iid) == 0) {
      ...
      if ((WINRT_IMPL_VirtualQuery(object, &info, sizeof(info)) != 0) &&
          ((info.protect & 0xEE) != 0)) {
        inspectable_abi* pinsp;
        if (((unknown_abi*)object)
                ->QueryInterface(iid, reinterpret_cast<void**>(&pinsp)) == 0) {
          static const int IInspectable_vtbl_size = 6;
          auto vtbl = *(void***)pinsp;
          // validate vtbl pointer is readable
          if ((WINRT_IMPL_VirtualQuery(vtbl, &info, sizeof(info)) != 0) &&
              ((info.protect & 0xEE) != 0)) {
            auto vfunc = vtbl[method + IInspectable_vtbl_size];
            // validate method pointer is executable
            if ((WINRT_IMPL_VirtualQuery(vfunc, &info, sizeof(info)) != 0) &&
                ((info.protect & 0xF0) != 0)) {
              typedef int32_t (__stdcall inspectable_abi::*PropertyAccessor)(
                  void*);
  ...
  static auto __stdcall get_val(
      winrt::Windows::Foundation::IInspectable* object, wchar_t const* iid_str,
      int method) {
    return abi_val(static_cast<unknown_abi*>(get_abi(*object)), iid_str,
                   method);
  }
};
}  // namespace winrt::impl
...
extern "C" __declspec(
    selectany) decltype(winrt::impl::natvis::abi_val)& WINRT_abi_val =
    winrt::impl::natvis::abi_val;

extern "C" __declspec(
    selectany) decltype(winrt::impl::natvis::get_val)& WINRT_get_val =
    winrt::impl::natvis::get_val;
...
// WINRT_version is used by Microsoft to analyze C++/WinRT library adoption and
// inform future product decisions.
extern "C" __declspec(selectany) char const* const WINRT_version =
    "C++/WinRT version:" CPPWINRT_VERSION;
...
WINRT_EXPORT namespace winrt {
  ...
  constexpr bool check_version(char const(&base)[BaseSize],
                               char const(&component)[ComponentSize]) noexcept {
