...
consume_Windows_UI_Composition_Desktop_IDesktopWindowTarget<D>::IsTopmost()
    const {
  bool value{};
  check_hresult(
      WINRT_IMPL_SHIM(
...
struct produce<D,
               winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget>
    : produce_base<
          D, winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget> {
...
#ifndef WINRT_LEAN_AND_MEAN
template <>
struct hash<winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Windows::UI::Composition::Desktop::DesktopWindowTarget>
    : winrt::impl::hash_base {};
#endif
}  // namespace std
#endif
