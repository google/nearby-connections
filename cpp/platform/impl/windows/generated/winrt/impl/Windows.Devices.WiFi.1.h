...
WINRT_EXPORT namespace winrt::Windows::Devices::WiFi {
  struct __declspec(empty_bases) IWiFiAdapter
    ...
    IWiFiAdapter(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IWiFiAdapter2
    ...
    IWiFiAdapter2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IWiFiAdapterStatics
    ...
    IWiFiAdapterStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWiFiAdapterStatics(IWiFiAdapterStatics const&) noexcept = default;
    IWiFiAdapterStatics(IWiFiAdapterStatics&&) noexcept = default;
    IWiFiAdapterStatics& operator=(IWiFiAdapterStatics const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IWiFiAvailableNetwork
    ...
    IWiFiAvailableNetwork(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IWiFiAvailableNetwork& operator=(IWiFiAvailableNetwork const&) & noexcept =
        default;
    IWiFiAvailableNetwork& operator=(IWiFiAvailableNetwork&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWiFiConnectionResult
    ...
    IWiFiConnectionResult(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IWiFiConnectionResult& operator=(IWiFiConnectionResult const&) & noexcept =
        default;
    IWiFiConnectionResult& operator=(IWiFiConnectionResult&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWiFiNetworkReport
    ...
    IWiFiNetworkReport(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWiFiNetworkReport(IWiFiNetworkReport const&) noexcept = default;
    IWiFiNetworkReport(IWiFiNetworkReport&&) noexcept = default;
    IWiFiNetworkReport& operator=(IWiFiNetworkReport const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IWiFiWpsConfigurationResult
    ...
    IWiFiWpsConfigurationResult(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWiFiWpsConfigurationResult(IWiFiWpsConfigurationResult const&) noexcept =
        default;
    IWiFiWpsConfigurationResult(IWiFiWpsConfigurationResult&&) noexcept =
        default;
    IWiFiWpsConfigurationResult& operator=(
        IWiFiWpsConfigurationResult const&) & noexcept = default;
    IWiFiWpsConfigurationResult& operator=(
        IWiFiWpsConfigurationResult&&) & noexcept = default;
  };
}
#endif
