...
WINRT_EXPORT namespace winrt::Windows::UI::Text {
  struct __declspec(empty_bases) IContentLinkInfo
    ...
    IContentLinkInfo(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IFontWeightsStatics
    ...
    IFontWeightsStatics& operator=(IFontWeightsStatics const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IRichEditTextRange
    ...
    IRichEditTextRange(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IRichEditTextRange(IRichEditTextRange const&) noexcept = default;
    IRichEditTextRange(IRichEditTextRange&&) noexcept = default;
    IRichEditTextRange& operator=(IRichEditTextRange const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ITextCharacterFormat
    ...
    ITextCharacterFormat& operator=(ITextCharacterFormat const&) & noexcept =
        default;
    ITextCharacterFormat& operator=(ITextCharacterFormat&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ITextConstantsStatics
    ...
    ITextConstantsStatics& operator=(ITextConstantsStatics const&) & noexcept =
        default;
    ITextConstantsStatics& operator=(ITextConstantsStatics&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) ITextDocument3
    ...
    ITextDocument3(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ITextDocument4
    ...
    ITextDocument4(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ITextParagraphFormat
    ...
    ITextParagraphFormat& operator=(ITextParagraphFormat const&) & noexcept =
        default;
    ITextParagraphFormat& operator=(ITextParagraphFormat&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) ITextSelection
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::UI::Text::ITextSelection,
