...
WINRT_EXPORT namespace winrt::Windows::Web::AtomPub {
  struct __declspec(empty_bases) AtomPubClient
      : winrt::Windows::Web::AtomPub::IAtomPubClient {
    AtomPubClient(std::nullptr_t) noexcept {}
    AtomPubClient(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Web::AtomPub::IAtomPubClient(
              ptr, take_ownership_from_abi) {}
    AtomPubClient();
    explicit AtomPubClient(
  ...
  struct __declspec(empty_bases) ResourceCollection
      : winrt::Windows::Web::AtomPub::IResourceCollection {
    ResourceCollection(std::nullptr_t) noexcept {}
    ResourceCollection(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Web::AtomPub::IResourceCollection(
              ptr, take_ownership_from_abi) {}
    ResourceCollection(ResourceCollection const&) noexcept = default;
    ResourceCollection(ResourceCollection&&) noexcept = default;
    ResourceCollection& operator=(ResourceCollection const&) & noexcept =
        default;
    ResourceCollection& operator=(ResourceCollection&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ServiceDocument
      : winrt::Windows::Web::AtomPub::IServiceDocument {
    ServiceDocument(std::nullptr_t) noexcept {}
    ServiceDocument(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Web::AtomPub::IServiceDocument(
              ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) Workspace
      : winrt::Windows::Web::AtomPub::IWorkspace {
    Workspace(std::nullptr_t) noexcept {}
    Workspace(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Web::AtomPub::IWorkspace(ptr,
