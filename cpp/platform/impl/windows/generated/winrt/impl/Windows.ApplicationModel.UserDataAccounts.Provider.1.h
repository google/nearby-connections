...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::UserDataAccounts::
  ...
  struct __declspec(empty_bases) IUserDataAccountPartnerAccountInfo
    ...
    IUserDataAccountPartnerAccountInfo(void* ptr,
                                       take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IUserDataAccountPartnerAccountInfo(
        IUserDataAccountPartnerAccountInfo const&) noexcept = default;
    IUserDataAccountPartnerAccountInfo(
        IUserDataAccountPartnerAccountInfo&&) noexcept = default;
    IUserDataAccountPartnerAccountInfo& operator=(
        IUserDataAccountPartnerAccountInfo const&) & noexcept = default;
    IUserDataAccountPartnerAccountInfo& operator=(
        IUserDataAccountPartnerAccountInfo&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IUserDataAccountProviderAddAccountOperation
    ...
    IUserDataAccountProviderAddAccountOperation(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IUserDataAccountProviderAddAccountOperation(
        IUserDataAccountProviderAddAccountOperation const&) noexcept = default;
    IUserDataAccountProviderAddAccountOperation(
        IUserDataAccountProviderAddAccountOperation&&) noexcept = default;
    IUserDataAccountProviderAddAccountOperation& operator=(
        IUserDataAccountProviderAddAccountOperation const&) & noexcept =
        default;
    IUserDataAccountProviderAddAccountOperation& operator=(
        IUserDataAccountProviderAddAccountOperation&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IUserDataAccountProviderOperation
    ...
    IUserDataAccountProviderOperation(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IUserDataAccountProviderOperation(
        IUserDataAccountProviderOperation const&) noexcept = default;
    IUserDataAccountProviderOperation(
        IUserDataAccountProviderOperation&&) noexcept = default;
    IUserDataAccountProviderOperation& operator=(
        IUserDataAccountProviderOperation const&) & noexcept = default;
    IUserDataAccountProviderOperation& operator=(
        IUserDataAccountProviderOperation&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IUserDataAccountProviderResolveErrorsOperation
    ...
    IUserDataAccountProviderResolveErrorsOperation(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IUserDataAccountProviderResolveErrorsOperation(
        IUserDataAccountProviderResolveErrorsOperation const&) noexcept =
        default;
    IUserDataAccountProviderResolveErrorsOperation(
        IUserDataAccountProviderResolveErrorsOperation&&) noexcept = default;
    IUserDataAccountProviderResolveErrorsOperation& operator=(
        IUserDataAccountProviderResolveErrorsOperation const&) & noexcept =
        default;
    IUserDataAccountProviderResolveErrorsOperation& operator=(
        IUserDataAccountProviderResolveErrorsOperation&&) & noexcept = default;
  ...
  struct __declspec(empty_bases) IUserDataAccountProviderSettingsOperation
    ...
    IUserDataAccountProviderSettingsOperation(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IUserDataAccountProviderSettingsOperation(
        IUserDataAccountProviderSettingsOperation const&) noexcept = default;
    IUserDataAccountProviderSettingsOperation(
        IUserDataAccountProviderSettingsOperation&&) noexcept = default;
    IUserDataAccountProviderSettingsOperation& operator=(
        IUserDataAccountProviderSettingsOperation const&) & noexcept = default;
    IUserDataAccountProviderSettingsOperation& operator=(
        IUserDataAccountProviderSettingsOperation&&) & noexcept = default;
  };
