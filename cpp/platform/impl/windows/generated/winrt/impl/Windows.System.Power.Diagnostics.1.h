...
WINRT_EXPORT namespace winrt::Windows::System::Power::Diagnostics {
  struct __declspec(empty_bases) IBackgroundEnergyDiagnosticsStatics
    ...
    IBackgroundEnergyDiagnosticsStatics(void* ptr,
                                        take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IBackgroundEnergyDiagnosticsStatics(
        IBackgroundEnergyDiagnosticsStatics const&) noexcept = default;
    IBackgroundEnergyDiagnosticsStatics(
        IBackgroundEnergyDiagnosticsStatics&&) noexcept = default;
    IBackgroundEnergyDiagnosticsStatics& operator=(
        IBackgroundEnergyDiagnosticsStatics const&) & noexcept = default;
    IBackgroundEnergyDiagnosticsStatics& operator=(
        IBackgroundEnergyDiagnosticsStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IForegroundEnergyDiagnosticsStatics
    ...
    IForegroundEnergyDiagnosticsStatics(void* ptr,
                                        take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IForegroundEnergyDiagnosticsStatics(
        IForegroundEnergyDiagnosticsStatics const&) noexcept = default;
    IForegroundEnergyDiagnosticsStatics(
        IForegroundEnergyDiagnosticsStatics&&) noexcept = default;
    IForegroundEnergyDiagnosticsStatics& operator=(
        IForegroundEnergyDiagnosticsStatics const&) & noexcept = default;
    IForegroundEnergyDiagnosticsStatics& operator=(
        IForegroundEnergyDiagnosticsStatics&&) & noexcept = default;
  };
