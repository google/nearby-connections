...
WINRT_EXPORT namespace winrt::Windows::UI::Input::Inking::Preview {
  struct __declspec(empty_bases) IPalmRejectionDelayZonePreview
    ...
    IPalmRejectionDelayZonePreview(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPalmRejectionDelayZonePreview(
        IPalmRejectionDelayZonePreview const&) noexcept = default;
    IPalmRejectionDelayZonePreview(IPalmRejectionDelayZonePreview&&) noexcept =
        default;
    IPalmRejectionDelayZonePreview& operator=(
        IPalmRejectionDelayZonePreview const&) & noexcept = default;
    IPalmRejectionDelayZonePreview& operator=(
        IPalmRejectionDelayZonePreview&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPalmRejectionDelayZonePreviewStatics
    ...
    IPalmRejectionDelayZonePreviewStatics(void* ptr,
                                          take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPalmRejectionDelayZonePreviewStatics(
        IPalmRejectionDelayZonePreviewStatics const&) noexcept = default;
    IPalmRejectionDelayZonePreviewStatics(
        IPalmRejectionDelayZonePreviewStatics&&) noexcept = default;
    IPalmRejectionDelayZonePreviewStatics& operator=(
        IPalmRejectionDelayZonePreviewStatics const&) & noexcept = default;
    IPalmRejectionDelayZonePreviewStatics& operator=(
        IPalmRejectionDelayZonePreviewStatics&&) & noexcept = default;
  };
