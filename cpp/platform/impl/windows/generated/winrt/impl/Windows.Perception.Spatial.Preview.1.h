...
WINRT_EXPORT namespace winrt::Windows::Perception::Spatial::Preview {
  struct __declspec(empty_bases) ISpatialGraphInteropFrameOfReferencePreview
    ...
    ISpatialGraphInteropFrameOfReferencePreview(
        ISpatialGraphInteropFrameOfReferencePreview const&) noexcept = default;
    ISpatialGraphInteropFrameOfReferencePreview(
        ISpatialGraphInteropFrameOfReferencePreview&&) noexcept = default;
    ISpatialGraphInteropFrameOfReferencePreview& operator=(
        ISpatialGraphInteropFrameOfReferencePreview const&) & noexcept =
        default;
    ISpatialGraphInteropFrameOfReferencePreview& operator=(
        ISpatialGraphInteropFrameOfReferencePreview&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISpatialGraphInteropPreviewStatics
    ...
    ISpatialGraphInteropPreviewStatics(void* ptr,
                                       take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISpatialGraphInteropPreviewStatics(
        ISpatialGraphInteropPreviewStatics const&) noexcept = default;
    ISpatialGraphInteropPreviewStatics(
        ISpatialGraphInteropPreviewStatics&&) noexcept = default;
    ISpatialGraphInteropPreviewStatics& operator=(
        ISpatialGraphInteropPreviewStatics const&) & noexcept = default;
    ISpatialGraphInteropPreviewStatics& operator=(
        ISpatialGraphInteropPreviewStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISpatialGraphInteropPreviewStatics2
    ...
    ISpatialGraphInteropPreviewStatics2(void* ptr,
                                        take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISpatialGraphInteropPreviewStatics2(
        ISpatialGraphInteropPreviewStatics2 const&) noexcept = default;
    ISpatialGraphInteropPreviewStatics2(
        ISpatialGraphInteropPreviewStatics2&&) noexcept = default;
    ISpatialGraphInteropPreviewStatics2& operator=(
        ISpatialGraphInteropPreviewStatics2 const&) & noexcept = default;
    ISpatialGraphInteropPreviewStatics2& operator=(
        ISpatialGraphInteropPreviewStatics2&&) & noexcept = default;
  };
