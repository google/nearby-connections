...
WINRT_EXPORT namespace winrt::Windows::UI::Composition::Desktop {
  struct __declspec(empty_bases) IDesktopWindowTarget
    ...
    IDesktopWindowTarget(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IDesktopWindowTarget& operator=(IDesktopWindowTarget const&) & noexcept =
        default;
    IDesktopWindowTarget& operator=(IDesktopWindowTarget&&) & noexcept =
        default;
  };
}
#endif
