...
WINRT_EXPORT namespace winrt::Windows::Devices::Custom {
  struct __declspec(empty_bases) ICustomDevice
    ...
    ICustomDevice(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) ICustomDeviceStatics
    ...
    ICustomDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    ICustomDeviceStatics& operator=(ICustomDeviceStatics const&) & noexcept =
        default;
    ICustomDeviceStatics& operator=(ICustomDeviceStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IIOControlCode
    ...
    IIOControlCode(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IIOControlCodeFactory
    ...
    IIOControlCodeFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IIOControlCodeFactory& operator=(IIOControlCodeFactory const&) & noexcept =
        default;
    IIOControlCodeFactory& operator=(IIOControlCodeFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IKnownDeviceTypesStatics
    ...
    IKnownDeviceTypesStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IKnownDeviceTypesStatics(IKnownDeviceTypesStatics const&) noexcept =
        default;
    IKnownDeviceTypesStatics(IKnownDeviceTypesStatics&&) noexcept = default;
    IKnownDeviceTypesStatics& operator=(
        IKnownDeviceTypesStatics const&) & noexcept = default;
    IKnownDeviceTypesStatics& operator=(IKnownDeviceTypesStatics&&) & noexcept =
        default;
  };
}
#endif
