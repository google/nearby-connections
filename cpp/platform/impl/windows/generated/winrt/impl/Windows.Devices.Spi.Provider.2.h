...
WINRT_EXPORT namespace winrt::Windows::Devices::Spi::Provider {
  struct __declspec(empty_bases) ProviderSpiConnectionSettings
      : winrt::Windows::Devices::Spi::Provider::IProviderSpiConnectionSettings {
    ProviderSpiConnectionSettings(std::nullptr_t) noexcept {}
    ProviderSpiConnectionSettings(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Spi::Provider::
              IProviderSpiConnectionSettings(ptr, take_ownership_from_abi) {}
    explicit ProviderSpiConnectionSettings(int32_t chipSelectLine);
    ProviderSpiConnectionSettings(
        ProviderSpiConnectionSettings const&) noexcept = default;
    ProviderSpiConnectionSettings(ProviderSpiConnectionSettings&&) noexcept =
        default;
    ProviderSpiConnectionSettings& operator=(
        ProviderSpiConnectionSettings const&) & noexcept = default;
    ProviderSpiConnectionSettings& operator=(
        ProviderSpiConnectionSettings&&) & noexcept = default;
  };
}
#endif
