...
WINRT_EXPORT namespace winrt::Windows::Gaming::Input::ForceFeedback {
  struct __declspec(empty_bases) IConditionForceEffect
    ...
    IConditionForceEffect(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IConditionForceEffect& operator=(IConditionForceEffect const&) & noexcept =
        default;
    IConditionForceEffect& operator=(IConditionForceEffect&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IConditionForceEffectFactory
    ...
    IConditionForceEffectFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IConditionForceEffectFactory(IConditionForceEffectFactory const&) noexcept =
        default;
    IConditionForceEffectFactory(IConditionForceEffectFactory&&) noexcept =
        default;
    IConditionForceEffectFactory& operator=(
        IConditionForceEffectFactory const&) & noexcept = default;
    IConditionForceEffectFactory& operator=(
        IConditionForceEffectFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IConstantForceEffect
    ...
    IConstantForceEffect(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IConstantForceEffect& operator=(IConstantForceEffect const&) & noexcept =
        default;
    IConstantForceEffect& operator=(IConstantForceEffect&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IForceFeedbackEffect
    ...
    IForceFeedbackEffect(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IForceFeedbackEffect& operator=(IForceFeedbackEffect const&) & noexcept =
        default;
    IForceFeedbackEffect& operator=(IForceFeedbackEffect&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IForceFeedbackMotor
    ...
    IForceFeedbackMotor(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IForceFeedbackMotor(IForceFeedbackMotor const&) noexcept = default;
    IForceFeedbackMotor(IForceFeedbackMotor&&) noexcept = default;
    IForceFeedbackMotor& operator=(IForceFeedbackMotor const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IPeriodicForceEffect
    ...
    IPeriodicForceEffect(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IPeriodicForceEffect& operator=(IPeriodicForceEffect const&) & noexcept =
        default;
    IPeriodicForceEffect& operator=(IPeriodicForceEffect&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPeriodicForceEffectFactory
    ...
    IPeriodicForceEffectFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPeriodicForceEffectFactory(IPeriodicForceEffectFactory const&) noexcept =
        default;
    IPeriodicForceEffectFactory(IPeriodicForceEffectFactory&&) noexcept =
        default;
    IPeriodicForceEffectFactory& operator=(
        IPeriodicForceEffectFactory const&) & noexcept = default;
    IPeriodicForceEffectFactory& operator=(
        IPeriodicForceEffectFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IRampForceEffect
    ...
    IRampForceEffect(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
