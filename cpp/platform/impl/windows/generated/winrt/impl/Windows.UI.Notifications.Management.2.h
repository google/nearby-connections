...
WINRT_EXPORT namespace winrt::Windows::UI::Notifications::Management {
  struct __declspec(empty_bases) UserNotificationListener
      : winrt::Windows::UI::Notifications::Management::
            IUserNotificationListener {
    UserNotificationListener(std::nullptr_t) noexcept {}
    UserNotificationListener(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::Notifications::Management::
              IUserNotificationListener(ptr, take_ownership_from_abi) {}
    UserNotificationListener(UserNotificationListener const&) noexcept =
        default;
    UserNotificationListener(UserNotificationListener&&) noexcept = default;
    UserNotificationListener& operator=(
        UserNotificationListener const&) & noexcept = default;
    UserNotificationListener& operator=(UserNotificationListener&&) & noexcept =
        default;
