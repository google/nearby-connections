...
template <>
struct category<winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::
                    IShareOperation> {
  using type = interface_category;
};
template <>
...
inline constexpr auto& name_v<
    winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::QuickLink> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.QuickLink";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::DataTransfer::
                                  ShareTarget::ShareOperation> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.ShareOperation";
template <>
inline constexpr auto& name_v<
    winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::IQuickLink> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.IQuickLink";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::DataTransfer::
                                  ShareTarget::IShareOperation> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.IShareOperation";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::DataTransfer::
                                  ShareTarget::IShareOperation2> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.IShareOperation2";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::DataTransfer::
                                  ShareTarget::IShareOperation3> =
    L"Windows.ApplicationModel.DataTransfer.ShareTarget.IShareOperation3";
template <>
inline constexpr guid guid_v<
    ...
    0xF0BE,
    0x4ADC,
    {0xAC, 0xC9, 0x8B, 0x27, 0xAB, 0x9C, 0xF5,
     0x56}};  // 603E4308-F0BE-4ADC-ACC9-8B27AB9CF556
template <>
inline constexpr guid guid_v<winrt::Windows::ApplicationModel::DataTransfer::
    ...
    0xD0F8,
    0x41C1,
    {0xA8, 0x2A, 0x41, 0x37, 0xDB, 0x65, 0x04,
     0xFB}};  // 2246BAB8-D0F8-41C1-A82A-4137DB6504FB
template <>
inline constexpr guid guid_v<winrt::Windows::ApplicationModel::DataTransfer::
                                 ShareTarget::IShareOperation2>{
    0x0FFB97C1,
    0x9778,
    0x4A09,
    {0x8E, 0x5B, 0xCB, 0x5E, 0x48, 0x2D, 0x05,
     0x55}};  // 0FFB97C1-9778-4A09-8E5B-CB5E482D0555
template <>
inline constexpr guid guid_v<winrt::Windows::ApplicationModel::DataTransfer::
                                 ShareTarget::IShareOperation3>{
    0x5EF6B382,
    0xB7A7,
    0x4571,
    {0xA2, 0xA6, 0x99, 0x4A, 0x03, 0x49, 0x88,
     0xB2}};  // 5EF6B382-B7A7-4571-A2A6-994A034988B2
template <>
...
struct default_interface<winrt::Windows::ApplicationModel::DataTransfer::
                             ShareTarget::ShareOperation> {
  using type = winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::
      IShareOperation;
};
template <>
struct abi<
...
template <>
struct abi<winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::
               IShareOperation> {
  struct __declspec(novtable) type : inspectable_abi {
...
struct consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IQuickLink {
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      ...
      SupportedDataFormats() const;
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::Foundation::Collections::IVector<hstring>)
      SupportedFileTypes() const;
};
template <>
struct consume<
    winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::IQuickLink> {
...
struct
  ...
  WINRT_IMPL_AUTO(void)
  ReportCompleted(winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::
                      QuickLink const& quicklink) const;
  WINRT_IMPL_AUTO(void) ReportCompleted() const;
  WINRT_IMPL_AUTO(void) ReportError(param::hstring const& value) const;
};
template <>
struct consume<winrt::Windows::ApplicationModel::DataTransfer::ShareTarget::
                   IShareOperation> {
  template <typename D>
  using type =
      consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IShareOperation<
