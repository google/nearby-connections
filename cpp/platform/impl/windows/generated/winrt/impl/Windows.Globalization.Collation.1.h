...
WINRT_EXPORT namespace winrt::Windows::Globalization::Collation {
  struct __declspec(empty_bases) ICharacterGrouping
    ...
    ICharacterGrouping(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    ICharacterGrouping& operator=(ICharacterGrouping const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ICharacterGroupings
    ...
    ICharacterGroupings(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICharacterGroupings(ICharacterGroupings const&) noexcept = default;
    ICharacterGroupings(ICharacterGroupings&&) noexcept = default;
    ICharacterGroupings& operator=(ICharacterGroupings const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ICharacterGroupingsFactory
    ...
    ICharacterGroupingsFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICharacterGroupingsFactory(ICharacterGroupingsFactory const&) noexcept =
        default;
    ICharacterGroupingsFactory(ICharacterGroupingsFactory&&) noexcept = default;
    ICharacterGroupingsFactory& operator=(
        ICharacterGroupingsFactory const&) & noexcept = default;
    ICharacterGroupingsFactory& operator=(
        ICharacterGroupingsFactory&&) & noexcept = default;
  };
}
#endif
