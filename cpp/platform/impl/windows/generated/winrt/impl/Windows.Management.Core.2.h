...
WINRT_EXPORT namespace winrt::Windows::Management::Core {
  struct __declspec(empty_bases) ApplicationDataManager
      : winrt::Windows::Management::Core::IApplicationDataManager {
    ApplicationDataManager(std::nullptr_t) noexcept {}
    ApplicationDataManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Core::IApplicationDataManager(
    ...
    ApplicationDataManager& operator=(
        ApplicationDataManager const&) & noexcept = default;
    ApplicationDataManager& operator=(ApplicationDataManager&&) & noexcept =
        default;
