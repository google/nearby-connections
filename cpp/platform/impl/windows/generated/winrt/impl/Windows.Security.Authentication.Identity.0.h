...
template <>
struct category<winrt::Windows::Security::Authentication::Identity::
...
inline constexpr auto&
    name_v<winrt::Windows::Security::Authentication::Identity::
               EnterpriseKeyCredentialRegistrationInfo> =
        L"Windows.Security.Authentication.Identity."
        L"EnterpriseKeyCredentialRegistrationInfo";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Security::Authentication::Identity::
               EnterpriseKeyCredentialRegistrationManager> =
        L"Windows.Security.Authentication.Identity."
        L"EnterpriseKeyCredentialRegistrationManager";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationInfo> =
        L"Windows.Security.Authentication.Identity."
        L"IEnterpriseKeyCredentialRegistrationInfo";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationManager> =
        L"Windows.Security.Authentication.Identity."
        L"IEnterpriseKeyCredentialRegistrationManager";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationManagerStatics> =
        L"Windows.Security.Authentication.Identity."
        L"IEnterpriseKeyCredentialRegistrationManagerStatics";
template <>
inline constexpr guid
    guid_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationInfo>{
        0x38321ACC,
        0x672B,
        0x4823,
        {0xB6, 0x03, 0x6B, 0x3C, 0x75, 0x3D, 0xAF,
         0x97}};  // 38321ACC-672B-4823-B603-6B3C753DAF97
template <>
inline constexpr guid
    guid_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationManager>{
        ...
        0xA25F,
        0x4CBA,
        {0xBB, 0x8E, 0xBD, 0xC3, 0x2D, 0x03, 0xC2,
         0x97}};  // 83F3BE3F-A25F-4CBA-BB8E-BDC32D03C297
template <>
inline constexpr guid
    guid_v<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationManagerStatics>{
        ...
        0xACF4,
        0x4BC0,
        {0xBA, 0xC2, 0x40, 0xBB, 0x46, 0xEF, 0xBB,
         0x3F}};  // 77B85E9E-ACF4-4BC0-BAC2-40BB46EFBB3F
template <>
struct default_interface<winrt::Windows::Security::Authentication::Identity::
                             EnterpriseKeyCredentialRegistrationInfo> {
  using type = winrt::Windows::Security::Authentication::Identity::
      IEnterpriseKeyCredentialRegistrationInfo;
};
template <>
struct default_interface<winrt::Windows::Security::Authentication::Identity::
...
template <>
struct abi<winrt::Windows::Security::Authentication::Identity::
               IEnterpriseKeyCredentialRegistrationInfo> {
...
template <typename D>
struct
    consume_Windows_Security_Authentication_Identity_IEnterpriseKeyCredentialRegistrationInfo {
...
template <>
struct consume<winrt::Windows::Security::Authentication::Identity::
                   IEnterpriseKeyCredentialRegistrationInfo> {
  template <typename D>
  using type =
      consume_Windows_Security_Authentication_Identity_IEnterpriseKeyCredentialRegistrationInfo<
...
template <typename D>
struct
    consume_Windows_Security_Authentication_Identity_IEnterpriseKeyCredentialRegistrationManager {
  WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<
                  winrt::Windows::Foundation::Collections::IVectorView<
                      winrt::Windows::Security::Authentication::Identity::
                          EnterpriseKeyCredentialRegistrationInfo>>)
  GetRegistrationsAsync() const;
};
template <>
struct consume<winrt::Windows::Security::Authentication::Identity::
                   IEnterpriseKeyCredentialRegistrationManager> {
...
template <typename D>
struct
    consume_Windows_Security_Authentication_Identity_IEnterpriseKeyCredentialRegistrationManagerStatics {
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::Security::Authentication::Identity::
          EnterpriseKeyCredentialRegistrationManager) Current() const;
};
template <>
struct consume<winrt::Windows::Security::Authentication::Identity::
                   IEnterpriseKeyCredentialRegistrationManagerStatics> {
