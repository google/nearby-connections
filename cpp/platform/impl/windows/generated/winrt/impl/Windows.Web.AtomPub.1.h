...
WINRT_EXPORT namespace winrt::Windows::Web::AtomPub {
  struct __declspec(empty_bases) IAtomPubClient
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Web::AtomPub::IAtomPubClient,
                      winrt::Windows::Web::Syndication::ISyndicationClient> {
    IAtomPubClient(std::nullptr_t = nullptr) noexcept {}
    IAtomPubClient(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IAtomPubClientFactory
    ...
    IAtomPubClientFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IAtomPubClientFactory& operator=(IAtomPubClientFactory const&) & noexcept =
        default;
    IAtomPubClientFactory& operator=(IAtomPubClientFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IResourceCollection
      : winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IResourceCollection>,
        impl::require<winrt::Windows::Web::AtomPub::IResourceCollection,
                      winrt::Windows::Web::Syndication::ISyndicationNode> {
    IResourceCollection(std::nullptr_t = nullptr) noexcept {}
    IResourceCollection(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IResourceCollection(IResourceCollection const&) noexcept = default;
    IResourceCollection(IResourceCollection&&) noexcept = default;
    IResourceCollection& operator=(IResourceCollection const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IServiceDocument
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Web::AtomPub::IServiceDocument,
                      winrt::Windows::Web::Syndication::ISyndicationNode> {
    IServiceDocument(std::nullptr_t = nullptr) noexcept {}
    IServiceDocument(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IWorkspace
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Web::AtomPub::IWorkspace,
                      winrt::Windows::Web::Syndication::ISyndicationNode> {
    IWorkspace(std::nullptr_t = nullptr) noexcept {}
    IWorkspace(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
