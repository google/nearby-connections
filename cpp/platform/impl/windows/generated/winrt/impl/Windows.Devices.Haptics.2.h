...
WINRT_EXPORT namespace winrt::Windows::Devices::Haptics {
  ...
  struct __declspec(empty_bases) SimpleHapticsController
      : winrt::Windows::Devices::Haptics::ISimpleHapticsController {
    SimpleHapticsController(std::nullptr_t) noexcept {}
    SimpleHapticsController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Haptics::ISimpleHapticsController(
    ...
    SimpleHapticsController& operator=(
        SimpleHapticsController const&) & noexcept = default;
    SimpleHapticsController& operator=(SimpleHapticsController&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) SimpleHapticsControllerFeedback
      : winrt::Windows::Devices::Haptics::ISimpleHapticsControllerFeedback {
    SimpleHapticsControllerFeedback(std::nullptr_t) noexcept {}
    SimpleHapticsControllerFeedback(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Haptics::ISimpleHapticsControllerFeedback(
              ptr, take_ownership_from_abi) {}
    SimpleHapticsControllerFeedback(
        SimpleHapticsControllerFeedback const&) noexcept = default;
    SimpleHapticsControllerFeedback(
        SimpleHapticsControllerFeedback&&) noexcept = default;
    SimpleHapticsControllerFeedback& operator=(
        SimpleHapticsControllerFeedback const&) & noexcept = default;
    SimpleHapticsControllerFeedback& operator=(
        SimpleHapticsControllerFeedback&&) & noexcept = default;
  };
  struct __declspec(empty_bases) VibrationDevice
      : winrt::Windows::Devices::Haptics::IVibrationDevice {
    VibrationDevice(std::nullptr_t) noexcept {}
    VibrationDevice(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Haptics::IVibrationDevice(
              ptr, take_ownership_from_abi) {}
