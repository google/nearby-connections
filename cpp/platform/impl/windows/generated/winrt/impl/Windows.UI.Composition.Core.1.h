...
WINRT_EXPORT namespace winrt::Windows::UI::Composition::Core {
  struct __declspec(empty_bases) ICompositorController
    ...
    ICompositorController(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    ICompositorController& operator=(ICompositorController const&) & noexcept =
        default;
    ICompositorController& operator=(ICompositorController&&) & noexcept =
        default;
  };
}
#endif
