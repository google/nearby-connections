...
WINRT_EXPORT namespace winrt::Windows::Devices::Pwm {
  struct __declspec(empty_bases) IPwmController
    ...
    IPwmController(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IPwmControllerStatics
    ...
    IPwmControllerStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IPwmControllerStatics& operator=(IPwmControllerStatics const&) & noexcept =
        default;
    IPwmControllerStatics& operator=(IPwmControllerStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPwmControllerStatics2
    ...
    IPwmControllerStatics2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IPwmControllerStatics2& operator=(
        IPwmControllerStatics2 const&) & noexcept = default;
    IPwmControllerStatics2& operator=(IPwmControllerStatics2&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPwmControllerStatics3
    ...
    IPwmControllerStatics3(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IPwmControllerStatics3& operator=(
        IPwmControllerStatics3 const&) & noexcept = default;
    IPwmControllerStatics3& operator=(IPwmControllerStatics3&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPwmPin
      : winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IPwmPin>,
        impl::require<winrt::Windows::Devices::Pwm::IPwmPin,
                      winrt::Windows::Foundation::IClosable> {
    IPwmPin(std::nullptr_t = nullptr) noexcept {}
    IPwmPin(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
