...
WINRT_EXPORT namespace winrt::Windows::Devices::I2c::Provider {
  struct __declspec(empty_bases) II2cControllerProvider
    ...
    II2cControllerProvider(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    II2cControllerProvider& operator=(
        II2cControllerProvider const&) & noexcept = default;
    II2cControllerProvider& operator=(II2cControllerProvider&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) II2cDeviceProvider
    ...
    II2cDeviceProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    II2cDeviceProvider(II2cDeviceProvider const&) noexcept = default;
    II2cDeviceProvider(II2cDeviceProvider&&) noexcept = default;
    II2cDeviceProvider& operator=(II2cDeviceProvider const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) II2cProvider
    ...
    II2cProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IProviderI2cConnectionSettings
    ...
    IProviderI2cConnectionSettings(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IProviderI2cConnectionSettings(
        IProviderI2cConnectionSettings const&) noexcept = default;
    IProviderI2cConnectionSettings(IProviderI2cConnectionSettings&&) noexcept =
        default;
    IProviderI2cConnectionSettings& operator=(
        IProviderI2cConnectionSettings const&) & noexcept = default;
    IProviderI2cConnectionSettings& operator=(
        IProviderI2cConnectionSettings&&) & noexcept = default;
  };
}
#endif
