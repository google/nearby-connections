...
WINRT_EXPORT namespace winrt::Windows::UI::Shell {
  struct __declspec(empty_bases) IAdaptiveCard
    ...
    IAdaptiveCard(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IAdaptiveCardBuilderStatics
    ...
    IAdaptiveCardBuilderStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IAdaptiveCardBuilderStatics(IAdaptiveCardBuilderStatics const&) noexcept =
        default;
    IAdaptiveCardBuilderStatics(IAdaptiveCardBuilderStatics&&) noexcept =
        default;
    IAdaptiveCardBuilderStatics& operator=(
        IAdaptiveCardBuilderStatics const&) & noexcept = default;
    IAdaptiveCardBuilderStatics& operator=(
        IAdaptiveCardBuilderStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISecurityAppManager
    ...
    ISecurityAppManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISecurityAppManager(ISecurityAppManager const&) noexcept = default;
    ISecurityAppManager(ISecurityAppManager&&) noexcept = default;
    ISecurityAppManager& operator=(ISecurityAppManager const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ITaskbarManager
    ...
    ITaskbarManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ITaskbarManager2
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::UI::Shell::ITaskbarManager2,
                      winrt::Windows::UI::Shell::ITaskbarManager> {
    ITaskbarManager2(std::nullptr_t = nullptr) noexcept {}
    ITaskbarManager2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ITaskbarManagerStatics
    ...
    ITaskbarManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    ITaskbarManagerStatics& operator=(
        ITaskbarManagerStatics const&) & noexcept = default;
    ITaskbarManagerStatics& operator=(ITaskbarManagerStatics&&) & noexcept =
        default;
  };
}
#endif
