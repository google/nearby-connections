...
WINRT_EXPORT namespace winrt::Windows::Security::Cryptography {
  struct __declspec(empty_bases) ICryptographicBufferStatics
    ...
    ICryptographicBufferStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICryptographicBufferStatics(ICryptographicBufferStatics const&) noexcept =
        default;
    ICryptographicBufferStatics(ICryptographicBufferStatics&&) noexcept =
        default;
    ICryptographicBufferStatics& operator=(
        ICryptographicBufferStatics const&) & noexcept = default;
    ICryptographicBufferStatics& operator=(
        ICryptographicBufferStatics&&) & noexcept = default;
  };
}
#endif
