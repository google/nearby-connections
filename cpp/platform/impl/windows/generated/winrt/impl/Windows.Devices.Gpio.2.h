...
WINRT_EXPORT namespace winrt::Windows::Devices::Gpio {
  ...
  inline bool operator==(GpioChangeCount const& left,
                         GpioChangeCount const& right) noexcept {
  ...
  inline bool operator==(GpioChangeRecord const& left,
                         GpioChangeRecord const& right) noexcept {
  ...
  struct __declspec(empty_bases) GpioChangeCounter
      : winrt::Windows::Devices::Gpio::IGpioChangeCounter {
    GpioChangeCounter(std::nullptr_t) noexcept {}
    GpioChangeCounter(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Gpio::IGpioChangeCounter(
              ptr, take_ownership_from_abi) {}
    explicit GpioChangeCounter(
  ...
  struct __declspec(empty_bases) GpioChangeReader
      : winrt::Windows::Devices::Gpio::IGpioChangeReader {
    GpioChangeReader(std::nullptr_t) noexcept {}
    GpioChangeReader(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Gpio::IGpioChangeReader(
              ptr, take_ownership_from_abi) {}
    explicit GpioChangeReader(
        winrt::Windows::Devices::Gpio::GpioPin const& pin);
    GpioChangeReader(winrt::Windows::Devices::Gpio::GpioPin const& pin,
                     int32_t minCapacity);
  ...
  struct __declspec(empty_bases) GpioController
      : winrt::Windows::Devices::Gpio::IGpioController {
    GpioController(std::nullptr_t) noexcept {}
    GpioController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Gpio::IGpioController(
              ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) GpioPin
      : winrt::Windows::Devices::Gpio::IGpioPin {
    GpioPin(std::nullptr_t) noexcept {}
    GpioPin(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Gpio::IGpioPin(ptr,
  ...
  struct __declspec(empty_bases) GpioPinValueChangedEventArgs
      : winrt::Windows::Devices::Gpio::IGpioPinValueChangedEventArgs {
    GpioPinValueChangedEventArgs(std::nullptr_t) noexcept {}
    GpioPinValueChangedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Gpio::IGpioPinValueChangedEventArgs(
              ptr, take_ownership_from_abi) {}
    GpioPinValueChangedEventArgs(GpioPinValueChangedEventArgs const&) noexcept =
        default;
    GpioPinValueChangedEventArgs(GpioPinValueChangedEventArgs&&) noexcept =
        default;
    GpioPinValueChangedEventArgs& operator=(
        GpioPinValueChangedEventArgs const&) & noexcept = default;
    GpioPinValueChangedEventArgs& operator=(
        GpioPinValueChangedEventArgs&&) & noexcept = default;
  };
}
#endif
