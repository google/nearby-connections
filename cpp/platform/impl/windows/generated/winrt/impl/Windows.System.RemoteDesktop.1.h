...
WINRT_EXPORT namespace winrt::Windows::System::RemoteDesktop {
  struct __declspec(empty_bases) IInteractiveSessionStatics
    ...
    IInteractiveSessionStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IInteractiveSessionStatics(IInteractiveSessionStatics const&) noexcept =
        default;
    IInteractiveSessionStatics(IInteractiveSessionStatics&&) noexcept = default;
    IInteractiveSessionStatics& operator=(
        IInteractiveSessionStatics const&) & noexcept = default;
    IInteractiveSessionStatics& operator=(
        IInteractiveSessionStatics&&) & noexcept = default;
  };
}
#endif
