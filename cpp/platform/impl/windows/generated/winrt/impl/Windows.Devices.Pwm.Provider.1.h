...
WINRT_EXPORT namespace winrt::Windows::Devices::Pwm::Provider {
  struct __declspec(empty_bases) IPwmControllerProvider
    ...
    IPwmControllerProvider(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IPwmControllerProvider& operator=(
        IPwmControllerProvider const&) & noexcept = default;
    IPwmControllerProvider& operator=(IPwmControllerProvider&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPwmProvider
    ...
    IPwmProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
