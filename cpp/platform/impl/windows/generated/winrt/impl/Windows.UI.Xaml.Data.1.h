...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Data {
  ...
  struct __declspec(empty_bases) IBinding2
    ...
    IBinding2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IBindingBaseFactory
    ...
    IBindingBaseFactory& operator=(IBindingBaseFactory const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IBindingExpression
    ...
    IBindingExpression& operator=(IBindingExpression const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IBindingExpressionBase
    ...
    IBindingExpressionBase& operator=(
        IBindingExpressionBase const&) & noexcept = default;
    IBindingExpressionBase& operator=(IBindingExpressionBase&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IBindingExpressionBaseFactory
    ...
    IBindingExpressionBaseFactory(
        IBindingExpressionBaseFactory const&) noexcept = default;
    IBindingExpressionBaseFactory(IBindingExpressionBaseFactory&&) noexcept =
        default;
    IBindingExpressionBaseFactory& operator=(
        IBindingExpressionBaseFactory const&) & noexcept = default;
    IBindingExpressionBaseFactory& operator=(
        IBindingExpressionBaseFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IBindingExpressionFactory
    ...
    IBindingExpressionFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IBindingExpressionFactory(IBindingExpressionFactory const&) noexcept =
        default;
    IBindingExpressionFactory(IBindingExpressionFactory&&) noexcept = default;
    IBindingExpressionFactory& operator=(
        IBindingExpressionFactory const&) & noexcept = default;
    IBindingExpressionFactory& operator=(
        IBindingExpressionFactory&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) IBindingOperations
    ...
    IBindingOperations& operator=(IBindingOperations const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IBindingOperationsStatics
    ...
    IBindingOperationsStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IBindingOperationsStatics(IBindingOperationsStatics const&) noexcept =
        default;
    IBindingOperationsStatics(IBindingOperationsStatics&&) noexcept = default;
    IBindingOperationsStatics& operator=(
        IBindingOperationsStatics const&) & noexcept = default;
    IBindingOperationsStatics& operator=(
        IBindingOperationsStatics&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) ICollectionViewFactory
    ...
    ICollectionViewFactory& operator=(
        ICollectionViewFactory const&) & noexcept = default;
    ICollectionViewFactory& operator=(ICollectionViewFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ICollectionViewGroup
    ...
    ICollectionViewGroup& operator=(ICollectionViewGroup const&) & noexcept =
        default;
    ICollectionViewGroup& operator=(ICollectionViewGroup&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ICollectionViewSource
    ...
    ICollectionViewSource& operator=(ICollectionViewSource const&) & noexcept =
        default;
    ICollectionViewSource& operator=(ICollectionViewSource&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ICollectionViewSourceStatics
    ...
    ICollectionViewSourceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICollectionViewSourceStatics(ICollectionViewSourceStatics const&) noexcept =
        default;
    ICollectionViewSourceStatics(ICollectionViewSourceStatics&&) noexcept =
        default;
    ICollectionViewSourceStatics& operator=(
        ICollectionViewSourceStatics const&) & noexcept = default;
    ICollectionViewSourceStatics& operator=(
        ICollectionViewSourceStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ICurrentChangingEventArgs
    ...
    ICurrentChangingEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICurrentChangingEventArgs(ICurrentChangingEventArgs const&) noexcept =
        default;
    ICurrentChangingEventArgs(ICurrentChangingEventArgs&&) noexcept = default;
    ICurrentChangingEventArgs& operator=(
        ICurrentChangingEventArgs const&) & noexcept = default;
    ICurrentChangingEventArgs& operator=(
        ICurrentChangingEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ICurrentChangingEventArgsFactory
    ...
    ICurrentChangingEventArgsFactory(
        ICurrentChangingEventArgsFactory const&) noexcept = default;
    ICurrentChangingEventArgsFactory(
        ICurrentChangingEventArgsFactory&&) noexcept = default;
    ICurrentChangingEventArgsFactory& operator=(
        ICurrentChangingEventArgsFactory const&) & noexcept = default;
    ICurrentChangingEventArgsFactory& operator=(
        ICurrentChangingEventArgsFactory&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) ICustomPropertyProvider
    ...
    ICustomPropertyProvider& operator=(
        ICustomPropertyProvider const&) & noexcept = default;
    ICustomPropertyProvider& operator=(ICustomPropertyProvider&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) IItemIndexRangeFactory
    ...
    IItemIndexRangeFactory& operator=(
        IItemIndexRangeFactory const&) & noexcept = default;
    IItemIndexRangeFactory& operator=(IItemIndexRangeFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IItemsRangeInfo
      : winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IItemsRangeInfo>,
        impl::require<winrt::Windows::UI::Xaml::Data::IItemsRangeInfo,
  ...
  struct __declspec(empty_bases) INotifyPropertyChanged
    ...
    INotifyPropertyChanged& operator=(
        INotifyPropertyChanged const&) & noexcept = default;
    INotifyPropertyChanged& operator=(INotifyPropertyChanged&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPropertyChangedEventArgs
    ...
    IPropertyChangedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPropertyChangedEventArgs(IPropertyChangedEventArgs const&) noexcept =
        default;
    IPropertyChangedEventArgs(IPropertyChangedEventArgs&&) noexcept = default;
    IPropertyChangedEventArgs& operator=(
        IPropertyChangedEventArgs const&) & noexcept = default;
    IPropertyChangedEventArgs& operator=(
        IPropertyChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPropertyChangedEventArgsFactory
    ...
    IPropertyChangedEventArgsFactory(
        IPropertyChangedEventArgsFactory const&) noexcept = default;
    IPropertyChangedEventArgsFactory(
        IPropertyChangedEventArgsFactory&&) noexcept = default;
    IPropertyChangedEventArgsFactory& operator=(
        IPropertyChangedEventArgsFactory const&) & noexcept = default;
    IPropertyChangedEventArgsFactory& operator=(
        IPropertyChangedEventArgsFactory&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) IRelativeSourceFactory
    ...
    IRelativeSourceFactory& operator=(
        IRelativeSourceFactory const&) & noexcept = default;
    IRelativeSourceFactory& operator=(IRelativeSourceFactory&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) ISupportIncrementalLoading
    ...
    ISupportIncrementalLoading(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISupportIncrementalLoading(ISupportIncrementalLoading const&) noexcept =
        default;
    ISupportIncrementalLoading(ISupportIncrementalLoading&&) noexcept = default;
    ISupportIncrementalLoading& operator=(
        ISupportIncrementalLoading const&) & noexcept = default;
    ISupportIncrementalLoading& operator=(
        ISupportIncrementalLoading&&) & noexcept = default;
  };
