...
WINRT_EXPORT namespace winrt::Windows::Devices::Spi::Provider {
  struct __declspec(empty_bases) IProviderSpiConnectionSettings
    ...
    IProviderSpiConnectionSettings(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IProviderSpiConnectionSettings(
        IProviderSpiConnectionSettings const&) noexcept = default;
    IProviderSpiConnectionSettings(IProviderSpiConnectionSettings&&) noexcept =
        default;
    IProviderSpiConnectionSettings& operator=(
        IProviderSpiConnectionSettings const&) & noexcept = default;
    IProviderSpiConnectionSettings& operator=(
        IProviderSpiConnectionSettings&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IProviderSpiConnectionSettingsFactory
    ...
    IProviderSpiConnectionSettingsFactory(void* ptr,
                                          take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IProviderSpiConnectionSettingsFactory(
        IProviderSpiConnectionSettingsFactory const&) noexcept = default;
    IProviderSpiConnectionSettingsFactory(
        IProviderSpiConnectionSettingsFactory&&) noexcept = default;
    IProviderSpiConnectionSettingsFactory& operator=(
        IProviderSpiConnectionSettingsFactory const&) & noexcept = default;
    IProviderSpiConnectionSettingsFactory& operator=(
        IProviderSpiConnectionSettingsFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISpiControllerProvider
    ...
    ISpiControllerProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    ISpiControllerProvider& operator=(
        ISpiControllerProvider const&) & noexcept = default;
    ISpiControllerProvider& operator=(ISpiControllerProvider&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISpiDeviceProvider
    ...
    ISpiDeviceProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISpiDeviceProvider(ISpiDeviceProvider const&) noexcept = default;
    ISpiDeviceProvider(ISpiDeviceProvider&&) noexcept = default;
    ISpiDeviceProvider& operator=(ISpiDeviceProvider const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ISpiProvider
    ...
    ISpiProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
