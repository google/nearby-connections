...
WINRT_EXPORT namespace winrt::Windows::Data::Pdf {
  struct __declspec(empty_bases) PdfDocument
      : winrt::Windows::Data::Pdf::IPdfDocument {
    PdfDocument(std::nullptr_t) noexcept {}
    PdfDocument(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Pdf::IPdfDocument(ptr,
  ...
  struct __declspec(empty_bases) PdfPage
      : winrt::Windows::Data::Pdf::IPdfPage,
        impl::require<PdfPage, winrt::Windows::Foundation::IClosable> {
    PdfPage(std::nullptr_t) noexcept {}
    PdfPage(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Pdf::IPdfPage(ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) PdfPageDimensions
      : winrt::Windows::Data::Pdf::IPdfPageDimensions {
    PdfPageDimensions(std::nullptr_t) noexcept {}
    PdfPageDimensions(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Pdf::IPdfPageDimensions(
  ...
  struct __declspec(empty_bases) PdfPageRenderOptions
      : winrt::Windows::Data::Pdf::IPdfPageRenderOptions {
    PdfPageRenderOptions(std::nullptr_t) noexcept {}
    PdfPageRenderOptions(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Pdf::IPdfPageRenderOptions(
              ptr, take_ownership_from_abi) {}
    ...
    PdfPageRenderOptions& operator=(PdfPageRenderOptions const&) & noexcept =
        default;
    PdfPageRenderOptions& operator=(PdfPageRenderOptions&&) & noexcept =
        default;
  };
}
#endif
