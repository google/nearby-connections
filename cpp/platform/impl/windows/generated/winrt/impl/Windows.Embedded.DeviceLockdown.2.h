...
WINRT_EXPORT namespace winrt::Windows::Embedded::DeviceLockdown {
  ...
  struct __declspec(empty_bases) DeviceLockdownProfileInformation
    ...
    DeviceLockdownProfileInformation(void* ptr,
                                     take_ownership_from_abi_t) noexcept
        : winrt::Windows::Embedded::DeviceLockdown::
              IDeviceLockdownProfileInformation(ptr, take_ownership_from_abi) {}
    DeviceLockdownProfileInformation(
        DeviceLockdownProfileInformation const&) noexcept = default;
    DeviceLockdownProfileInformation(
        DeviceLockdownProfileInformation&&) noexcept = default;
    DeviceLockdownProfileInformation& operator=(
        DeviceLockdownProfileInformation const&) & noexcept = default;
    DeviceLockdownProfileInformation& operator=(
        DeviceLockdownProfileInformation&&) & noexcept = default;
  };
