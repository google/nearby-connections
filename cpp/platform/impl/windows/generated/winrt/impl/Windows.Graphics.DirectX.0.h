...
template <>
struct category<winrt::Windows::Graphics::DirectX::DirectXAlphaMode> {
  using type = enum_category;
};
template <>
struct category<winrt::Windows::Graphics::DirectX::DirectXColorSpace> {
  using type = enum_category;
};
template <>
struct category<winrt::Windows::Graphics::DirectX::DirectXPixelFormat> {
  using type = enum_category;
};
template <>
struct category<winrt::Windows::Graphics::DirectX::DirectXPrimitiveTopology> {
  using type = enum_category;
};
template <>
inline constexpr auto&
    name_v<winrt::Windows::Graphics::DirectX::DirectXAlphaMode> =
        L"Windows.Graphics.DirectX.DirectXAlphaMode";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Graphics::DirectX::DirectXColorSpace> =
        L"Windows.Graphics.DirectX.DirectXColorSpace";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Graphics::DirectX::DirectXPixelFormat> =
        L"Windows.Graphics.DirectX.DirectXPixelFormat";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Graphics::DirectX::DirectXPrimitiveTopology> =
        L"Windows.Graphics.DirectX.DirectXPrimitiveTopology";
}  // namespace winrt::impl
#endif
