...
WINRT_EXPORT namespace winrt::Windows::Devices::I2c {
  struct __declspec(empty_bases) II2cConnectionSettings
    ...
    II2cConnectionSettings(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    II2cConnectionSettings& operator=(
        II2cConnectionSettings const&) & noexcept = default;
    II2cConnectionSettings& operator=(II2cConnectionSettings&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) II2cConnectionSettingsFactory
    ...
    II2cConnectionSettingsFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    II2cConnectionSettingsFactory(
        II2cConnectionSettingsFactory const&) noexcept = default;
    II2cConnectionSettingsFactory(II2cConnectionSettingsFactory&&) noexcept =
        default;
    II2cConnectionSettingsFactory& operator=(
        II2cConnectionSettingsFactory const&) & noexcept = default;
    II2cConnectionSettingsFactory& operator=(
        II2cConnectionSettingsFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) II2cController
      : winrt::Windows::Foundation::IInspectable,
        impl::consume_t<II2cController> {
    II2cController(std::nullptr_t = nullptr) noexcept {}
    II2cController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) II2cControllerStatics
    ...
    II2cControllerStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    II2cControllerStatics& operator=(II2cControllerStatics const&) & noexcept =
        default;
    II2cControllerStatics& operator=(II2cControllerStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) II2cDevice
      : winrt::Windows::Foundation::IInspectable,
        impl::consume_t<II2cDevice>,
        impl::require<winrt::Windows::Devices::I2c::II2cDevice,
                      winrt::Windows::Foundation::IClosable> {
    II2cDevice(std::nullptr_t = nullptr) noexcept {}
    II2cDevice(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) II2cDeviceStatics
    ...
    II2cDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
