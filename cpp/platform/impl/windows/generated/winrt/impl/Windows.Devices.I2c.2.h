...
WINRT_EXPORT namespace winrt::Windows::Devices::I2c {
  ...
  inline bool operator==(I2cTransferResult const& left,
                         I2cTransferResult const& right) noexcept {
  ...
  struct __declspec(empty_bases) I2cConnectionSettings
      : winrt::Windows::Devices::I2c::II2cConnectionSettings {
    I2cConnectionSettings(std::nullptr_t) noexcept {}
    I2cConnectionSettings(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::I2c::II2cConnectionSettings(
    ...
    I2cConnectionSettings& operator=(I2cConnectionSettings const&) & noexcept =
        default;
    I2cConnectionSettings& operator=(I2cConnectionSettings&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) I2cController
      : winrt::Windows::Devices::I2c::II2cController {
    I2cController(std::nullptr_t) noexcept {}
    I2cController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::I2c::II2cController(
              ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) I2cDevice
      : winrt::Windows::Devices::I2c::II2cDevice {
    I2cDevice(std::nullptr_t) noexcept {}
    I2cDevice(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::I2c::II2cDevice(ptr,
