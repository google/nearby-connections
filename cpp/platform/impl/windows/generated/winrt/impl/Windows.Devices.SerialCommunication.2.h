...
WINRT_EXPORT namespace winrt::Windows::Devices::SerialCommunication {
  struct __declspec(empty_bases) ErrorReceivedEventArgs
      : winrt::Windows::Devices::SerialCommunication::IErrorReceivedEventArgs {
    ErrorReceivedEventArgs(std::nullptr_t) noexcept {}
    ErrorReceivedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::SerialCommunication::IErrorReceivedEventArgs(
    ...
    ErrorReceivedEventArgs& operator=(
        ErrorReceivedEventArgs const&) & noexcept = default;
    ErrorReceivedEventArgs& operator=(ErrorReceivedEventArgs&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) PinChangedEventArgs
      : winrt::Windows::Devices::SerialCommunication::IPinChangedEventArgs {
    PinChangedEventArgs(std::nullptr_t) noexcept {}
    PinChangedEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::SerialCommunication::IPinChangedEventArgs(
              ptr, take_ownership_from_abi) {}
    PinChangedEventArgs(PinChangedEventArgs const&) noexcept = default;
    PinChangedEventArgs(PinChangedEventArgs&&) noexcept = default;
    PinChangedEventArgs& operator=(PinChangedEventArgs const&) & noexcept =
        default;
    PinChangedEventArgs& operator=(PinChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) SerialDevice
      : winrt::Windows::Devices::SerialCommunication::ISerialDevice {
    SerialDevice(std::nullptr_t) noexcept {}
    SerialDevice(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::SerialCommunication::ISerialDevice(
              ptr, take_ownership_from_abi) {}
    ...
    static auto GetDeviceSelectorFromUsbVidPid(uint16_t vendorId,
                                               uint16_t productId);
