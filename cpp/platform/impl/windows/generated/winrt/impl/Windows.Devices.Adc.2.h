...
WINRT_EXPORT namespace winrt::Windows::Devices::Adc {
  struct __declspec(empty_bases) AdcChannel
      : winrt::Windows::Devices::Adc::IAdcChannel {
    AdcChannel(std::nullptr_t) noexcept {}
    AdcChannel(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Adc::IAdcChannel(ptr,
  ...
  struct __declspec(empty_bases) AdcController
      : winrt::Windows::Devices::Adc::IAdcController {
    AdcController(std::nullptr_t) noexcept {}
    AdcController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Adc::IAdcController(
