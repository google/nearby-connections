...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::SocialInfo::Provider {
  struct __declspec(empty_bases) ISocialDashboardItemUpdater
    ...
    ISocialDashboardItemUpdater(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISocialDashboardItemUpdater(ISocialDashboardItemUpdater const&) noexcept =
        default;
    ISocialDashboardItemUpdater(ISocialDashboardItemUpdater&&) noexcept =
        default;
    ISocialDashboardItemUpdater& operator=(
        ISocialDashboardItemUpdater const&) & noexcept = default;
    ISocialDashboardItemUpdater& operator=(
        ISocialDashboardItemUpdater&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISocialFeedUpdater
    ...
    ISocialFeedUpdater(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISocialFeedUpdater(ISocialFeedUpdater const&) noexcept = default;
    ISocialFeedUpdater(ISocialFeedUpdater&&) noexcept = default;
    ISocialFeedUpdater& operator=(ISocialFeedUpdater const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ISocialInfoProviderManagerStatics
    ...
    ISocialInfoProviderManagerStatics(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISocialInfoProviderManagerStatics(
        ISocialInfoProviderManagerStatics const&) noexcept = default;
    ISocialInfoProviderManagerStatics(
        ISocialInfoProviderManagerStatics&&) noexcept = default;
    ISocialInfoProviderManagerStatics& operator=(
        ISocialInfoProviderManagerStatics const&) & noexcept = default;
    ISocialInfoProviderManagerStatics& operator=(
        ISocialInfoProviderManagerStatics&&) & noexcept = default;
  };
