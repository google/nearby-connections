...
WINRT_EXPORT namespace winrt::Windows::Foundation::Metadata {
  struct __declspec(empty_bases) IApiInformationStatics
    ...
    IApiInformationStatics(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IApiInformationStatics& operator=(
        IApiInformationStatics const&) & noexcept = default;
    IApiInformationStatics& operator=(IApiInformationStatics&&) & noexcept =
        default;
  };
}
#endif
