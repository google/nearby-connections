...
WINRT_EXPORT namespace winrt::Windows::Embedded::DeviceLockdown {
  struct __declspec(empty_bases) IDeviceLockdownProfileInformation
    ...
    IDeviceLockdownProfileInformation(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDeviceLockdownProfileInformation(
        IDeviceLockdownProfileInformation const&) noexcept = default;
    IDeviceLockdownProfileInformation(
        IDeviceLockdownProfileInformation&&) noexcept = default;
    IDeviceLockdownProfileInformation& operator=(
        IDeviceLockdownProfileInformation const&) & noexcept = default;
    IDeviceLockdownProfileInformation& operator=(
        IDeviceLockdownProfileInformation&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IDeviceLockdownProfileStatics
    ...
    IDeviceLockdownProfileStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDeviceLockdownProfileStatics(
        IDeviceLockdownProfileStatics const&) noexcept = default;
    IDeviceLockdownProfileStatics(IDeviceLockdownProfileStatics&&) noexcept =
        default;
    IDeviceLockdownProfileStatics& operator=(
        IDeviceLockdownProfileStatics const&) & noexcept = default;
    IDeviceLockdownProfileStatics& operator=(
        IDeviceLockdownProfileStatics&&) & noexcept = default;
  };
}
#endif
