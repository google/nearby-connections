...
WINRT_EXPORT namespace winrt::Windows::UI::Core::AnimationMetrics {
  struct __declspec(empty_bases) IAnimationDescription
    ...
    IAnimationDescription(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IAnimationDescription& operator=(IAnimationDescription const&) & noexcept =
        default;
    IAnimationDescription& operator=(IAnimationDescription&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IAnimationDescriptionFactory
    ...
    IAnimationDescriptionFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IAnimationDescriptionFactory(IAnimationDescriptionFactory const&) noexcept =
        default;
    IAnimationDescriptionFactory(IAnimationDescriptionFactory&&) noexcept =
        default;
    IAnimationDescriptionFactory& operator=(
        IAnimationDescriptionFactory const&) & noexcept = default;
    IAnimationDescriptionFactory& operator=(
        IAnimationDescriptionFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IOpacityAnimation
    ...
    IOpacityAnimation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IPropertyAnimation
    ...
    IPropertyAnimation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPropertyAnimation(IPropertyAnimation const&) noexcept = default;
    IPropertyAnimation(IPropertyAnimation&&) noexcept = default;
    IPropertyAnimation& operator=(IPropertyAnimation const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IScaleAnimation
    ...
    IScaleAnimation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
