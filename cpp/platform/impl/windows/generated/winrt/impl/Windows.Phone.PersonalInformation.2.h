...
WINRT_EXPORT namespace winrt::Windows::Phone::PersonalInformation {
  ...
  struct __declspec(empty_bases) StoredContact
    ...
    StoredContact(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Phone::PersonalInformation::IStoredContact(
              ptr, take_ownership_from_abi) {}
    explicit StoredContact(
