...
WINRT_EXPORT namespace winrt::Windows::Perception::People {
  struct __declspec(empty_bases) IEyesPose
    ...
    IEyesPose(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IEyesPoseStatics
    ...
    IEyesPoseStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IHandMeshObserver
    ...
    IHandMeshObserver(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IHandMeshVertexState
    ...
    IHandMeshVertexState(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IHandMeshVertexState& operator=(IHandMeshVertexState const&) & noexcept =
        default;
    IHandMeshVertexState& operator=(IHandMeshVertexState&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHandPose
    ...
    IHandPose(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IHeadPose
    ...
    IHeadPose(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
