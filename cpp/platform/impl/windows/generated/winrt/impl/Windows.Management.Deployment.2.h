...
WINRT_EXPORT namespace winrt::Windows::Management::Deployment {
  ...
  inline bool operator==(DeploymentProgress const& left,
                         DeploymentProgress const& right) noexcept {
  ...
  struct __declspec(empty_bases) AddPackageOptions
  ...
  struct __declspec(empty_bases) DeploymentResult
  ...
  struct __declspec(empty_bases) PackageManager
  ...
  struct __declspec(empty_bases) PackageManagerDebugSettings
      : winrt::Windows::Management::Deployment::IPackageManagerDebugSettings {
    PackageManagerDebugSettings(std::nullptr_t) noexcept {}
    PackageManagerDebugSettings(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Deployment::IPackageManagerDebugSettings(
              ptr, take_ownership_from_abi) {}
    PackageManagerDebugSettings(PackageManagerDebugSettings const&) noexcept =
        default;
    PackageManagerDebugSettings(PackageManagerDebugSettings&&) noexcept =
        default;
    PackageManagerDebugSettings& operator=(
        PackageManagerDebugSettings const&) & noexcept = default;
    PackageManagerDebugSettings& operator=(
        PackageManagerDebugSettings&&) & noexcept = default;
  };
  struct __declspec(empty_bases) PackageUserInformation
      : winrt::Windows::Management::Deployment::IPackageUserInformation {
    PackageUserInformation(std::nullptr_t) noexcept {}
    PackageUserInformation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Deployment::IPackageUserInformation(
              ptr, take_ownership_from_abi) {}
    ...
    PackageUserInformation& operator=(
        PackageUserInformation const&) & noexcept = default;
    PackageUserInformation& operator=(PackageUserInformation&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) PackageVolume
      : winrt::Windows::Management::Deployment::IPackageVolume,
        impl::require<PackageVolume,
                      winrt::Windows::Management::Deployment::IPackageVolume2> {
  ...
  struct __declspec(empty_bases) RegisterPackageOptions
    ...
    RegisterPackageOptions& operator=(
        RegisterPackageOptions const&) & noexcept = default;
    RegisterPackageOptions& operator=(RegisterPackageOptions&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) StagePackageOptions
    ...
    StagePackageOptions& operator=(StagePackageOptions const&) & noexcept =
        default;
