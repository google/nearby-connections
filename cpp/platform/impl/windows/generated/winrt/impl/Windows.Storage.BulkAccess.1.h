...
WINRT_EXPORT namespace winrt::Windows::Storage::BulkAccess {
  struct __declspec(empty_bases) IFileInformationFactory
    ...
    IFileInformationFactory(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IFileInformationFactory& operator=(
        IFileInformationFactory const&) & noexcept = default;
    IFileInformationFactory& operator=(IFileInformationFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IFileInformationFactoryFactory
    ...
    IFileInformationFactoryFactory(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IFileInformationFactoryFactory(
        IFileInformationFactoryFactory const&) noexcept = default;
    IFileInformationFactoryFactory(IFileInformationFactoryFactory&&) noexcept =
        default;
    IFileInformationFactoryFactory& operator=(
        IFileInformationFactoryFactory const&) & noexcept = default;
    IFileInformationFactoryFactory& operator=(
        IFileInformationFactoryFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IStorageItemInformation
    ...
    IStorageItemInformation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IStorageItemInformation& operator=(
        IStorageItemInformation const&) & noexcept = default;
    IStorageItemInformation& operator=(IStorageItemInformation&&) & noexcept =
        default;
  };
}
#endif
