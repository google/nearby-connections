...
WINRT_EXPORT namespace winrt::Windows::Media::ClosedCaptioning {
  struct __declspec(empty_bases) IClosedCaptionPropertiesStatics
    ...
    IClosedCaptionPropertiesStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IClosedCaptionPropertiesStatics(
        IClosedCaptionPropertiesStatics const&) noexcept = default;
    IClosedCaptionPropertiesStatics(
        IClosedCaptionPropertiesStatics&&) noexcept = default;
    IClosedCaptionPropertiesStatics& operator=(
        IClosedCaptionPropertiesStatics const&) & noexcept = default;
    IClosedCaptionPropertiesStatics& operator=(
        IClosedCaptionPropertiesStatics&&) & noexcept = default;
  };
