...
WINRT_EXPORT namespace winrt::Windows::UI::WebUI::Core {
  struct __declspec(empty_bases) IWebUICommandBar
    ...
    IWebUICommandBar(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IWebUICommandBarBitmapIcon
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<
            ...
            winrt::Windows::UI::WebUI::Core::IWebUICommandBarIcon> {
    IWebUICommandBarBitmapIcon(std::nullptr_t = nullptr) noexcept {}
    IWebUICommandBarBitmapIcon(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarBitmapIcon(IWebUICommandBarBitmapIcon const&) noexcept =
        default;
    IWebUICommandBarBitmapIcon(IWebUICommandBarBitmapIcon&&) noexcept = default;
    IWebUICommandBarBitmapIcon& operator=(
        IWebUICommandBarBitmapIcon const&) & noexcept = default;
    IWebUICommandBarBitmapIcon& operator=(
        IWebUICommandBarBitmapIcon&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarBitmapIconFactory
    ...
    IWebUICommandBarBitmapIconFactory(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarBitmapIconFactory(
        IWebUICommandBarBitmapIconFactory const&) noexcept = default;
    IWebUICommandBarBitmapIconFactory(
        IWebUICommandBarBitmapIconFactory&&) noexcept = default;
    IWebUICommandBarBitmapIconFactory& operator=(
        IWebUICommandBarBitmapIconFactory const&) & noexcept = default;
    IWebUICommandBarBitmapIconFactory& operator=(
        IWebUICommandBarBitmapIconFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarConfirmationButton
    ...
    IWebUICommandBarConfirmationButton(void* ptr,
                                       take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarConfirmationButton(
        IWebUICommandBarConfirmationButton const&) noexcept = default;
    IWebUICommandBarConfirmationButton(
        IWebUICommandBarConfirmationButton&&) noexcept = default;
    IWebUICommandBarConfirmationButton& operator=(
        IWebUICommandBarConfirmationButton const&) & noexcept = default;
    IWebUICommandBarConfirmationButton& operator=(
        IWebUICommandBarConfirmationButton&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarElement
    ...
    IWebUICommandBarElement(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IWebUICommandBarElement& operator=(
        IWebUICommandBarElement const&) & noexcept = default;
    IWebUICommandBarElement& operator=(IWebUICommandBarElement&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWebUICommandBarIcon
    ...
    IWebUICommandBarIcon(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IWebUICommandBarIcon& operator=(IWebUICommandBarIcon const&) & noexcept =
        default;
    IWebUICommandBarIcon& operator=(IWebUICommandBarIcon&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWebUICommandBarIconButton
    ...
    IWebUICommandBarIconButton(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarIconButton(IWebUICommandBarIconButton const&) noexcept =
        default;
    IWebUICommandBarIconButton(IWebUICommandBarIconButton&&) noexcept = default;
    IWebUICommandBarIconButton& operator=(
        IWebUICommandBarIconButton const&) & noexcept = default;
    IWebUICommandBarIconButton& operator=(
        IWebUICommandBarIconButton&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarItemInvokedEventArgs
    ...
    IWebUICommandBarItemInvokedEventArgs(void* ptr,
                                         take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarItemInvokedEventArgs(
        IWebUICommandBarItemInvokedEventArgs const&) noexcept = default;
    IWebUICommandBarItemInvokedEventArgs(
        IWebUICommandBarItemInvokedEventArgs&&) noexcept = default;
    IWebUICommandBarItemInvokedEventArgs& operator=(
        IWebUICommandBarItemInvokedEventArgs const&) & noexcept = default;
    IWebUICommandBarItemInvokedEventArgs& operator=(
        IWebUICommandBarItemInvokedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarSizeChangedEventArgs
    ...
    IWebUICommandBarSizeChangedEventArgs(void* ptr,
                                         take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarSizeChangedEventArgs(
        IWebUICommandBarSizeChangedEventArgs const&) noexcept = default;
    IWebUICommandBarSizeChangedEventArgs(
        IWebUICommandBarSizeChangedEventArgs&&) noexcept = default;
    IWebUICommandBarSizeChangedEventArgs& operator=(
        IWebUICommandBarSizeChangedEventArgs const&) & noexcept = default;
    IWebUICommandBarSizeChangedEventArgs& operator=(
        IWebUICommandBarSizeChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarStatics
    ...
    IWebUICommandBarStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IWebUICommandBarStatics& operator=(
        IWebUICommandBarStatics const&) & noexcept = default;
    IWebUICommandBarStatics& operator=(IWebUICommandBarStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWebUICommandBarSymbolIcon
    ...
    IWebUICommandBarSymbolIcon(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarSymbolIcon(IWebUICommandBarSymbolIcon const&) noexcept =
        default;
    IWebUICommandBarSymbolIcon(IWebUICommandBarSymbolIcon&&) noexcept = default;
    IWebUICommandBarSymbolIcon& operator=(
        IWebUICommandBarSymbolIcon const&) & noexcept = default;
    IWebUICommandBarSymbolIcon& operator=(
        IWebUICommandBarSymbolIcon&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IWebUICommandBarSymbolIconFactory
    ...
    IWebUICommandBarSymbolIconFactory(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWebUICommandBarSymbolIconFactory(
        IWebUICommandBarSymbolIconFactory const&) noexcept = default;
    IWebUICommandBarSymbolIconFactory(
        IWebUICommandBarSymbolIconFactory&&) noexcept = default;
    IWebUICommandBarSymbolIconFactory& operator=(
        IWebUICommandBarSymbolIconFactory const&) & noexcept = default;
    IWebUICommandBarSymbolIconFactory& operator=(
        IWebUICommandBarSymbolIconFactory&&) & noexcept = default;
  };
