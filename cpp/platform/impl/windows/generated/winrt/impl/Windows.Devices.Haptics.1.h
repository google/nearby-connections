...
WINRT_EXPORT namespace winrt::Windows::Devices::Haptics {
  struct __declspec(empty_bases) IKnownSimpleHapticsControllerWaveformsStatics
    ...
    IKnownSimpleHapticsControllerWaveformsStatics(
        IKnownSimpleHapticsControllerWaveformsStatics const&) noexcept =
        default;
    IKnownSimpleHapticsControllerWaveformsStatics(
        IKnownSimpleHapticsControllerWaveformsStatics&&) noexcept = default;
    IKnownSimpleHapticsControllerWaveformsStatics& operator=(
        IKnownSimpleHapticsControllerWaveformsStatics const&) & noexcept =
        default;
    IKnownSimpleHapticsControllerWaveformsStatics& operator=(
        IKnownSimpleHapticsControllerWaveformsStatics&&) & noexcept = default;
  ...
  struct __declspec(empty_bases) ISimpleHapticsController
    ...
    ISimpleHapticsController(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISimpleHapticsController(ISimpleHapticsController const&) noexcept =
        default;
    ISimpleHapticsController(ISimpleHapticsController&&) noexcept = default;
    ISimpleHapticsController& operator=(
        ISimpleHapticsController const&) & noexcept = default;
    ISimpleHapticsController& operator=(ISimpleHapticsController&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISimpleHapticsControllerFeedback
    ...
    ISimpleHapticsControllerFeedback(void* ptr,
                                     take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISimpleHapticsControllerFeedback(
        ISimpleHapticsControllerFeedback const&) noexcept = default;
    ISimpleHapticsControllerFeedback(
        ISimpleHapticsControllerFeedback&&) noexcept = default;
    ISimpleHapticsControllerFeedback& operator=(
        ISimpleHapticsControllerFeedback const&) & noexcept = default;
    ISimpleHapticsControllerFeedback& operator=(
        ISimpleHapticsControllerFeedback&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IVibrationDevice
    ...
    IVibrationDevice(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IVibrationDeviceStatics
    ...
    IVibrationDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IVibrationDeviceStatics& operator=(
        IVibrationDeviceStatics const&) & noexcept = default;
    IVibrationDeviceStatics& operator=(IVibrationDeviceStatics&&) & noexcept =
        default;
  };
}
#endif
