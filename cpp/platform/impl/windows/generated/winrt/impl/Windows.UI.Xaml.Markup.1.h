...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Markup {
  struct __declspec(empty_bases) IComponentConnector
    ...
    IComponentConnector& operator=(IComponentConnector const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IComponentConnector2
    ...
    IComponentConnector2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IComponentConnector2& operator=(IComponentConnector2 const&) & noexcept =
        default;
    IComponentConnector2& operator=(IComponentConnector2&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IDataTemplateComponent
    ...
    IDataTemplateComponent& operator=(
        IDataTemplateComponent const&) & noexcept = default;
    IDataTemplateComponent& operator=(IDataTemplateComponent&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) IMarkupExtensionFactory
    ...
    IMarkupExtensionFactory& operator=(
        IMarkupExtensionFactory const&) & noexcept = default;
    IMarkupExtensionFactory& operator=(IMarkupExtensionFactory&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IMarkupExtensionOverrides
    ...
    IMarkupExtensionOverrides(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IMarkupExtensionOverrides(IMarkupExtensionOverrides const&) noexcept =
        default;
    IMarkupExtensionOverrides(IMarkupExtensionOverrides&&) noexcept = default;
    IMarkupExtensionOverrides& operator=(
        IMarkupExtensionOverrides const&) & noexcept = default;
    IMarkupExtensionOverrides& operator=(
        IMarkupExtensionOverrides&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) IXamlBinaryWriterStatics
    ...
    IXamlBinaryWriterStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IXamlBinaryWriterStatics(IXamlBinaryWriterStatics const&) noexcept =
        default;
    IXamlBinaryWriterStatics(IXamlBinaryWriterStatics&&) noexcept = default;
    IXamlBinaryWriterStatics& operator=(
        IXamlBinaryWriterStatics const&) & noexcept = default;
    IXamlBinaryWriterStatics& operator=(IXamlBinaryWriterStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IXamlBindScopeDiagnostics
    ...
    IXamlBindScopeDiagnostics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IXamlBindScopeDiagnostics(IXamlBindScopeDiagnostics const&) noexcept =
        default;
    IXamlBindScopeDiagnostics(IXamlBindScopeDiagnostics&&) noexcept = default;
    IXamlBindScopeDiagnostics& operator=(
        IXamlBindScopeDiagnostics const&) & noexcept = default;
    IXamlBindScopeDiagnostics& operator=(
        IXamlBindScopeDiagnostics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IXamlBindingHelper
    ...
    IXamlBindingHelper& operator=(IXamlBindingHelper const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IXamlBindingHelperStatics
    ...
    IXamlBindingHelperStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IXamlBindingHelperStatics(IXamlBindingHelperStatics const&) noexcept =
        default;
    IXamlBindingHelperStatics(IXamlBindingHelperStatics&&) noexcept = default;
    IXamlBindingHelperStatics& operator=(
        IXamlBindingHelperStatics const&) & noexcept = default;
    IXamlBindingHelperStatics& operator=(
        IXamlBindingHelperStatics&&) & noexcept = default;
  };
  ...
  struct __declspec(empty_bases) IXamlMarkupHelperStatics
    ...
    IXamlMarkupHelperStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IXamlMarkupHelperStatics(IXamlMarkupHelperStatics const&) noexcept =
        default;
    IXamlMarkupHelperStatics(IXamlMarkupHelperStatics&&) noexcept = default;
    IXamlMarkupHelperStatics& operator=(
        IXamlMarkupHelperStatics const&) & noexcept = default;
    IXamlMarkupHelperStatics& operator=(IXamlMarkupHelperStatics&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) IXamlMetadataProvider
    ...
    IXamlMetadataProvider& operator=(IXamlMetadataProvider const&) & noexcept =
        default;
    IXamlMetadataProvider& operator=(IXamlMetadataProvider&&) & noexcept =
        default;
  };
  ...
  struct __declspec(empty_bases) IXamlReaderStatics
    ...
    IXamlReaderStatics& operator=(IXamlReaderStatics const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IXamlType2
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::UI::Xaml::Markup::IXamlType2,
                      winrt::Windows::UI::Xaml::Markup::IXamlType> {
    IXamlType2(std::nullptr_t = nullptr) noexcept {}
    IXamlType2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
