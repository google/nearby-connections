...
WINRT_EXPORT namespace winrt::Windows::Gaming::Input::Preview {
  struct __declspec(empty_bases) IGameControllerProviderInfoStatics
    ...
    IGameControllerProviderInfoStatics(void* ptr,
                                       take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IGameControllerProviderInfoStatics(
        IGameControllerProviderInfoStatics const&) noexcept = default;
    IGameControllerProviderInfoStatics(
        IGameControllerProviderInfoStatics&&) noexcept = default;
    IGameControllerProviderInfoStatics& operator=(
        IGameControllerProviderInfoStatics const&) & noexcept = default;
    IGameControllerProviderInfoStatics& operator=(
        IGameControllerProviderInfoStatics&&) & noexcept = default;
  };
