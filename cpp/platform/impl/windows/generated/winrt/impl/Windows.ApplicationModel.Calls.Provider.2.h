...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Calls::Provider {
  ...
  struct PhoneCallOriginManager {
    ...
    static auto SetCallOrigin(winrt::guid const& requestId,
                              winrt::Windows::ApplicationModel::Calls::
                                  Provider::PhoneCallOrigin const& callOrigin);
