...
WINRT_EXPORT namespace winrt::Windows::Web::Http::Filters {
  struct __declspec(empty_bases) IHttpBaseProtocolFilter
    ...
    IHttpBaseProtocolFilter(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IHttpBaseProtocolFilter& operator=(
        IHttpBaseProtocolFilter const&) & noexcept = default;
    IHttpBaseProtocolFilter& operator=(IHttpBaseProtocolFilter&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHttpBaseProtocolFilter2
    ...
    IHttpBaseProtocolFilter2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpBaseProtocolFilter2(IHttpBaseProtocolFilter2 const&) noexcept =
        default;
    IHttpBaseProtocolFilter2(IHttpBaseProtocolFilter2&&) noexcept = default;
    IHttpBaseProtocolFilter2& operator=(
        IHttpBaseProtocolFilter2 const&) & noexcept = default;
    IHttpBaseProtocolFilter2& operator=(IHttpBaseProtocolFilter2&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHttpBaseProtocolFilter3
    ...
    IHttpBaseProtocolFilter3(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpBaseProtocolFilter3(IHttpBaseProtocolFilter3 const&) noexcept =
        default;
    IHttpBaseProtocolFilter3(IHttpBaseProtocolFilter3&&) noexcept = default;
    IHttpBaseProtocolFilter3& operator=(
        IHttpBaseProtocolFilter3 const&) & noexcept = default;
    IHttpBaseProtocolFilter3& operator=(IHttpBaseProtocolFilter3&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHttpBaseProtocolFilter4
    ...
    IHttpBaseProtocolFilter4(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpBaseProtocolFilter4(IHttpBaseProtocolFilter4 const&) noexcept =
        default;
    IHttpBaseProtocolFilter4(IHttpBaseProtocolFilter4&&) noexcept = default;
    IHttpBaseProtocolFilter4& operator=(
        IHttpBaseProtocolFilter4 const&) & noexcept = default;
    IHttpBaseProtocolFilter4& operator=(IHttpBaseProtocolFilter4&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHttpBaseProtocolFilter5
    ...
    IHttpBaseProtocolFilter5(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpBaseProtocolFilter5(IHttpBaseProtocolFilter5 const&) noexcept =
        default;
    IHttpBaseProtocolFilter5(IHttpBaseProtocolFilter5&&) noexcept = default;
    IHttpBaseProtocolFilter5& operator=(
        IHttpBaseProtocolFilter5 const&) & noexcept = default;
    IHttpBaseProtocolFilter5& operator=(IHttpBaseProtocolFilter5&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IHttpBaseProtocolFilterStatics
    ...
    IHttpBaseProtocolFilterStatics(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpBaseProtocolFilterStatics(
        IHttpBaseProtocolFilterStatics const&) noexcept = default;
    IHttpBaseProtocolFilterStatics(IHttpBaseProtocolFilterStatics&&) noexcept =
        default;
    IHttpBaseProtocolFilterStatics& operator=(
        IHttpBaseProtocolFilterStatics const&) & noexcept = default;
    IHttpBaseProtocolFilterStatics& operator=(
        IHttpBaseProtocolFilterStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IHttpCacheControl
    ...
    IHttpCacheControl(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IHttpFilter
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Web::Http::Filters::IHttpFilter,
                      winrt::Windows::Foundation::IClosable> {
    IHttpFilter(std::nullptr_t = nullptr) noexcept {}
    IHttpFilter(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IHttpServerCustomValidationRequestedEventArgs
    ...
    IHttpServerCustomValidationRequestedEventArgs(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHttpServerCustomValidationRequestedEventArgs(
        IHttpServerCustomValidationRequestedEventArgs const&) noexcept =
        default;
    IHttpServerCustomValidationRequestedEventArgs(
        IHttpServerCustomValidationRequestedEventArgs&&) noexcept = default;
    IHttpServerCustomValidationRequestedEventArgs& operator=(
        IHttpServerCustomValidationRequestedEventArgs const&) & noexcept =
        default;
    IHttpServerCustomValidationRequestedEventArgs& operator=(
        IHttpServerCustomValidationRequestedEventArgs&&) & noexcept = default;
