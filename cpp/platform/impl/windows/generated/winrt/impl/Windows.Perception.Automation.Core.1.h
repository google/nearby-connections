...
WINRT_EXPORT namespace winrt::Windows::Perception::Automation::Core {
  struct __declspec(empty_bases) ICorePerceptionAutomationStatics
    ...
    ICorePerceptionAutomationStatics(void* ptr,
                                     take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICorePerceptionAutomationStatics(
        ICorePerceptionAutomationStatics const&) noexcept = default;
    ICorePerceptionAutomationStatics(
        ICorePerceptionAutomationStatics&&) noexcept = default;
    ICorePerceptionAutomationStatics& operator=(
        ICorePerceptionAutomationStatics const&) & noexcept = default;
    ICorePerceptionAutomationStatics& operator=(
        ICorePerceptionAutomationStatics&&) & noexcept = default;
  };
