...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::UserActivities::Core {
  struct __declspec(empty_bases) ICoreUserActivityManagerStatics
    ...
    ICoreUserActivityManagerStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICoreUserActivityManagerStatics(
        ICoreUserActivityManagerStatics const&) noexcept = default;
    ICoreUserActivityManagerStatics(
        ICoreUserActivityManagerStatics&&) noexcept = default;
    ICoreUserActivityManagerStatics& operator=(
        ICoreUserActivityManagerStatics const&) & noexcept = default;
    ICoreUserActivityManagerStatics& operator=(
        ICoreUserActivityManagerStatics&&) & noexcept = default;
  };
