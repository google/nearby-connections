...
WINRT_EXPORT namespace winrt::Windows::UI::Input::Inking::Preview {
  struct __declspec(empty_bases) PalmRejectionDelayZonePreview
      : winrt::Windows::UI::Input::Inking::Preview::
            IPalmRejectionDelayZonePreview,
        impl::require<PalmRejectionDelayZonePreview,
                      winrt::Windows::Foundation::IClosable> {
    PalmRejectionDelayZonePreview(std::nullptr_t) noexcept {}
    PalmRejectionDelayZonePreview(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::Input::Inking::Preview::
              IPalmRejectionDelayZonePreview(ptr, take_ownership_from_abi) {}
    PalmRejectionDelayZonePreview(
        PalmRejectionDelayZonePreview const&) noexcept = default;
    PalmRejectionDelayZonePreview(PalmRejectionDelayZonePreview&&) noexcept =
        default;
    PalmRejectionDelayZonePreview& operator=(
        PalmRejectionDelayZonePreview const&) & noexcept = default;
    PalmRejectionDelayZonePreview& operator=(
        PalmRejectionDelayZonePreview&&) & noexcept = default;
    static auto CreateForVisual(
