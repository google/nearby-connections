...
WINRT_EXPORT namespace winrt::Windows::UI {
  ...
  struct __declspec(empty_bases) ColorHelper
      : winrt::Windows::UI::IColorHelper {
    ColorHelper(std::nullptr_t) noexcept {}
    ColorHelper(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::IColorHelper(ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) Colors : winrt::Windows::UI::IColors {
    ...
    Colors(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::IColors(ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) UIContentRoot
      : winrt::Windows::UI::IUIContentRoot {
    UIContentRoot(std::nullptr_t) noexcept {}
    UIContentRoot(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::IUIContentRoot(ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) UIContext : winrt::Windows::UI::IUIContext {
    ...
    UIContext(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::IUIContext(ptr, take_ownership_from_abi) {}
