...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::SocialInfo {
  struct __declspec(empty_bases) ISocialFeedChildItem
    ...
    ISocialFeedChildItem(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    ISocialFeedChildItem& operator=(ISocialFeedChildItem const&) & noexcept =
        default;
    ISocialFeedChildItem& operator=(ISocialFeedChildItem&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISocialFeedContent
    ...
    ISocialFeedContent(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISocialFeedContent(ISocialFeedContent const&) noexcept = default;
    ISocialFeedContent(ISocialFeedContent&&) noexcept = default;
    ISocialFeedContent& operator=(ISocialFeedContent const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ISocialFeedItem
    ...
    ISocialFeedItem(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ISocialFeedSharedItem
    ...
    ISocialFeedSharedItem(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    ISocialFeedSharedItem& operator=(ISocialFeedSharedItem const&) & noexcept =
        default;
    ISocialFeedSharedItem& operator=(ISocialFeedSharedItem&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISocialItemThumbnail
    ...
    ISocialItemThumbnail(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    ISocialItemThumbnail& operator=(ISocialItemThumbnail const&) & noexcept =
        default;
    ISocialItemThumbnail& operator=(ISocialItemThumbnail&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISocialUserInfo
    ...
    ISocialUserInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
