...
WINRT_EXPORT namespace winrt::Windows::UI::Composition::Desktop {
  struct __declspec(empty_bases) DesktopWindowTarget
    ...
    DesktopWindowTarget(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget(
    ...
    DesktopWindowTarget& operator=(DesktopWindowTarget const&) & noexcept =
        default;
