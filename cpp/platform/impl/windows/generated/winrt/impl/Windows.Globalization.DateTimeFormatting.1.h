...
WINRT_EXPORT namespace winrt::Windows::Globalization::DateTimeFormatting {
  struct __declspec(empty_bases) IDateTimeFormatter
    ...
    IDateTimeFormatter(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IDateTimeFormatter& operator=(IDateTimeFormatter const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IDateTimeFormatter2
    ...
    IDateTimeFormatter2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDateTimeFormatter2(IDateTimeFormatter2 const&) noexcept = default;
    IDateTimeFormatter2(IDateTimeFormatter2&&) noexcept = default;
    IDateTimeFormatter2& operator=(IDateTimeFormatter2 const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IDateTimeFormatterFactory
    ...
    IDateTimeFormatterFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDateTimeFormatterFactory(IDateTimeFormatterFactory const&) noexcept =
        default;
    IDateTimeFormatterFactory(IDateTimeFormatterFactory&&) noexcept = default;
    IDateTimeFormatterFactory& operator=(
        IDateTimeFormatterFactory const&) & noexcept = default;
    IDateTimeFormatterFactory& operator=(
        IDateTimeFormatterFactory&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IDateTimeFormatterStatics
    ...
    IDateTimeFormatterStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDateTimeFormatterStatics(IDateTimeFormatterStatics const&) noexcept =
        default;
    IDateTimeFormatterStatics(IDateTimeFormatterStatics&&) noexcept = default;
    IDateTimeFormatterStatics& operator=(
        IDateTimeFormatterStatics const&) & noexcept = default;
    IDateTimeFormatterStatics& operator=(
        IDateTimeFormatterStatics&&) & noexcept = default;
  };
}
#endif
