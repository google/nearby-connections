...
WINRT_EXPORT namespace winrt::Windows::Devices::Adc::Provider {
  struct __declspec(empty_bases) IAdcControllerProvider
    ...
    IAdcControllerProvider(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IAdcControllerProvider& operator=(
        IAdcControllerProvider const&) & noexcept = default;
    IAdcControllerProvider& operator=(IAdcControllerProvider&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IAdcProvider
    ...
    IAdcProvider(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
