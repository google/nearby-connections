...
template <>
struct category<winrt::Windows::Devices::Adc::Provider::IAdcProvider> {
  using type = interface_category;
};
template <>
struct category<
...
inline constexpr auto&
    name_v<winrt::Windows::Devices::Adc::Provider::ProviderAdcChannelMode> =
        L"Windows.Devices.Adc.Provider.ProviderAdcChannelMode";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider> =
        L"Windows.Devices.Adc.Provider.IAdcControllerProvider";
template <>
inline constexpr auto&
    name_v<winrt::Windows::Devices::Adc::Provider::IAdcProvider> =
        L"Windows.Devices.Adc.Provider.IAdcProvider";
template <>
inline constexpr guid
    guid_v<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider>{
        0xBE545828,
        0x816D,
        0x4DE5,
        {0xA0, 0x48, 0xAB, 0xA0, 0x69, 0x58, 0xAA,
         0xA8}};  // BE545828-816D-4DE5-A048-ABA06958AAA8
template <>
inline constexpr guid
    guid_v<winrt::Windows::Devices::Adc::Provider::IAdcProvider>{
        0x28953668,
        0x9359,
        0x4C57,
        {0xBC, 0x88, 0xE2, 0x75, 0xE8, 0x16, 0x38,
         0xC9}};  // 28953668-9359-4C57-BC88-E275E81638C9
template <>
struct abi<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider> {
...
template <>
struct abi<winrt::Windows::Devices::Adc::Provider::IAdcProvider> {
  struct __declspec(novtable) type : inspectable_abi {
...
template <>
struct consume<winrt::Windows::Devices::Adc::Provider::IAdcControllerProvider> {
  template <typename D>
  using type = consume_Windows_Devices_Adc_Provider_IAdcControllerProvider<D>;
};
template <typename D>
...
template <>
struct consume<winrt::Windows::Devices::Adc::Provider::IAdcProvider> {
  template <typename D>
  using type = consume_Windows_Devices_Adc_Provider_IAdcProvider<D>;
};
}  // namespace winrt::impl
#endif
