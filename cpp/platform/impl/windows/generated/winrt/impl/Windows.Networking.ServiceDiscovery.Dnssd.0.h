...
template <>
struct category<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
...
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::DnssdRegistrationResult> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdRegistrationResult";
template <>
inline constexpr auto& name_v<
    winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstance> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceInstance";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::DnssdServiceInstanceCollection> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceInstanceCollection";
template <>
inline constexpr auto& name_v<
    winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcher> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceWatcher";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::DnssdRegistrationStatus> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdRegistrationStatus";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::DnssdServiceWatcherStatus> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceWatcherStatus";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::IDnssdRegistrationResult> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.IDnssdRegistrationResult";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::IDnssdServiceInstance> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstance";
template <>
inline constexpr auto& name_v<winrt::Windows::Networking::ServiceDiscovery::
                                  Dnssd::IDnssdServiceInstanceFactory> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceInstanceFactory";
template <>
inline constexpr auto& name_v<
    winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher> =
    L"Windows.Networking.ServiceDiscovery.Dnssd.IDnssdServiceWatcher";
template <>
inline constexpr guid guid_v<winrt::Windows::Networking::ServiceDiscovery::
                                 Dnssd::IDnssdRegistrationResult>{
    0x3D786AD2,
    0xE606,
    0x5350,
    {0x73, 0xEA, 0x7E, 0x97, 0xF0, 0x66, 0x16,
     0x2F}};  // 3D786AD2-E606-5350-73EA-7E97F066162F
template <>
inline constexpr guid guid_v<
    ...
    0x98A5,
    0x4CA1,
    {0xB9, 0xE4, 0xC2, 0x53, 0xD3, 0x3C, 0x35,
     0xFF}};  // E246DB7E-98A5-4CA1-B9E4-C253D33C35FF
template <>
inline constexpr guid guid_v<winrt::Windows::Networking::ServiceDiscovery::
                                 Dnssd::IDnssdServiceInstanceFactory>{
    0x6CB061A1,
    0xC478,
    0x4331,
    {0x96, 0x84, 0x4A, 0xF2, 0x18, 0x6C, 0x0A,
     0x2B}};  // 6CB061A1-C478-4331-9684-4AF2186C0A2B
template <>
inline constexpr guid guid_v<
    winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher>{
    0xCC34D9C1,
    0xDB7D,
    0x4B69,
    {0x98, 0x3D, 0xC6, 0xF8, 0x3F, 0x20, 0x56,
     0x82}};  // CC34D9C1-DB7D-4B69-983D-C6F83F205682
template <>
struct default_interface<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                             DnssdRegistrationResult> {
  using type = winrt::Windows::Networking::ServiceDiscovery::Dnssd::
      IDnssdRegistrationResult;
};
template <>
...
template <>
struct abi<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
               IDnssdRegistrationResult> {
...
struct abi<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
  ...
  struct __declspec(novtable) type : inspectable_abi {
    ...
    virtual int32_t __stdcall RegisterStreamSocketListenerAsync1(
        void*, void**) noexcept = 0;
    virtual int32_t __stdcall RegisterStreamSocketListenerAsync2(
        void*, void*, void**) noexcept = 0;
    virtual int32_t __stdcall RegisterDatagramSocketAsync1(void*,
                                                           void**) noexcept = 0;
    virtual int32_t __stdcall RegisterDatagramSocketAsync2(void*, void*,
                                                           void**) noexcept = 0;
  };
};
template <>
...
struct
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Networking::ServiceDiscovery::
                                    Dnssd::DnssdRegistrationStatus)
      Status() const;
...
template <>
struct consume<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                   IDnssdRegistrationResult> {
  template <typename D>
  using type =
      consume_Windows_Networking_ServiceDiscovery_Dnssd_IDnssdRegistrationResult<
...
struct consume_Windows_Networking_ServiceDiscovery_Dnssd_IDnssdServiceInstance {
  ...
  DnssdServiceInstanceName(param::hstring const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Networking::HostName)
      HostName() const;
  WINRT_IMPL_AUTO(void)
  HostName(winrt::Windows::Networking::HostName const& value) const;
  ...
  RegisterDatagramSocketAsync(
      winrt::Windows::Networking::Sockets::DatagramSocket const& socket) const;
  WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<
                  winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                      DnssdRegistrationResult>)
  RegisterDatagramSocketAsync(
...
struct
  ...
  WINRT_IMPL_AUTO(
      winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstance)
  Create(param::hstring const& dnssdServiceInstanceName,
...
struct consume_Windows_Networking_ServiceDiscovery_Dnssd_IDnssdServiceWatcher {
  ...
  using Added_revoker = impl::event_revoker<
      winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher,
      &impl::abi_t<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                       IDnssdServiceWatcher>::remove_Added>;
  ...
  using EnumerationCompleted_revoker = impl::event_revoker<
      winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher,
      &impl::abi_t<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                       IDnssdServiceWatcher>::remove_EnumerationCompleted>;
  ...
  using Stopped_revoker = impl::event_revoker<
      winrt::Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceWatcher,
      &impl::abi_t<winrt::Windows::Networking::ServiceDiscovery::Dnssd::
                       IDnssdServiceWatcher>::remove_Stopped>;
