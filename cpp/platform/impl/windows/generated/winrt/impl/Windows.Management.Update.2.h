...
WINRT_EXPORT namespace winrt::Windows::Management::Update {
  struct __declspec(empty_bases) PreviewBuildsManager
      : winrt::Windows::Management::Update::IPreviewBuildsManager {
    PreviewBuildsManager(std::nullptr_t) noexcept {}
    PreviewBuildsManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Update::IPreviewBuildsManager(
    ...
    PreviewBuildsManager& operator=(PreviewBuildsManager const&) & noexcept =
        default;
    PreviewBuildsManager& operator=(PreviewBuildsManager&&) & noexcept =
        default;
    static auto GetDefault();
    static auto IsSupported();
  };
  struct __declspec(empty_bases) PreviewBuildsState
      : winrt::Windows::Management::Update::IPreviewBuildsState {
    PreviewBuildsState(std::nullptr_t) noexcept {}
    PreviewBuildsState(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Update::IPreviewBuildsState(
              ptr, take_ownership_from_abi) {}
    PreviewBuildsState(PreviewBuildsState const&) noexcept = default;
    PreviewBuildsState(PreviewBuildsState&&) noexcept = default;
    PreviewBuildsState& operator=(PreviewBuildsState const&) & noexcept =
        default;
