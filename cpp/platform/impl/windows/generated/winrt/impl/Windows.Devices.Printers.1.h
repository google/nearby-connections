...
WINRT_EXPORT namespace winrt::Windows::Devices::Printers {
  struct __declspec(empty_bases) IPrint3DDevice
    ...
    IPrint3DDevice(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IPrint3DDeviceStatics
    ...
    IPrint3DDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IPrint3DDeviceStatics& operator=(IPrint3DDeviceStatics const&) & noexcept =
        default;
    IPrint3DDeviceStatics& operator=(IPrint3DDeviceStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPrintSchema
    ...
    IPrintSchema(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
