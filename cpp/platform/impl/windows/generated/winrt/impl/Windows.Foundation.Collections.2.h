...
WINRT_EXPORT namespace winrt::Windows::Foundation::Collections {
  ...
  struct MapChangedEventHandler : Windows::Foundation::IUnknown {
    ...
    MapChangedEventHandler(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    MapChangedEventHandler& operator=(
        MapChangedEventHandler const&) & noexcept = default;
    MapChangedEventHandler& operator=(MapChangedEventHandler&&) & noexcept =
        default;
    template <typename L>
    MapChangedEventHandler(L lambda);
    template <typename F>
    MapChangedEventHandler(F* function);
    template <typename O, typename M>
    MapChangedEventHandler(O* object, M method);
    template <typename O, typename M>
    MapChangedEventHandler(com_ptr<O>&& object, M method);
    template <typename O, typename M>
    MapChangedEventHandler(weak_ref<O>&& object, M method);
    auto operator()(
  ...
  struct VectorChangedEventHandler : Windows::Foundation::IUnknown {
    ...
    VectorChangedEventHandler(void* ptr, take_ownership_from_abi_t) noexcept
        : Windows::Foundation::IUnknown(ptr, take_ownership_from_abi) {}
    VectorChangedEventHandler(VectorChangedEventHandler const&) noexcept =
        default;
    VectorChangedEventHandler(VectorChangedEventHandler&&) noexcept = default;
    VectorChangedEventHandler& operator=(
        VectorChangedEventHandler const&) & noexcept = default;
    VectorChangedEventHandler& operator=(
        VectorChangedEventHandler&&) & noexcept = default;
    template <typename L>
    VectorChangedEventHandler(L lambda);
    template <typename F>
    VectorChangedEventHandler(F* function);
    template <typename O, typename M>
    VectorChangedEventHandler(O* object, M method);
    template <typename O, typename M>
    VectorChangedEventHandler(com_ptr<O>&& object, M method);
    template <typename O, typename M>
    VectorChangedEventHandler(weak_ref<O>&& object, M method);
    auto operator()(
  ...
  struct __declspec(empty_bases) PropertySet
  ...
  struct __declspec(empty_bases) StringMap
      : winrt::Windows::Foundation::Collections::IMap<hstring, hstring>,
        impl::require<StringMap, winrt::Windows::Foundation::Collections::
  ...
  struct __declspec(empty_bases) ValueSet
      : winrt::Windows::Foundation::Collections::IPropertySet {
    ValueSet(std::nullptr_t) noexcept {}
    ValueSet(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::Collections::IPropertySet(
              ptr, take_ownership_from_abi) {}
    ValueSet();
