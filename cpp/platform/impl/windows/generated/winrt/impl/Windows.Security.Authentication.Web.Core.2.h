...
WINRT_EXPORT namespace winrt::Windows::Security::Authentication::Web::Core {
  struct __declspec(empty_bases) FindAllAccountsResult
      : winrt::Windows::Security::Authentication::Web::Core::
            IFindAllAccountsResult {
    FindAllAccountsResult(std::nullptr_t) noexcept {}
    FindAllAccountsResult(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IFindAllAccountsResult(ptr, take_ownership_from_abi) {}
    ...
    FindAllAccountsResult& operator=(FindAllAccountsResult const&) & noexcept =
        default;
    FindAllAccountsResult& operator=(FindAllAccountsResult&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) WebAccountEventArgs
      : winrt::Windows::Security::Authentication::Web::Core::
            IWebAccountEventArgs {
    WebAccountEventArgs(std::nullptr_t) noexcept {}
    WebAccountEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IWebAccountEventArgs(ptr, take_ownership_from_abi) {}
    WebAccountEventArgs(WebAccountEventArgs const&) noexcept = default;
    WebAccountEventArgs(WebAccountEventArgs&&) noexcept = default;
    WebAccountEventArgs& operator=(WebAccountEventArgs const&) & noexcept =
        default;
    WebAccountEventArgs& operator=(WebAccountEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) WebAccountMonitor
      : winrt::Windows::Security::Authentication::Web::Core::IWebAccountMonitor,
        impl::require<WebAccountMonitor,
                      winrt::Windows::Security::Authentication::Web::Core::
                          IWebAccountMonitor2> {
    WebAccountMonitor(std::nullptr_t) noexcept {}
    WebAccountMonitor(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IWebAccountMonitor(ptr, take_ownership_from_abi) {}
  ...
  struct WebAuthenticationCoreManager {
    ...
    static auto GetTokenSilentlyAsync(
        winrt::Windows::Security::Authentication::Web::Core::
    ...
    static auto CreateWebAccountMonitor(
        param::iterable<
            winrt::Windows::Security::Credentials::WebAccount> const&
            webAccounts);
    static auto FindAllAccountsAsync(
        winrt::Windows::Security::Credentials::WebAccountProvider const&
            provider);
    static auto FindAllAccountsAsync(
        winrt::Windows::Security::Credentials::WebAccountProvider const&
    ...
    static auto FindSystemAccountProviderAsync(
        param::hstring const& webAccountProviderId);
    static auto FindSystemAccountProviderAsync(
        param::hstring const& webAccountProviderId,
        param::hstring const& authority);
  ...
  struct __declspec(empty_bases) WebProviderError
      : winrt::Windows::Security::Authentication::Web::Core::IWebProviderError {
    WebProviderError(std::nullptr_t) noexcept {}
    WebProviderError(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IWebProviderError(ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) WebTokenRequest
      : winrt::Windows::Security::Authentication::Web::Core::IWebTokenRequest,
        impl::require<WebTokenRequest,
                      winrt::Windows::Security::Authentication::Web::Core::
                          IWebTokenRequest2,
                      winrt::Windows::Security::Authentication::Web::Core::
                          IWebTokenRequest3> {
    WebTokenRequest(std::nullptr_t) noexcept {}
    WebTokenRequest(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::IWebTokenRequest(
  ...
  struct __declspec(empty_bases) WebTokenRequestResult
      : winrt::Windows::Security::Authentication::Web::Core::
            IWebTokenRequestResult {
    WebTokenRequestResult(std::nullptr_t) noexcept {}
    WebTokenRequestResult(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IWebTokenRequestResult(ptr, take_ownership_from_abi) {}
    ...
    WebTokenRequestResult& operator=(WebTokenRequestResult const&) & noexcept =
        default;
    WebTokenRequestResult& operator=(WebTokenRequestResult&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) WebTokenResponse
      : winrt::Windows::Security::Authentication::Web::Core::IWebTokenResponse {
    WebTokenResponse(std::nullptr_t) noexcept {}
    WebTokenResponse(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Security::Authentication::Web::Core::
              IWebTokenResponse(ptr, take_ownership_from_abi) {}
    WebTokenResponse();
