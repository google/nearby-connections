...
WINRT_EXPORT namespace winrt::Windows::Globalization::Fonts {
  struct __declspec(empty_bases) LanguageFont
      : winrt::Windows::Globalization::Fonts::ILanguageFont {
    LanguageFont(std::nullptr_t) noexcept {}
    LanguageFont(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Globalization::Fonts::ILanguageFont(
  ...
  struct __declspec(empty_bases) LanguageFontGroup
      : winrt::Windows::Globalization::Fonts::ILanguageFontGroup {
    LanguageFontGroup(std::nullptr_t) noexcept {}
    LanguageFontGroup(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Globalization::Fonts::ILanguageFontGroup(
              ptr, take_ownership_from_abi) {}
