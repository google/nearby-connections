...
template <>
struct category<winrt::Windows::ApplicationModel::UserDataAccounts::
                    SystemAccess::UserDataAccountSystemAccessManager> {
  using type = class_category;
};
template <>
struct category<winrt::Windows::ApplicationModel::UserDataAccounts::
...
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountConfiguration> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountConfiguration";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               UserDataAccountSystemAccessManager> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"UserDataAccountSystemAccessManager";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountAuthenticationType> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountAuthenticationType";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountIconId> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountIconId";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountMailAgeFilter> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountMailAgeFilter";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountServerType> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountServerType";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               DeviceAccountSyncScheduleKind> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"DeviceAccountSyncScheduleKind";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IDeviceAccountConfiguration> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"IDeviceAccountConfiguration";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IDeviceAccountConfiguration2> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"IDeviceAccountConfiguration2";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"IUserDataAccountSystemAccessManagerStatics";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics2> =
        L"Windows.ApplicationModel.UserDataAccounts.SystemAccess."
        L"IUserDataAccountSystemAccessManagerStatics2";
template <>
inline constexpr guid
    guid_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IDeviceAccountConfiguration>{
        0xAD0123A3,
        0xFBDC,
        0x4D1B,
        {0xBE, 0x43, 0x5A, 0x27, 0xEA, 0x4A, 0x1B,
         0x63}};  // AD0123A3-FBDC-4D1B-BE43-5A27EA4A1B63
template <>
inline constexpr guid
    guid_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IDeviceAccountConfiguration2>{
        ...
        0x728D,
        0x4A4A,
        {0x89, 0x45, 0x2B, 0xF8, 0x58, 0x01, 0x36,
         0xDE}};  // F2B2E5A6-728D-4A4A-8945-2BF8580136DE
template <>
inline constexpr guid
    guid_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics>{
        ...
        0xCBE5,
        0x45F5,
        {0x82, 0x2B, 0xC2, 0x67, 0xB8, 0x1D, 0xBD,
         0xB6}};  // 9D6B11B9-CBE5-45F5-822B-C267B81DBDB6
template <>
inline constexpr guid
    guid_v<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics2>{
        ...
        0x4B4E,
        0x439F,
        {0x83, 0xD3, 0x97, 0x9B, 0x27, 0xC0, 0x5A,
         0xC7}};  // 943F854D-4B4E-439F-83D3-979B27C05AC7
template <>
...
template <>
struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IDeviceAccountConfiguration> {
...
struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
  ...
  struct __declspec(novtable) type : inspectable_abi {
    ...
    virtual int32_t __stdcall get_IsSsoAuthenticationSupported(
        bool*) noexcept = 0;
    ...
    virtual int32_t __stdcall get_IsClientAuthenticationCertificateRequired(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_IsClientAuthenticationCertificateRequired(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_AutoSelectAuthenticationCertificate(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_AutoSelectAuthenticationCertificate(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_AuthenticationCertificateId(
        void**) noexcept = 0;
    virtual int32_t __stdcall put_AuthenticationCertificateId(
        void*) noexcept = 0;
    virtual int32_t __stdcall get_CardDavSyncScheduleKind(
        int32_t*) noexcept = 0;
    ...
    virtual int32_t __stdcall get_WasIncomingServerCertificateHashConfirmed(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_WasIncomingServerCertificateHashConfirmed(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_IncomingServerCertificateHash(
        void**) noexcept = 0;
    virtual int32_t __stdcall put_IncomingServerCertificateHash(
        void*) noexcept = 0;
    virtual int32_t __stdcall get_IsOutgoingServerAuthenticationRequired(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_IsOutgoingServerAuthenticationRequired(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_IsOutgoingServerAuthenticationEnabled(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_IsOutgoingServerAuthenticationEnabled(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_WasOutgoingServerCertificateHashConfirmed(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_WasOutgoingServerCertificateHashConfirmed(
        bool) noexcept = 0;
    virtual int32_t __stdcall get_OutgoingServerCertificateHash(
        void**) noexcept = 0;
    virtual int32_t __stdcall put_OutgoingServerCertificateHash(
        void*) noexcept = 0;
    virtual int32_t __stdcall get_IsSyncScheduleManagedBySystem(
        bool*) noexcept = 0;
    virtual int32_t __stdcall put_IsSyncScheduleManagedBySystem(
        bool) noexcept = 0;
  };
};
template <>
struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics> {
  struct __declspec(novtable) type : inspectable_abi {
    virtual int32_t __stdcall AddAndShowDeviceAccountsAsync(
...
struct abi<winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
               IUserDataAccountSystemAccessManagerStatics2> {
  struct __declspec(novtable) type : inspectable_abi {
    virtual int32_t __stdcall SuppressLocalAccountWithAccountAsync(
        void*, void**) noexcept = 0;
    virtual int32_t __stdcall CreateDeviceAccountAsync(void*,
                                                       void**) noexcept = 0;
    virtual int32_t __stdcall DeleteDeviceAccountAsync(void*,
                                                       void**) noexcept = 0;
    virtual int32_t __stdcall GetDeviceAccountConfigurationAsync(
        void*, void**) noexcept = 0;
  };
};
template <typename D>
struct
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountServerType) ServerType() const;
  WINRT_IMPL_AUTO(void)
  ServerType(winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
                 DeviceAccountServerType const& value) const;
  ...
  WINRT_IMPL_AUTO(void)
  IncomingServerAddress(param::hstring const& value) const;
  ...
  WINRT_IMPL_AUTO(void)
  IncomingServerUsername(param::hstring const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(hstring) OutgoingServerAddress() const;
  WINRT_IMPL_AUTO(void)
  OutgoingServerAddress(param::hstring const& value) const;
  ...
  WINRT_IMPL_AUTO(void)
  OutgoingServerUsername(param::hstring const& value) const;
};
template <>
...
struct
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      ...
      IncomingServerCredential() const;
  WINRT_IMPL_AUTO(void)
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::Security::Credentials::PasswordCredential)
      OutgoingServerCredential() const;
  WINRT_IMPL_AUTO(void)
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountIconId) AccountIconId() const;
  WINRT_IMPL_AUTO(void)
  AccountIconId(winrt::Windows::ApplicationModel::UserDataAccounts::
                    SystemAccess::DeviceAccountIconId const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountAuthenticationType) AuthenticationType() const;
  WINRT_IMPL_AUTO(void)
  AuthenticationType(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountSyncScheduleKind) SyncScheduleKind() const;
  WINRT_IMPL_AUTO(void)
  SyncScheduleKind(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountMailAgeFilter) MailAgeFilter() const;
  WINRT_IMPL_AUTO(void)
  MailAgeFilter(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountMailAgeFilter const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      IsClientAuthenticationCertificateRequired() const;
  WINRT_IMPL_AUTO(void)
  IsClientAuthenticationCertificateRequired(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      AutoSelectAuthenticationCertificate() const;
  ...
  WINRT_IMPL_AUTO(void)
  AuthenticationCertificateId(param::hstring const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountSyncScheduleKind) CardDavSyncScheduleKind() const;
  WINRT_IMPL_AUTO(void)
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountSyncScheduleKind) CalDavSyncScheduleKind() const;
  WINRT_IMPL_AUTO(void)
  CalDavSyncScheduleKind(
      winrt::Windows::ApplicationModel::UserDataAccounts::SystemAccess::
          DeviceAccountSyncScheduleKind const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri)
      CardDavServerUrl() const;
  WINRT_IMPL_AUTO(void)
  CardDavServerUrl(winrt::Windows::Foundation::Uri const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool) CardDavRequiresSsl() const;
  WINRT_IMPL_AUTO(void) CardDavRequiresSsl(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri)
      CalDavServerUrl() const;
  WINRT_IMPL_AUTO(void)
  CalDavServerUrl(winrt::Windows::Foundation::Uri const& value) const;
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      WasIncomingServerCertificateHashConfirmed() const;
  WINRT_IMPL_AUTO(void)
  WasIncomingServerCertificateHashConfirmed(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(hstring) IncomingServerCertificateHash() const;
  WINRT_IMPL_AUTO(void)
  IncomingServerCertificateHash(param::hstring const& value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      IsOutgoingServerAuthenticationRequired() const;
  WINRT_IMPL_AUTO(void)
  IsOutgoingServerAuthenticationRequired(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      IsOutgoingServerAuthenticationEnabled() const;
  WINRT_IMPL_AUTO(void) IsOutgoingServerAuthenticationEnabled(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(bool)
      WasOutgoingServerCertificateHashConfirmed() const;
  WINRT_IMPL_AUTO(void)
  WasOutgoingServerCertificateHashConfirmed(bool value) const;
  [[nodiscard]] WINRT_IMPL_AUTO(hstring) OutgoingServerCertificateHash() const;
  WINRT_IMPL_AUTO(void)
  OutgoingServerCertificateHash(param::hstring const& value) const;
...
struct
  ...
  WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction)
  DeleteDeviceAccountAsync(param::hstring const& accountId) const;
  WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<
                  winrt::Windows::ApplicationModel::UserDataAccounts::
                      SystemAccess::DeviceAccountConfiguration>)
  GetDeviceAccountConfigurationAsync(param::hstring const& accountId) const;
};
template <>
struct consume<winrt::Windows::ApplicationModel::UserDataAccounts::
                   SystemAccess::IUserDataAccountSystemAccessManagerStatics2> {
