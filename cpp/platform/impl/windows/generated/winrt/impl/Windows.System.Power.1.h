...
WINRT_EXPORT namespace winrt::Windows::System::Power {
  struct __declspec(empty_bases) IBackgroundEnergyManagerStatics
    ...
    IBackgroundEnergyManagerStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IBackgroundEnergyManagerStatics(
        IBackgroundEnergyManagerStatics const&) noexcept = default;
    IBackgroundEnergyManagerStatics(
        IBackgroundEnergyManagerStatics&&) noexcept = default;
    IBackgroundEnergyManagerStatics& operator=(
        IBackgroundEnergyManagerStatics const&) & noexcept = default;
    IBackgroundEnergyManagerStatics& operator=(
        IBackgroundEnergyManagerStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IForegroundEnergyManagerStatics
    ...
    IForegroundEnergyManagerStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IForegroundEnergyManagerStatics(
        IForegroundEnergyManagerStatics const&) noexcept = default;
    IForegroundEnergyManagerStatics(
        IForegroundEnergyManagerStatics&&) noexcept = default;
    IForegroundEnergyManagerStatics& operator=(
        IForegroundEnergyManagerStatics const&) & noexcept = default;
    IForegroundEnergyManagerStatics& operator=(
        IForegroundEnergyManagerStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPowerManagerStatics
    ...
    IPowerManagerStatics& operator=(IPowerManagerStatics const&) & noexcept =
        default;
    IPowerManagerStatics& operator=(IPowerManagerStatics&&) & noexcept =
        default;
  };
}
#endif
