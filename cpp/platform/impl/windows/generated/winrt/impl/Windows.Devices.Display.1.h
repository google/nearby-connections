...
WINRT_EXPORT namespace winrt::Windows::Devices::Display {
  struct __declspec(empty_bases) IDisplayMonitor
    ...
    IDisplayMonitor(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IDisplayMonitor2
    ...
    IDisplayMonitor2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IDisplayMonitorStatics
    ...
    IDisplayMonitorStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IDisplayMonitorStatics& operator=(
        IDisplayMonitorStatics const&) & noexcept = default;
    IDisplayMonitorStatics& operator=(IDisplayMonitorStatics&&) & noexcept =
        default;
  };
}
#endif
