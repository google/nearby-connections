...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Preview::Holographic {
  struct __declspec(empty_bases) IHolographicApplicationPreviewStatics
    ...
    IHolographicApplicationPreviewStatics(void* ptr,
                                          take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHolographicApplicationPreviewStatics(
        IHolographicApplicationPreviewStatics const&) noexcept = default;
    IHolographicApplicationPreviewStatics(
        IHolographicApplicationPreviewStatics&&) noexcept = default;
    IHolographicApplicationPreviewStatics& operator=(
        IHolographicApplicationPreviewStatics const&) & noexcept = default;
    IHolographicApplicationPreviewStatics& operator=(
        IHolographicApplicationPreviewStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IHolographicKeyboardPlacementOverridePreview
    ...
    IHolographicKeyboardPlacementOverridePreview(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHolographicKeyboardPlacementOverridePreview(
        IHolographicKeyboardPlacementOverridePreview const&) noexcept = default;
    IHolographicKeyboardPlacementOverridePreview(
        IHolographicKeyboardPlacementOverridePreview&&) noexcept = default;
    IHolographicKeyboardPlacementOverridePreview& operator=(
        IHolographicKeyboardPlacementOverridePreview const&) & noexcept =
        default;
    IHolographicKeyboardPlacementOverridePreview& operator=(
        IHolographicKeyboardPlacementOverridePreview&&) & noexcept = default;
  };
  struct __declspec(empty_bases)
    ...
    IHolographicKeyboardPlacementOverridePreviewStatics(
        ...
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IHolographicKeyboardPlacementOverridePreviewStatics(
        IHolographicKeyboardPlacementOverridePreviewStatics const&) noexcept =
        default;
    IHolographicKeyboardPlacementOverridePreviewStatics(
        IHolographicKeyboardPlacementOverridePreviewStatics&&) noexcept =
        default;
    IHolographicKeyboardPlacementOverridePreviewStatics& operator=(
        IHolographicKeyboardPlacementOverridePreviewStatics const&) & noexcept =
        default;
    IHolographicKeyboardPlacementOverridePreviewStatics& operator=(
        IHolographicKeyboardPlacementOverridePreviewStatics&&) & noexcept =
