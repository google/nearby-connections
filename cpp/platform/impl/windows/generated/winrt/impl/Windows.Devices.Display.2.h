...
WINRT_EXPORT namespace winrt::Windows::Devices::Display {
  struct __declspec(empty_bases) DisplayMonitor
      : winrt::Windows::Devices::Display::IDisplayMonitor,
        impl::require<DisplayMonitor,
                      winrt::Windows::Devices::Display::IDisplayMonitor2> {
    DisplayMonitor(std::nullptr_t) noexcept {}
    DisplayMonitor(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Display::IDisplayMonitor(
