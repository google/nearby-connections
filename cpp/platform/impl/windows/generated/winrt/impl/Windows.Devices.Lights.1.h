...
WINRT_EXPORT namespace winrt::Windows::Devices::Lights {
  struct __declspec(empty_bases) ILamp
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Devices::Lights::ILamp,
                      winrt::Windows::Foundation::IClosable> {
    ILamp(std::nullptr_t = nullptr) noexcept {}
    ILamp(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) ILampArray
    ...
    ILampArray(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ILampArrayStatics
    ...
    ILampArrayStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ILampAvailabilityChangedEventArgs
    ...
    ILampAvailabilityChangedEventArgs(void* ptr,
                                      take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILampAvailabilityChangedEventArgs(
        ILampAvailabilityChangedEventArgs const&) noexcept = default;
    ILampAvailabilityChangedEventArgs(
        ILampAvailabilityChangedEventArgs&&) noexcept = default;
    ILampAvailabilityChangedEventArgs& operator=(
        ILampAvailabilityChangedEventArgs const&) & noexcept = default;
    ILampAvailabilityChangedEventArgs& operator=(
        ILampAvailabilityChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ILampInfo
    ...
    ILampInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ILampStatics
    ...
    ILampStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
