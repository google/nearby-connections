...
WINRT_EXPORT namespace winrt::Windows::Security::Authorization::
  ...
  struct __declspec(empty_bases) IAppCapability
    ...
    IAppCapability(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IAppCapabilityAccessChangedEventArgs
    ...
    IAppCapabilityAccessChangedEventArgs(void* ptr,
                                         take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IAppCapabilityAccessChangedEventArgs(
        IAppCapabilityAccessChangedEventArgs const&) noexcept = default;
    IAppCapabilityAccessChangedEventArgs(
        IAppCapabilityAccessChangedEventArgs&&) noexcept = default;
    IAppCapabilityAccessChangedEventArgs& operator=(
        IAppCapabilityAccessChangedEventArgs const&) & noexcept = default;
    IAppCapabilityAccessChangedEventArgs& operator=(
        IAppCapabilityAccessChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IAppCapabilityStatics
    ...
    IAppCapabilityStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IAppCapabilityStatics& operator=(IAppCapabilityStatics const&) & noexcept =
        default;
    IAppCapabilityStatics& operator=(IAppCapabilityStatics&&) & noexcept =
        default;
  };
}
#endif
