...
WINRT_EXPORT namespace winrt::Windows::Devices::Sensors::Custom {
  struct __declspec(empty_bases) CustomSensor
    ...
    CustomSensor(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Sensors::Custom::ICustomSensor(
  ...
  struct __declspec(empty_bases) CustomSensorReading
    ...
    CustomSensorReading(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Sensors::Custom::ICustomSensorReading(
              ptr, take_ownership_from_abi) {}
    CustomSensorReading(CustomSensorReading const&) noexcept = default;
    CustomSensorReading(CustomSensorReading&&) noexcept = default;
    CustomSensorReading& operator=(CustomSensorReading const&) & noexcept =
        default;
    CustomSensorReading& operator=(CustomSensorReading&&) & noexcept = default;
  };
  struct __declspec(empty_bases) CustomSensorReadingChangedEventArgs
    ...
    CustomSensorReadingChangedEventArgs(void* ptr,
                                        take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Sensors::Custom::
              ICustomSensorReadingChangedEventArgs(ptr,
                                                   take_ownership_from_abi) {}
    CustomSensorReadingChangedEventArgs(
        CustomSensorReadingChangedEventArgs const&) noexcept = default;
    CustomSensorReadingChangedEventArgs(
        CustomSensorReadingChangedEventArgs&&) noexcept = default;
    CustomSensorReadingChangedEventArgs& operator=(
        CustomSensorReadingChangedEventArgs const&) & noexcept = default;
    CustomSensorReadingChangedEventArgs& operator=(
        CustomSensorReadingChangedEventArgs&&) & noexcept = default;
  };
