...
WINRT_EXPORT namespace winrt::Windows::Data::Xml::Xsl {
  struct __declspec(empty_bases) IXsltProcessor
    ...
    IXsltProcessor(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IXsltProcessor2
    ...
    IXsltProcessor2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IXsltProcessorFactory
    ...
    IXsltProcessorFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IXsltProcessorFactory& operator=(IXsltProcessorFactory const&) & noexcept =
        default;
    IXsltProcessorFactory& operator=(IXsltProcessorFactory&&) & noexcept =
        default;
  };
}
#endif
