...
WINRT_EXPORT namespace winrt::Windows::Graphics::Effects {
  struct __declspec(empty_bases) IGraphicsEffect
    ...
    IGraphicsEffect(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IGraphicsEffectSource
    ...
    IGraphicsEffectSource(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IGraphicsEffectSource& operator=(IGraphicsEffectSource const&) & noexcept =
        default;
    IGraphicsEffectSource& operator=(IGraphicsEffectSource&&) & noexcept =
        default;
  };
}
#endif
