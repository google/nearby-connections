...
WINRT_EXPORT namespace winrt::Windows::Media::Ocr {
  struct __declspec(empty_bases) IOcrEngine
    ...
    IOcrEngine(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) IOcrEngineStatics
    ...
    IOcrEngineStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IOcrLine
    ...
    IOcrLine(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IOcrResult
    ...
    IOcrResult(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IOcrWord
    ...
    IOcrWord(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
