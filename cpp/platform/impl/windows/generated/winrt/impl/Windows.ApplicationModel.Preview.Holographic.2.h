...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Preview::Holographic {
  struct HolographicApplicationPreview {
    ...
    static auto IsHolographicActivation(
        winrt::Windows::ApplicationModel::Activation::IActivatedEventArgs const&
            activatedEventArgs);
  };
  struct __declspec(empty_bases) HolographicKeyboardPlacementOverridePreview
    ...
    HolographicKeyboardPlacementOverridePreview(
        HolographicKeyboardPlacementOverridePreview const&) noexcept = default;
    HolographicKeyboardPlacementOverridePreview(
        HolographicKeyboardPlacementOverridePreview&&) noexcept = default;
    HolographicKeyboardPlacementOverridePreview& operator=(
        HolographicKeyboardPlacementOverridePreview const&) & noexcept =
        default;
    HolographicKeyboardPlacementOverridePreview& operator=(
        HolographicKeyboardPlacementOverridePreview&&) & noexcept = default;
