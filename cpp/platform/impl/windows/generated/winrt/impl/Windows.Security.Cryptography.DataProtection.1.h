...
WINRT_EXPORT namespace winrt::Windows::Security::Cryptography::DataProtection {
  struct __declspec(empty_bases) IDataProtectionProvider
    ...
    IDataProtectionProvider(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IDataProtectionProvider& operator=(
        IDataProtectionProvider const&) & noexcept = default;
    IDataProtectionProvider& operator=(IDataProtectionProvider&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IDataProtectionProviderFactory
    ...
    IDataProtectionProviderFactory(void* ptr,
                                   take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IDataProtectionProviderFactory(
        IDataProtectionProviderFactory const&) noexcept = default;
    IDataProtectionProviderFactory(IDataProtectionProviderFactory&&) noexcept =
        default;
    IDataProtectionProviderFactory& operator=(
        IDataProtectionProviderFactory const&) & noexcept = default;
    IDataProtectionProviderFactory& operator=(
        IDataProtectionProviderFactory&&) & noexcept = default;
  };
}
#endif
