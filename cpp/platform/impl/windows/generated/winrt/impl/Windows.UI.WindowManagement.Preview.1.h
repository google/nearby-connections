...
WINRT_EXPORT namespace winrt::Windows::UI::WindowManagement::Preview {
  struct __declspec(empty_bases) IWindowManagementPreview
    ...
    IWindowManagementPreview(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWindowManagementPreview(IWindowManagementPreview const&) noexcept =
        default;
    IWindowManagementPreview(IWindowManagementPreview&&) noexcept = default;
    IWindowManagementPreview& operator=(
        IWindowManagementPreview const&) & noexcept = default;
    IWindowManagementPreview& operator=(IWindowManagementPreview&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IWindowManagementPreviewStatics
    ...
    IWindowManagementPreviewStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IWindowManagementPreviewStatics(
        IWindowManagementPreviewStatics const&) noexcept = default;
    IWindowManagementPreviewStatics(
        IWindowManagementPreviewStatics&&) noexcept = default;
    IWindowManagementPreviewStatics& operator=(
        IWindowManagementPreviewStatics const&) & noexcept = default;
    IWindowManagementPreviewStatics& operator=(
        IWindowManagementPreviewStatics&&) & noexcept = default;
  };
