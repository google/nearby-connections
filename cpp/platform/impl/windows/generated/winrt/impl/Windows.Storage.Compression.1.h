...
WINRT_EXPORT namespace winrt::Windows::Storage::Compression {
  ...
  struct __declspec(empty_bases) ICompressorFactory
    ...
    ICompressorFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ICompressorFactory(ICompressorFactory const&) noexcept = default;
    ICompressorFactory(ICompressorFactory&&) noexcept = default;
    ICompressorFactory& operator=(ICompressorFactory const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IDecompressor
      : winrt::Windows::Foundation::IInspectable,
        ...
        impl::require<winrt::Windows::Storage::Compression::IDecompressor,
                      winrt::Windows::Foundation::IClosable,
                      winrt::Windows::Storage::Streams::IInputStream> {
    IDecompressor(std::nullptr_t = nullptr) noexcept {}
    IDecompressor(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) IDecompressorFactory
    ...
    IDecompressorFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IDecompressorFactory& operator=(IDecompressorFactory const&) & noexcept =
        default;
    IDecompressorFactory& operator=(IDecompressorFactory&&) & noexcept =
        default;
  };
}
#endif
