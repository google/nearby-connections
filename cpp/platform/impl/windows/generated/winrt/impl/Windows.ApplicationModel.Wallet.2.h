...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Wallet {
  struct __declspec(empty_bases) WalletBarcode
      : winrt::Windows::ApplicationModel::Wallet::IWalletBarcode {
    WalletBarcode(std::nullptr_t) noexcept {}
    WalletBarcode(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletBarcode(
  ...
  struct __declspec(empty_bases) WalletItem
      : winrt::Windows::ApplicationModel::Wallet::IWalletItem {
    WalletItem(std::nullptr_t) noexcept {}
    WalletItem(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletItem(
              ptr, take_ownership_from_abi) {}
    WalletItem(
  ...
  struct __declspec(empty_bases) WalletItemCustomProperty
      : winrt::Windows::ApplicationModel::Wallet::IWalletItemCustomProperty {
    WalletItemCustomProperty(std::nullptr_t) noexcept {}
    WalletItemCustomProperty(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletItemCustomProperty(
              ptr, take_ownership_from_abi) {}
    WalletItemCustomProperty(param::hstring const& name,
                             param::hstring const& value);
    WalletItemCustomProperty(WalletItemCustomProperty const&) noexcept =
        default;
    WalletItemCustomProperty(WalletItemCustomProperty&&) noexcept = default;
    WalletItemCustomProperty& operator=(
        WalletItemCustomProperty const&) & noexcept = default;
    WalletItemCustomProperty& operator=(WalletItemCustomProperty&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) WalletItemStore
      : winrt::Windows::ApplicationModel::Wallet::IWalletItemStore {
    WalletItemStore(std::nullptr_t) noexcept {}
    WalletItemStore(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletItemStore(
              ptr, take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) WalletRelevantLocation
      : winrt::Windows::ApplicationModel::Wallet::IWalletRelevantLocation {
    WalletRelevantLocation(std::nullptr_t) noexcept {}
    WalletRelevantLocation(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletRelevantLocation(
              ptr, take_ownership_from_abi) {}
    ...
    WalletRelevantLocation& operator=(
        WalletRelevantLocation const&) & noexcept = default;
    WalletRelevantLocation& operator=(WalletRelevantLocation&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) WalletTransaction
      : winrt::Windows::ApplicationModel::Wallet::IWalletTransaction {
    WalletTransaction(std::nullptr_t) noexcept {}
    WalletTransaction(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletTransaction(
              ptr, take_ownership_from_abi) {}
    WalletTransaction();
  ...
  struct __declspec(empty_bases) WalletVerb
      : winrt::Windows::ApplicationModel::Wallet::IWalletVerb {
    WalletVerb(std::nullptr_t) noexcept {}
    WalletVerb(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::ApplicationModel::Wallet::IWalletVerb(
              ptr, take_ownership_from_abi) {}
