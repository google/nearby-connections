...
WINRT_EXPORT namespace winrt::Windows::System::Diagnostics::Telemetry {
  struct __declspec(empty_bases) IPlatformTelemetryClientStatics
    ...
    IPlatformTelemetryClientStatics(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPlatformTelemetryClientStatics(
        IPlatformTelemetryClientStatics const&) noexcept = default;
    IPlatformTelemetryClientStatics(
        IPlatformTelemetryClientStatics&&) noexcept = default;
    IPlatformTelemetryClientStatics& operator=(
        IPlatformTelemetryClientStatics const&) & noexcept = default;
    IPlatformTelemetryClientStatics& operator=(
        IPlatformTelemetryClientStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPlatformTelemetryRegistrationResult
    ...
    IPlatformTelemetryRegistrationResult(void* ptr,
                                         take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPlatformTelemetryRegistrationResult(
        IPlatformTelemetryRegistrationResult const&) noexcept = default;
    IPlatformTelemetryRegistrationResult(
        IPlatformTelemetryRegistrationResult&&) noexcept = default;
    IPlatformTelemetryRegistrationResult& operator=(
        IPlatformTelemetryRegistrationResult const&) & noexcept = default;
    IPlatformTelemetryRegistrationResult& operator=(
        IPlatformTelemetryRegistrationResult&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPlatformTelemetryRegistrationSettings
    ...
    IPlatformTelemetryRegistrationSettings(void* ptr,
                                           take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPlatformTelemetryRegistrationSettings(
        IPlatformTelemetryRegistrationSettings const&) noexcept = default;
    IPlatformTelemetryRegistrationSettings(
        IPlatformTelemetryRegistrationSettings&&) noexcept = default;
    IPlatformTelemetryRegistrationSettings& operator=(
        IPlatformTelemetryRegistrationSettings const&) & noexcept = default;
    IPlatformTelemetryRegistrationSettings& operator=(
        IPlatformTelemetryRegistrationSettings&&) & noexcept = default;
  };
