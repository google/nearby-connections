...
WINRT_EXPORT namespace winrt::Windows::UI::Shell {
  ...
  struct __declspec(empty_bases) SecurityAppManager
      : winrt::Windows::UI::Shell::ISecurityAppManager {
    SecurityAppManager(std::nullptr_t) noexcept {}
    SecurityAppManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::Shell::ISecurityAppManager(
              ptr, take_ownership_from_abi) {}
    SecurityAppManager();
    SecurityAppManager(SecurityAppManager const&) noexcept = default;
    SecurityAppManager(SecurityAppManager&&) noexcept = default;
    SecurityAppManager& operator=(SecurityAppManager const&) & noexcept =
        default;
    SecurityAppManager& operator=(SecurityAppManager&&) & noexcept = default;
  };
  struct __declspec(empty_bases) TaskbarManager
      : winrt::Windows::UI::Shell::ITaskbarManager,
        impl::require<TaskbarManager,
                      winrt::Windows::UI::Shell::ITaskbarManager2> {
    TaskbarManager(std::nullptr_t) noexcept {}
    TaskbarManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::UI::Shell::ITaskbarManager(ptr,
