...
WINRT_EXPORT namespace winrt::Windows::System::Profile {
  struct AnalyticsInfo {
    ...
    static auto GetSystemPropertiesAsync(
        param::async_iterable<hstring> const& attributeNames);
  };
  struct __declspec(empty_bases) AnalyticsVersionInfo
      : winrt::Windows::System::Profile::IAnalyticsVersionInfo {
    AnalyticsVersionInfo(std::nullptr_t) noexcept {}
    AnalyticsVersionInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Profile::IAnalyticsVersionInfo(
    ...
    AnalyticsVersionInfo& operator=(AnalyticsVersionInfo const&) & noexcept =
        default;
    AnalyticsVersionInfo& operator=(AnalyticsVersionInfo&&) & noexcept =
        default;
  };
  struct AppApplicability {
    AppApplicability() = delete;
    static auto GetUnsupportedAppRequirements(
  ...
  struct HardwareIdentification {
    ...
    static auto GetPackageSpecificToken(
        winrt::Windows::Storage::Streams::IBuffer const& nonce);
  };
  struct __declspec(empty_bases) HardwareToken
      : winrt::Windows::System::Profile::IHardwareToken {
    HardwareToken(std::nullptr_t) noexcept {}
    HardwareToken(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Profile::IHardwareToken(
              ptr, take_ownership_from_abi) {}
  ...
  struct PlatformDiagnosticsAndUsageDataSettings {
    ...
    static auto CollectionLevelChanged(
        winrt::Windows::Foundation::EventHandler<
            winrt::Windows::Foundation::IInspectable> const& handler);
    using CollectionLevelChanged_revoker = impl::factory_event_revoker<
    ...
    [[nodiscard]] static CollectionLevelChanged_revoker CollectionLevelChanged(
        auto_revoke_t,
        winrt::Windows::Foundation::EventHandler<
            winrt::Windows::Foundation::IInspectable> const& handler);
    static auto CollectionLevelChanged(winrt::event_token const& token);
    static auto CanCollectDiagnostics(
  ...
  struct __declspec(empty_bases) SystemIdentificationInfo
      : winrt::Windows::System::Profile::ISystemIdentificationInfo {
    SystemIdentificationInfo(std::nullptr_t) noexcept {}
    SystemIdentificationInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Profile::ISystemIdentificationInfo(
              ptr, take_ownership_from_abi) {}
    SystemIdentificationInfo(SystemIdentificationInfo const&) noexcept =
        default;
    SystemIdentificationInfo(SystemIdentificationInfo&&) noexcept = default;
    SystemIdentificationInfo& operator=(
        SystemIdentificationInfo const&) & noexcept = default;
    SystemIdentificationInfo& operator=(SystemIdentificationInfo&&) & noexcept =
        default;
  };
  struct SystemSetupInfo {
    SystemSetupInfo() = delete;
    [[nodiscard]] static auto OutOfBoxExperienceState();
    static auto OutOfBoxExperienceStateChanged(
        winrt::Windows::Foundation::EventHandler<
            winrt::Windows::Foundation::IInspectable> const& handler);
    using OutOfBoxExperienceStateChanged_revoker = impl::factory_event_revoker<
    ...
    [[nodiscard]] static OutOfBoxExperienceStateChanged_revoker
  ...
  struct __declspec(empty_bases) UnsupportedAppRequirement
      : winrt::Windows::System::Profile::IUnsupportedAppRequirement {
    UnsupportedAppRequirement(std::nullptr_t) noexcept {}
    UnsupportedAppRequirement(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Profile::IUnsupportedAppRequirement(
              ptr, take_ownership_from_abi) {}
    UnsupportedAppRequirement(UnsupportedAppRequirement const&) noexcept =
        default;
    UnsupportedAppRequirement(UnsupportedAppRequirement&&) noexcept = default;
    UnsupportedAppRequirement& operator=(
        UnsupportedAppRequirement const&) & noexcept = default;
    UnsupportedAppRequirement& operator=(
        UnsupportedAppRequirement&&) & noexcept = default;
  };
