...
WINRT_EXPORT namespace winrt::Windows::Graphics::DirectX::Direct3D11 {
  ...
  inline bool operator==(Direct3DMultisampleDescription const& left,
                         Direct3DMultisampleDescription const& right) noexcept {
  ...
  inline bool operator==(Direct3DSurfaceDescription const& left,
                         Direct3DSurfaceDescription const& right) noexcept {
    return left.Width == right.Width && left.Height == right.Height &&
           left.Format == right.Format &&
           left.MultisampleDescription == right.MultisampleDescription;
  }
  inline bool operator!=(Direct3DSurfaceDescription const& left,
                         Direct3DSurfaceDescription const& right) noexcept {
    return !(left == right);
