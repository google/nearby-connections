...
WINRT_EXPORT namespace winrt::Windows::Devices::Portable {
  struct __declspec(empty_bases) IServiceDeviceStatics
    ...
    IServiceDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IServiceDeviceStatics& operator=(IServiceDeviceStatics const&) & noexcept =
        default;
    IServiceDeviceStatics& operator=(IServiceDeviceStatics&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IStorageDeviceStatics
    ...
    IStorageDeviceStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ...
    IStorageDeviceStatics& operator=(IStorageDeviceStatics const&) & noexcept =
        default;
    IStorageDeviceStatics& operator=(IStorageDeviceStatics&&) & noexcept =
        default;
  };
}
#endif
