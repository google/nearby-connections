...
WINRT_EXPORT namespace winrt::Windows::System::Update {
  struct __declspec(empty_bases) SystemUpdateItem
      : winrt::Windows::System::Update::ISystemUpdateItem {
    SystemUpdateItem(std::nullptr_t) noexcept {}
    SystemUpdateItem(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Update::ISystemUpdateItem(
  ...
  struct __declspec(empty_bases) SystemUpdateLastErrorInfo
      : winrt::Windows::System::Update::ISystemUpdateLastErrorInfo {
    SystemUpdateLastErrorInfo(std::nullptr_t) noexcept {}
    SystemUpdateLastErrorInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::System::Update::ISystemUpdateLastErrorInfo(
              ptr, take_ownership_from_abi) {}
    SystemUpdateLastErrorInfo(SystemUpdateLastErrorInfo const&) noexcept =
        default;
    SystemUpdateLastErrorInfo(SystemUpdateLastErrorInfo&&) noexcept = default;
    SystemUpdateLastErrorInfo& operator=(
        SystemUpdateLastErrorInfo const&) & noexcept = default;
    SystemUpdateLastErrorInfo& operator=(
        SystemUpdateLastErrorInfo&&) & noexcept = default;
  };
  struct SystemUpdateManager {
    ...
    using StateChanged_revoker = impl::factory_event_revoker<
    ...
    [[nodiscard]] static StateChanged_revoker StateChanged(
        auto_revoke_t,
        winrt::Windows::Foundation::EventHandler<
            winrt::Windows::Foundation::IInspectable> const& handler);
    ...
    static auto TrySetUserActiveHours(
