...
WINRT_EXPORT namespace winrt::Windows::UI::Input::Preview {
  struct __declspec(empty_bases) IInputActivationListenerPreviewStatics
    ...
    IInputActivationListenerPreviewStatics(void* ptr,
                                           take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IInputActivationListenerPreviewStatics(
        IInputActivationListenerPreviewStatics const&) noexcept = default;
    IInputActivationListenerPreviewStatics(
        IInputActivationListenerPreviewStatics&&) noexcept = default;
    IInputActivationListenerPreviewStatics& operator=(
        IInputActivationListenerPreviewStatics const&) & noexcept = default;
    IInputActivationListenerPreviewStatics& operator=(
        IInputActivationListenerPreviewStatics&&) & noexcept = default;
  };
