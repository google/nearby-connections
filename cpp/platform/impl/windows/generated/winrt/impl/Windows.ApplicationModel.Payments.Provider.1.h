...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Payments::Provider {
  struct __declspec(empty_bases) IPaymentAppCanMakePaymentTriggerDetails
    ...
    IPaymentAppCanMakePaymentTriggerDetails(void* ptr,
                                            take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentAppCanMakePaymentTriggerDetails(
        IPaymentAppCanMakePaymentTriggerDetails const&) noexcept = default;
    IPaymentAppCanMakePaymentTriggerDetails(
        IPaymentAppCanMakePaymentTriggerDetails&&) noexcept = default;
    IPaymentAppCanMakePaymentTriggerDetails& operator=(
        IPaymentAppCanMakePaymentTriggerDetails const&) & noexcept = default;
    IPaymentAppCanMakePaymentTriggerDetails& operator=(
        IPaymentAppCanMakePaymentTriggerDetails&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPaymentAppManager
    ...
    IPaymentAppManager(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentAppManager(IPaymentAppManager const&) noexcept = default;
    IPaymentAppManager(IPaymentAppManager&&) noexcept = default;
    IPaymentAppManager& operator=(IPaymentAppManager const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IPaymentAppManagerStatics
    ...
    IPaymentAppManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentAppManagerStatics(IPaymentAppManagerStatics const&) noexcept =
        default;
    IPaymentAppManagerStatics(IPaymentAppManagerStatics&&) noexcept = default;
    IPaymentAppManagerStatics& operator=(
        IPaymentAppManagerStatics const&) & noexcept = default;
    IPaymentAppManagerStatics& operator=(
        IPaymentAppManagerStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPaymentTransaction
    ...
    IPaymentTransaction(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentTransaction(IPaymentTransaction const&) noexcept = default;
    IPaymentTransaction(IPaymentTransaction&&) noexcept = default;
    IPaymentTransaction& operator=(IPaymentTransaction const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) IPaymentTransactionAcceptResult
    ...
    IPaymentTransactionAcceptResult(void* ptr,
                                    take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentTransactionAcceptResult(
        IPaymentTransactionAcceptResult const&) noexcept = default;
    IPaymentTransactionAcceptResult(
        IPaymentTransactionAcceptResult&&) noexcept = default;
    IPaymentTransactionAcceptResult& operator=(
        IPaymentTransactionAcceptResult const&) & noexcept = default;
    IPaymentTransactionAcceptResult& operator=(
        IPaymentTransactionAcceptResult&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPaymentTransactionStatics
    ...
    IPaymentTransactionStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPaymentTransactionStatics(IPaymentTransactionStatics const&) noexcept =
        default;
    IPaymentTransactionStatics(IPaymentTransactionStatics&&) noexcept = default;
    IPaymentTransactionStatics& operator=(
        IPaymentTransactionStatics const&) & noexcept = default;
    IPaymentTransactionStatics& operator=(
        IPaymentTransactionStatics&&) & noexcept = default;
  };
}
#endif
