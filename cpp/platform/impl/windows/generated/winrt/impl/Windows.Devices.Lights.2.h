...
WINRT_EXPORT namespace winrt::Windows::Devices::Lights {
  struct __declspec(empty_bases) Lamp : winrt::Windows::Devices::Lights::ILamp {
    ...
    Lamp(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Lights::ILamp(ptr, take_ownership_from_abi) {
    }
  ...
  struct __declspec(empty_bases) LampArray
      : winrt::Windows::Devices::Lights::ILampArray {
    LampArray(std::nullptr_t) noexcept {}
    LampArray(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Lights::ILampArray(
  ...
  struct __declspec(empty_bases) LampAvailabilityChangedEventArgs
      : winrt::Windows::Devices::Lights::ILampAvailabilityChangedEventArgs {
    LampAvailabilityChangedEventArgs(std::nullptr_t) noexcept {}
    LampAvailabilityChangedEventArgs(void* ptr,
                                     take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Lights::ILampAvailabilityChangedEventArgs(
              ptr, take_ownership_from_abi) {}
    LampAvailabilityChangedEventArgs(
        LampAvailabilityChangedEventArgs const&) noexcept = default;
    LampAvailabilityChangedEventArgs(
        LampAvailabilityChangedEventArgs&&) noexcept = default;
    LampAvailabilityChangedEventArgs& operator=(
        LampAvailabilityChangedEventArgs const&) & noexcept = default;
    LampAvailabilityChangedEventArgs& operator=(
        LampAvailabilityChangedEventArgs&&) & noexcept = default;
  };
  struct __declspec(empty_bases) LampInfo
      : winrt::Windows::Devices::Lights::ILampInfo {
    LampInfo(std::nullptr_t) noexcept {}
    LampInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Devices::Lights::ILampInfo(ptr,
