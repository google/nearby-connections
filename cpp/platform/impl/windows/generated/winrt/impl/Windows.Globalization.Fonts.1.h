...
WINRT_EXPORT namespace winrt::Windows::Globalization::Fonts {
  struct __declspec(empty_bases) ILanguageFont
    ...
    ILanguageFont(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) ILanguageFontGroup
    ...
    ILanguageFontGroup(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILanguageFontGroup(ILanguageFontGroup const&) noexcept = default;
    ILanguageFontGroup(ILanguageFontGroup&&) noexcept = default;
    ILanguageFontGroup& operator=(ILanguageFontGroup const&) & noexcept =
        default;
  ...
  struct __declspec(empty_bases) ILanguageFontGroupFactory
    ...
    ILanguageFontGroupFactory(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILanguageFontGroupFactory(ILanguageFontGroupFactory const&) noexcept =
        default;
    ILanguageFontGroupFactory(ILanguageFontGroupFactory&&) noexcept = default;
    ILanguageFontGroupFactory& operator=(
        ILanguageFontGroupFactory const&) & noexcept = default;
    ILanguageFontGroupFactory& operator=(
        ILanguageFontGroupFactory&&) & noexcept = default;
  };
}
#endif
