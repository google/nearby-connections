...
WINRT_EXPORT namespace winrt::Windows::Management::Update {
  struct __declspec(empty_bases) IPreviewBuildsManager
    ...
    IPreviewBuildsManager(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    IPreviewBuildsManager& operator=(IPreviewBuildsManager const&) & noexcept =
        default;
    IPreviewBuildsManager& operator=(IPreviewBuildsManager&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) IPreviewBuildsManagerStatics
    ...
    IPreviewBuildsManagerStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPreviewBuildsManagerStatics(IPreviewBuildsManagerStatics const&) noexcept =
        default;
    IPreviewBuildsManagerStatics(IPreviewBuildsManagerStatics&&) noexcept =
        default;
    IPreviewBuildsManagerStatics& operator=(
        IPreviewBuildsManagerStatics const&) & noexcept = default;
    IPreviewBuildsManagerStatics& operator=(
        IPreviewBuildsManagerStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) IPreviewBuildsState
    ...
    IPreviewBuildsState(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    IPreviewBuildsState(IPreviewBuildsState const&) noexcept = default;
    IPreviewBuildsState(IPreviewBuildsState&&) noexcept = default;
    IPreviewBuildsState& operator=(IPreviewBuildsState const&) & noexcept =
        default;
