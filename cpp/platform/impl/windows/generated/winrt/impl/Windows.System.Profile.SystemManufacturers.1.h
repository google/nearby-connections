...
WINRT_EXPORT namespace winrt::Windows::System::Profile::SystemManufacturers {
  struct __declspec(empty_bases) IOemSupportInfo
    ...
    IOemSupportInfo(void* ptr, take_ownership_from_abi_t) noexcept
  ...
  struct __declspec(empty_bases) ISmbiosInformationStatics
    ...
    ISmbiosInformationStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISmbiosInformationStatics(ISmbiosInformationStatics const&) noexcept =
        default;
    ISmbiosInformationStatics(ISmbiosInformationStatics&&) noexcept = default;
    ISmbiosInformationStatics& operator=(
        ISmbiosInformationStatics const&) & noexcept = default;
    ISmbiosInformationStatics& operator=(
        ISmbiosInformationStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISystemSupportDeviceInfo
    ...
    ISystemSupportDeviceInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISystemSupportDeviceInfo(ISystemSupportDeviceInfo const&) noexcept =
        default;
    ISystemSupportDeviceInfo(ISystemSupportDeviceInfo&&) noexcept = default;
    ISystemSupportDeviceInfo& operator=(
        ISystemSupportDeviceInfo const&) & noexcept = default;
    ISystemSupportDeviceInfo& operator=(ISystemSupportDeviceInfo&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ISystemSupportInfoStatics
    ...
    ISystemSupportInfoStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISystemSupportInfoStatics(ISystemSupportInfoStatics const&) noexcept =
        default;
    ISystemSupportInfoStatics(ISystemSupportInfoStatics&&) noexcept = default;
    ISystemSupportInfoStatics& operator=(
        ISystemSupportInfoStatics const&) & noexcept = default;
    ISystemSupportInfoStatics& operator=(
        ISystemSupportInfoStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ISystemSupportInfoStatics2
    ...
    ISystemSupportInfoStatics2(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ISystemSupportInfoStatics2(ISystemSupportInfoStatics2 const&) noexcept =
        default;
    ISystemSupportInfoStatics2(ISystemSupportInfoStatics2&&) noexcept = default;
    ISystemSupportInfoStatics2& operator=(
        ISystemSupportInfoStatics2 const&) & noexcept = default;
    ISystemSupportInfoStatics2& operator=(
        ISystemSupportInfoStatics2&&) & noexcept = default;
  };
}
#endif
