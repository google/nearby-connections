...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::LockScreen {
  struct __declspec(empty_bases) ILockApplicationHost
    ...
    ILockApplicationHost(void* ptr, take_ownership_from_abi_t) noexcept
    ...
    ILockApplicationHost& operator=(ILockApplicationHost const&) & noexcept =
        default;
    ILockApplicationHost& operator=(ILockApplicationHost&&) & noexcept =
        default;
  };
  struct __declspec(empty_bases) ILockApplicationHostStatics
    ...
    ILockApplicationHostStatics(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILockApplicationHostStatics(ILockApplicationHostStatics const&) noexcept =
        default;
    ILockApplicationHostStatics(ILockApplicationHostStatics&&) noexcept =
        default;
    ILockApplicationHostStatics& operator=(
        ILockApplicationHostStatics const&) & noexcept = default;
    ILockApplicationHostStatics& operator=(
        ILockApplicationHostStatics&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ILockScreenBadge
    ...
    ILockScreenBadge(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ILockScreenInfo
    ...
    ILockScreenInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
  ...
  struct __declspec(empty_bases) ILockScreenUnlockingDeferral
    ...
    ILockScreenUnlockingDeferral(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILockScreenUnlockingDeferral(ILockScreenUnlockingDeferral const&) noexcept =
        default;
    ILockScreenUnlockingDeferral(ILockScreenUnlockingDeferral&&) noexcept =
        default;
    ILockScreenUnlockingDeferral& operator=(
        ILockScreenUnlockingDeferral const&) & noexcept = default;
    ILockScreenUnlockingDeferral& operator=(
        ILockScreenUnlockingDeferral&&) & noexcept = default;
  };
  struct __declspec(empty_bases) ILockScreenUnlockingEventArgs
    ...
    ILockScreenUnlockingEventArgs(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Foundation::IInspectable(ptr,
                                                   take_ownership_from_abi) {}
    ILockScreenUnlockingEventArgs(
        ILockScreenUnlockingEventArgs const&) noexcept = default;
    ILockScreenUnlockingEventArgs(ILockScreenUnlockingEventArgs&&) noexcept =
        default;
    ILockScreenUnlockingEventArgs& operator=(
        ILockScreenUnlockingEventArgs const&) & noexcept = default;
    ILockScreenUnlockingEventArgs& operator=(
        ILockScreenUnlockingEventArgs&&) & noexcept = default;
  };
}
#endif
