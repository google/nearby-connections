...
WINRT_EXPORT namespace winrt::Windows::Data::Json {
  struct __declspec(empty_bases) JsonArray
      : winrt::Windows::Data::Json::IJsonArray,
        impl::require<JsonArray,
    ...
    JsonArray(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Json::IJsonArray(ptr, take_ownership_from_abi) {
    }
    JsonArray();
  ...
  struct __declspec(empty_bases) JsonObject
    ...
    JsonObject(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Json::IJsonObject(ptr,
    ...
    using impl::consume_t<
        JsonObject, winrt::Windows::Data::Json::IJsonObjectWithDefaultValues>::
        GetNamedArray;
  ...
  struct __declspec(empty_bases) JsonValue
      : winrt::Windows::Data::Json::IJsonValue,
        impl::require<JsonValue, winrt::Windows::Foundation::IStringable> {
    JsonValue(std::nullptr_t) noexcept {}
    JsonValue(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Data::Json::IJsonValue(ptr, take_ownership_from_abi) {
    }
