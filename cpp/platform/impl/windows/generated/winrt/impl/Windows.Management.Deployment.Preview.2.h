...
WINRT_EXPORT namespace winrt::Windows::Management::Deployment::Preview {
  ...
  struct __declspec(empty_bases) InstalledClassicAppInfo
      : winrt::Windows::Management::Deployment::Preview::
            IInstalledClassicAppInfo {
    InstalledClassicAppInfo(std::nullptr_t) noexcept {}
    InstalledClassicAppInfo(void* ptr, take_ownership_from_abi_t) noexcept
        : winrt::Windows::Management::Deployment::Preview::
              IInstalledClassicAppInfo(ptr, take_ownership_from_abi) {}
    ...
    InstalledClassicAppInfo& operator=(
        InstalledClassicAppInfo const&) & noexcept = default;
    InstalledClassicAppInfo& operator=(InstalledClassicAppInfo&&) & noexcept =
        default;
  };
}
#endif
