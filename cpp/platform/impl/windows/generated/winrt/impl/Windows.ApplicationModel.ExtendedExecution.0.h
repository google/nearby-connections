...
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::ExtendedExecution::
               ExtendedExecutionRevokedEventArgs> =
        L"Windows.ApplicationModel.ExtendedExecution."
        L"ExtendedExecutionRevokedEventArgs";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::
                                  ExtendedExecution::ExtendedExecutionSession> =
    L"Windows.ApplicationModel.ExtendedExecution.ExtendedExecutionSession";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::
                                  ExtendedExecution::ExtendedExecutionReason> =
    L"Windows.ApplicationModel.ExtendedExecution.ExtendedExecutionReason";
template <>
inline constexpr auto& name_v<winrt::Windows::ApplicationModel::
                                  ExtendedExecution::ExtendedExecutionResult> =
    L"Windows.ApplicationModel.ExtendedExecution.ExtendedExecutionResult";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::ExtendedExecution::
               ExtendedExecutionRevokedReason> =
        L"Windows.ApplicationModel.ExtendedExecution."
        L"ExtendedExecutionRevokedReason";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::ExtendedExecution::
               IExtendedExecutionRevokedEventArgs> =
        L"Windows.ApplicationModel.ExtendedExecution."
        L"IExtendedExecutionRevokedEventArgs";
template <>
inline constexpr auto&
    name_v<winrt::Windows::ApplicationModel::ExtendedExecution::
               IExtendedExecutionSession> =
        L"Windows.ApplicationModel.ExtendedExecution.IExtendedExecutionSession";
template <>
inline constexpr guid
    guid_v<winrt::Windows::ApplicationModel::ExtendedExecution::
               IExtendedExecutionRevokedEventArgs>{
        0xBFBC9F16,
        0x63B5,
        0x4C0B,
        {0xAA, 0xD6, 0x82, 0x8A, 0xF5, 0x37, 0x3E,
         0xC3}};  // BFBC9F16-63B5-4C0B-AAD6-828AF5373EC3
template <>
inline constexpr guid guid_v<winrt::Windows::ApplicationModel::
                                 ExtendedExecution::IExtendedExecutionSession>{
    0xAF908A2D,
    0x118B,
    0x48F1,
    {0x93, 0x08, 0x0C, 0x4F, 0xC4, 0x1E, 0x20,
     0x0F}};  // AF908A2D-118B-48F1-9308-0C4FC41E200F
template <>
struct default_interface<winrt::Windows::ApplicationModel::ExtendedExecution::
                             ExtendedExecutionRevokedEventArgs> {
  using type = winrt::Windows::ApplicationModel::ExtendedExecution::
      IExtendedExecutionRevokedEventArgs;
};
template <>
struct default_interface<winrt::Windows::ApplicationModel::ExtendedExecution::
...
template <>
struct abi<winrt::Windows::ApplicationModel::ExtendedExecution::
               IExtendedExecutionRevokedEventArgs> {
...
struct
  ...
  [[nodiscard]] WINRT_IMPL_AUTO(
      winrt::Windows::ApplicationModel::ExtendedExecution::
          ExtendedExecutionRevokedReason) Reason() const;
};
template <>
struct consume<winrt::Windows::ApplicationModel::ExtendedExecution::
                   IExtendedExecutionRevokedEventArgs> {
  template <typename D>
  using type =
      consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionRevokedEventArgs<
...
struct
  ...
  Reason(winrt::Windows::ApplicationModel::ExtendedExecution::
  ...
  using Revoked_revoker = impl::event_revoker<
      winrt::Windows::ApplicationModel::ExtendedExecution::
          IExtendedExecutionSession,
      &impl::abi_t<winrt::Windows::ApplicationModel::ExtendedExecution::
                       IExtendedExecutionSession>::remove_Revoked>;
