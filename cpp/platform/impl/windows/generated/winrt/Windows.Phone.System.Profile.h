...
consume_Windows_Phone_System_Profile_IRetailModeStatics<D>::RetailModeEnabled()
    const {
  bool value{};
  check_hresult(WINRT_IMPL_SHIM(
                    winrt::Windows::Phone::System::Profile::IRetailModeStatics)
                    ->get_RetailModeEnabled(&value));
  return value;
}
#ifndef WINRT_LEAN_AND_MEAN
template <typename D>
struct produce<D, winrt::Windows::Phone::System::Profile::IRetailModeStatics>
    : produce_base<D,
                   winrt::Windows::Phone::System::Profile::IRetailModeStatics> {
...
WINRT_EXPORT namespace winrt::Windows::Phone::System::Profile {
  inline auto RetailMode::RetailModeEnabled() {
    return impl::call_factory_cast<bool (*)(IRetailModeStatics const&),
                                   RetailMode, IRetailModeStatics>(
        [](IRetailModeStatics const& f) { return f.RetailModeEnabled(); });
  }
}
namespace std {
#ifndef WINRT_LEAN_AND_MEAN
template <>
struct hash<winrt::Windows::Phone::System::Profile::IRetailModeStatics>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Windows::Phone::System::Profile::RetailMode>
    : winrt::impl::hash_base {};
#endif
}  // namespace std
#endif
