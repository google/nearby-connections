...
consume_Windows_System_Display_IDisplayRequest<D>::RequestActive() const {
  check_hresult(
      WINRT_IMPL_SHIM(winrt::Windows::System::Display::IDisplayRequest)
          ->RequestActive());
}
template <typename D>
WINRT_IMPL_AUTO(void)
consume_Windows_System_Display_IDisplayRequest<D>::RequestRelease() const {
  check_hresult(
      WINRT_IMPL_SHIM(winrt::Windows::System::Display::IDisplayRequest)
          ->RequestRelease());
}
...
template <typename D>
struct produce<D, winrt::Windows::System::Display::IDisplayRequest>
    : produce_base<D, winrt::Windows::System::Display::IDisplayRequest> {
      ...
      : DisplayRequest(
            impl::call_factory_cast<
                ...
                [](winrt::Windows::Foundation::IActivationFactory const& f) {
                  return f.template ActivateInstance<DisplayRequest>();
                })) {}
}
namespace std {
#ifndef WINRT_LEAN_AND_MEAN
template <>
struct hash<winrt::Windows::System::Display::IDisplayRequest>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Windows::System::Display::DisplayRequest>
    : winrt::impl::hash_base {};
#endif
}  // namespace std
#endif
