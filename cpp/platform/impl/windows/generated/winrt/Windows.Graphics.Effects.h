...
consume_Windows_Graphics_Effects_IGraphicsEffect<D>::Name() const {
  void* name{};
  check_hresult(
      WINRT_IMPL_SHIM(winrt::Windows::Graphics::Effects::IGraphicsEffect)
          ->get_Name(&name));
  return hstring{name, take_ownership_from_abi};
}
template <typename D>
WINRT_IMPL_AUTO(void)
consume_Windows_Graphics_Effects_IGraphicsEffect<D>::Name(
...
template <typename D>
struct produce<D, winrt::Windows::Graphics::Effects::IGraphicsEffect>
    : produce_base<D, winrt::Windows::Graphics::Effects::IGraphicsEffect> {
...
template <typename D>
struct produce<D, winrt::Windows::Graphics::Effects::IGraphicsEffectSource>
    : produce_base<D,
...
template <>
struct hash<winrt::Windows::Graphics::Effects::IGraphicsEffect>
    : winrt::impl::hash_base {};
template <>
struct hash<winrt::Windows::Graphics::Effects::IGraphicsEffectSource>
    : winrt::impl::hash_base {};
#endif
}  // namespace std
#endif
