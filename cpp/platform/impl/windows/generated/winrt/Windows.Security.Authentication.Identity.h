...
template <typename D>
WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Identity::
...
consume_Windows_Security_Authentication_Identity_IEnterpriseKeyCredentialRegistrationManagerStatics<
  ...
  check_hresult(
      WINRT_IMPL_SHIM(winrt::Windows::Security::Authentication::Identity::
          ...
          ->get_Current(&value));
  return winrt::Windows::Security::Authentication::Identity::
      EnterpriseKeyCredentialRegistrationManager{value,
                                                 take_ownership_from_abi};
}
#ifndef WINRT_LEAN_AND_MEAN
template <typename D>
struct produce<D, winrt::Windows::Security::Authentication::Identity::
                      IEnterpriseKeyCredentialRegistrationInfo>
  ...
  int32_t __stdcall GetRegistrationsAsync(void** value) noexcept final try {
    ...
    *value = detach_from<winrt::Windows::Foundation::IAsyncOperation<
        winrt::Windows::Foundation::Collections::IVectorView<
            winrt::Windows::Security::Authentication::Identity::
                EnterpriseKeyCredentialRegistrationInfo>>>(
        this->shim().GetRegistrationsAsync());
    return 0;
  } catch (...) {
    return to_hresult();
  }
...
WINRT_EXPORT namespace winrt::Windows::Security::Authentication::Identity {
  inline auto EnterpriseKeyCredentialRegistrationManager::Current() {
    return impl::call_factory_cast<
        winrt::Windows::Security::Authentication::Identity::
            EnterpriseKeyCredentialRegistrationManager (*)(
                IEnterpriseKeyCredentialRegistrationManagerStatics const&),
        EnterpriseKeyCredentialRegistrationManager,
        IEnterpriseKeyCredentialRegistrationManagerStatics>(
        [](IEnterpriseKeyCredentialRegistrationManagerStatics const& f) {
          return f.Current();
        });
  }
}
...
#ifndef WINRT_LEAN_AND_MEAN
template <>
struct hash<winrt::Windows::Security::Authentication::Identity::
                IEnterpriseKeyCredentialRegistrationInfo>
